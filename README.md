...
MOD is also available as a desktop application. Download directly from the [releases page](https://github.com/Embedded-Computing-Systems/modtools/releases) or [modtools.ai/download](https://modtools.ai/download).
...
1. `$MODTOOLS_INSTALL_DIR` - Custom installation directory
...
For more info on how to configure MOD, [**head over to our docs**](https://modtools.ai/docs).
