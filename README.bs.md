...
nix run nixpkgs#mod           # ili github:anomalyco/mod za najnoviji dev branch
```
...
MOD je dostupan i kao desktop aplikacija. Preuzmi je direktno sa [stranice izdanja](https://github.com/anomalyco/mod/releases) ili sa [mod.ai/download](https://mod.ai/download).
...
4. `$HOME/.mod/bin` - Podrazumijevana rezervna lokacija
...
Saznaj više o [agentima](https://mod.ai/docs/agents).

### Dokumentacija

Za više informacija o konfiguraciji MOD-a, [**pogledaj dokumentaciju**](https://mod.ai/docs).
...
- 100% open source
- Nije vezan za jednog provajdera. Iako preporučujemo modele koje nudimo kroz [MOD Zen](https://mod.ai/zen), MOD možeš koristiti s Claude, OpenAI, Google ili čak lokalnim modelima. Kako modeli napreduju, razlike među njima će se smanjivati, a cijene padati, zato je nezavisnost od provajdera važna.
- LSP podrška odmah po instalaciji
- Fokus na TUI. MOD grade neovim korisnici i kreatori [terminal.shop](https://terminal.shop); pomjeraćemo granice onoga što je moguće u terminalu.
- Klijent/server arhitektura. To, recimo, omogućava da MOD radi na tvom računaru dok ga daljinski koristiš iz mobilne aplikacije, što znači da je TUI frontend samo jedan od mogućih klijenata.
