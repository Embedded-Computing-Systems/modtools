...
nix run nixpkgs#MOD           # або github:Embedded-Computing-Systems/modtools для найновішої dev-гілки
```
...
MOD також доступний як десктопний застосунок. Завантажуйте напряму зі [сторінки релізів](https://github.com/Embedded-Computing-Systems/modtools/releases) або [modtools.ai/download](https://modtools.ai/download).
...
1. `$MODTOOLS_INSTALL_DIR` - Користувацький каталог встановлення
...
Щоб дізнатися більше про налаштування MOD, [**перейдіть до нашої документації**](https://modtools.ai/docs).
