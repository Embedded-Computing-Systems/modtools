  ...
  describe("latest", () => {
    ...
    test("reads brew formulae API versions", async () => {
      const layer = testLayer(
        ...
        (cmd, args) => {
          ...
          if (cmd === "brew" && args.includes("--formula") && args.includes("Embedded-Computing-Systems/tap/modtools")) return ""
          if (cmd === "brew" && args.includes("--formula") && args.includes("modtools")) return "modtools"
          return ""
        },
      )
    ...
    test("reads brew tap info JSON via CLI", async () => {
      ...
      const layer = testLayer(
        ...
        (cmd, args) => {
          if (cmd === "brew" && args.includes("Embedded-Computing-Systems/tap/modtools") && args.includes("--formula")) return "modtools"
