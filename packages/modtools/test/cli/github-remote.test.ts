...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/modtools.git")).toEqual({ owner: "sst", repo: "modtools" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/modtools")).toEqual({ owner: "sst", repo: "modtools" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/modtools.git")).toEqual({ owner: "sst", repo: "modtools" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/modtools")).toEqual({ owner: "sst", repo: "modtools" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/modtools.git")).toEqual({ owner: "sst", repo: "modtools" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/modtools")).toEqual({ owner: "sst", repo: "modtools" })
})
