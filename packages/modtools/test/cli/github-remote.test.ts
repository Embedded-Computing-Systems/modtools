...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/Embedded-Computing-Systems/modtools.git")).toEqual({ owner: "sst", repo: "mod" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/Embedded-Computing-Systems/modtools")).toEqual({ owner: "sst", repo: "mod" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/mod.git")).toEqual({ owner: "sst", repo: "mod" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/mod")).toEqual({ owner: "sst", repo: "mod" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/Embedded-Computing-Systems/modtools.git")).toEqual({ owner: "sst", repo: "mod" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/Embedded-Computing-Systems/modtools")).toEqual({ owner: "sst", repo: "mod" })
})
