...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/MOD.git")).toEqual({ owner: "sst", repo: "MOD" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/MOD")).toEqual({ owner: "sst", repo: "MOD" })
})
...
test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/MOD.git")).toEqual({ owner: "sst", repo: "MOD" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/MOD")).toEqual({ owner: "sst", repo: "MOD" })
})
