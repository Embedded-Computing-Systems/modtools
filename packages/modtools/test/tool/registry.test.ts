...
describe("tool.registry", () => {
  ...
  it.instance("loads tools from .mod/tool (singular)", () =>
    Effect.gen(function* () {
  ...
  it.instance("ignores non-tool exports in .mod/tool files", () =>
    Effect.gen(function* () {
      const test = yield* TestInstance
  ...
  it.instance("loads tools from .mod/tools (plural)", () =>
    Effect.gen(function* () {
      const test = yield* TestInstance
      const mod = path.join(test.directory, ".mod")
  ...
  it.instance(
    ...
    () =>
      Effect.gen(function* () {
        ...
        const plugin = path.join(mod, "node_modules", "@modtools-ai", "plugin")
