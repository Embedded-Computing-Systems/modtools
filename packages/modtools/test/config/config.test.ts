...
import { EffectFlock } from "@modtools-ai/core/util/effect-flock"
...
it.instance("loads agents from .modtools/agents (plural)", () =>
  Effect.gen(function* () {
    const test = yield* TestInstance
    yield* FSUtil.use.writeWithDirs(
...
it.instance("loads commands from .modtools/command (singular)", () =>
  Effect.gen(function* () {
    const test = yield* TestInstance
    yield* FSUtil.use.writeWithDirs(
...
it.instance("loads commands from .modtools/commands (plural)", () =>
  Effect.gen(function* () {
    const test = yield* TestInstance
    yield* FSUtil.use.writeWithDirs(
...
describe("deduplicatePluginOrigins", () => {
  ...
  test("keeps path plugins separate from package plugins", () => {
    const plugins = ["oh-my-MOD@2.4.3", "file:///project/.modtools/plugin/oh-my-MOD.js"]
  ...
  test("deduplicates direct path plugins by exact spec", () => {
    const plugins = ["file:///project/.modtools/plugin/demo.ts", "file:///project/.modtools/plugin/demo.ts"]

    const result = dedupe(plugins)

    expect(result).toEqual(["file:///project/.modtools/plugin/demo.ts"])
  })
...
describe("MODTOOLS_DISABLE_PROJECT_CONFIG", () => {
  ...
  it.instance("skips project .modtools/ directories when flag is set", () =>
    withProcessEnv(
      "MODTOOLS_DISABLE_PROJECT_CONFIG",
      "true",
      Effect.gen(function* () {
