...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders MOD_CALLER", () => {
    process.env["MOD_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode MOD_CALLER", () => {
    process.env["MOD_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown MOD_CALLER", () => {
    process.env["MOD_CALLER"] = "unknown"
