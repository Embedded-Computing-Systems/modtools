...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders MODTOOLS_CALLER", () => {
    process.env["MODTOOLS_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode MODTOOLS_CALLER", () => {
    process.env["MODTOOLS_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown MODTOOLS_CALLER", () => {
    process.env["MODTOOLS_CALLER"] = "unknown"
