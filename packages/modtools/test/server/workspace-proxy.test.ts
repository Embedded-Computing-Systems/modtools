...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips MOD-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-MOD-directory"]).toBeUndefined()
      expect(forwarded["x-MOD-workspace"]).toBeUndefined()
