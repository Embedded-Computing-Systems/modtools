...
const noAuthLayer = ServerAuth.Config.layer({ password: Option.none(), username: "MOD" })
const secretLayer = ServerAuth.Config.layer({ password: Option.some("secret"), username: "MOD" })
