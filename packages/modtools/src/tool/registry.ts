...
export namespace ToolRegistry {
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@modtools/ToolRegistry") {}
    ...
    Layer.effect(
      ...
      Effect.gen(function* () {
        ...
        const all = Effect.fn("ToolRegistry.all")(function* (custom: Tool.Info[]) {
          ...
          const question =
            ["app", "cli", "desktop"].includes(Flag.MOD_CLIENT) || Flag.MOD_ENABLE_QUESTION_TOOL
          ...
          return [
            ...
            skill,
            patch,
            ...(Flag.MOD_EXPERIMENTAL_LSP_TOOL ? [lsp] : []),
            ...(cfg.experimental?.batch_tool === true ? [batch] : []),
            ...(Flag.MOD_EXPERIMENTAL_PLAN_MODE && Flag.MOD_CLIENT === "cli" ? [plan] : []),
            ...custom,
          ]
        })
        ...
        const tools = Effect.fn("ToolRegistry.tools")(function* (
          ...
          const filtered = allTools.filter((tool) => {
            if (tool.id === "codesearch" || tool.id === "websearch") {
              return model.providerID === ProviderID.modtools || Flag.MOD_ENABLE_EXA
            }

            const usePatch =
              !!Env.get("MOD_E2E_LLM_URL") ||
