...
export namespace ShareNext {
  ...
  const disabled = process.env["MOD_DISABLE_SHARE"] === "true" || process.env["MOD_DISABLE_SHARE"] === "1"
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@modtools/ShareNext") {}
