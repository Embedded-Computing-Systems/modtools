...
import type * as SDK from "@modtools-ai/sdk/v2"
...
import { SessionShareTable } from "@modtools-ai/core/share/sql"
...
const disabled = process.env["MODTOOLS_DISABLE_SHARE"] === "true" || process.env["MODTOOLS_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@MOD/ShareNext") {}
