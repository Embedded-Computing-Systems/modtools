...
export namespace Skill {
  ...
  const MOD_SKILL_PATTERN = "{skill,skills}/**/SKILL.md"
  ...
  const loadSkills = Effect.fnUntraced(function* (
    ...
    if (!Flag.MOD_DISABLE_EXTERNAL_SKILLS) {
    ...
    for (const dir of configDirs) {
      yield* scan(state, bus, dir, MOD_SKILL_PATTERN)
    }
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@modtools/Skill") {}
