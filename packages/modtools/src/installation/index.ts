...
export namespace Installation {
  ...
  export const USER_AGENT = `modtools/${CHANNEL}/${VERSION}/${Flag.MOD_CLIENT}`
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@modtools/Installation") {}
    ...
    Layer.effect(
      ...
      Effect.gen(function* () {
        ...
        const getBrewFormula = Effect.fnUntraced(function* () {
          const tapFormula = yield* text(["brew", "list", "--formula", "Embedded-Computing-Systems/tap/modtools"])
          if (tapFormula.includes("modtools")) return "Embedded-Computing-Systems/tap/modtools"
        ...
        const methodImpl = Effect.fn("Installation.method")(function* () {
          if (process.execPath.includes(path.join(".modtools", "bin"))) return "curl" as Method
        ...
        const upgradeImpl = Effect.fn("Installation.upgrade")(function* (m: Method, target: string) {
          ...
          switch (m) {
            ...
            case "brew": {
              ...
              if (formula.includes("/")) {
                const tap = yield* run(["brew", "tap", "Embedded-Computing-Systems/tap"], { env })
                if (tap.code !== 0) {
                  result = tap
                  break
                }
                const repo = yield* text(["brew", "--repo", "Embedded-Computing-Systems/tap"])
                const dir = repo.trim()
                if (dir) {
