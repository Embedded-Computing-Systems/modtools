...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@MOD/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@MOD/ACPDirectory") {}
