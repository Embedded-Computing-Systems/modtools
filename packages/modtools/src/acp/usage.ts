...
import type { AssistantMessage as ModAssistantMessage, Message } from "@modtools-ai/sdk/v2"
...
export type AssistantTokenCost = Pick<ModAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<ModAssistantMessage, "role"> &
  Partial<Pick<ModAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@MOD/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@MOD/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@MOD/ACPUsage") {}
