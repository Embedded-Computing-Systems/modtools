...
export class Service extends Context.Service<Service, Interface>()("@MOD/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __MODTOOLS_PHOTON_WASM_PATH?: string }).__MODTOOLS_PHOTON_WASM_PATH =
