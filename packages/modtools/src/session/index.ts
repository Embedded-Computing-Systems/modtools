import { Slug } from "@modtools-ai/util/slug"
...
export namespace Session {
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@modtools/Session") {}
  ...
  export const layer: Layer.Layer<Service, never, Bus.Service | Config.Service> = Layer.effect(
    ...
    Effect.gen(function* () {
      ...
      const createNext = Effect.fn("Session.createNext")(function* (input: {
        ...
        if (!Flag.MOD_EXPERIMENTAL_WORKSPACES) {
