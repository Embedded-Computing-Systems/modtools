import type { JsonSchema, LLMRequest, ProviderMetadata } from "@modtools-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@modtools-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @modtools-ai/llm request objects from mod's session/AI SDK-shaped data.
  return LLM.request({
