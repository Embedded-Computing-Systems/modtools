...
import { llmClient } from "@modtools-ai/core/effect/layer-node-platform"
...
import type { LLMEvent } from "@modtools-ai/llm"
import { LLMClient, RequestExecutor, WebSocketExecutor } from "@modtools-ai/llm/route"
import type { LLMClientService } from "@modtools-ai/llm/route"
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @modtools-ai/llm. It
