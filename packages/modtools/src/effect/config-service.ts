 ...
 *   "@MOD/ServerAuthConfig",
 *   {
 *     password: Config.string("MODTOOLS_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("MODTOOLS_SERVER_USERNAME").pipe(Config.withDefault("MOD")),
 *   },
 * ) {}
 *
