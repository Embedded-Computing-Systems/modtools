...
export namespace LSP {
  ...
  const filterExperimentalServers = (servers: Record<string, LSPServer.Info>) => {
    if (Flag.MOD_EXPERIMENTAL_LSP_TY) {
      if (servers["pyright"]) {
        log.info("LSP server pyright is disabled because MOD_EXPERIMENTAL_LSP_TY is enabled")
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@modtools/LSP") {}
