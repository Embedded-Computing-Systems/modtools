...
import { ProjectDirectoryTable, ProjectTable } from "@modtools-ai/core/project/sql"
import { ProjectDirectories } from "@modtools-ai/core/project/directories"
...
import { which } from "@modtools-ai/core/util/which"
...
import { AbsolutePath, NonNegativeInt, optionalOmitUndefined } from "@modtools-ai/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@MOD/Project") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(ProjectVcs))(Flag.MODTOOLS_FAKE_VCS)
