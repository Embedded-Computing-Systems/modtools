...
import { path } from "@modtools-ai/core/effect/app-node-platform"
...
import type { ProjectV2 } from "@modtools-ai/core/project"
...
import { WorktreeEvent } from "@modtools-ai/schema/worktree-event"
  ...
  Effect.gen(function* () {
    ...
    const candidate = Effect.fn("Worktree.candidate")(function* (input: {
      ...
      for (const attempt of Array.from({ length: MAX_NAME_ATTEMPTS }, (_, i) => i)) {
        ...
        const branch = input.detached ? undefined : `mod/${name}`
