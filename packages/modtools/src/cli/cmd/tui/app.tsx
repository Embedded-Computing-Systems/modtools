...
function App(props: { onSnapshot?: () => Promise<string[]> }) {
  ...
  createEffect(() => {
    ...
    if (route.data.type === "home") {
      renderer.setTerminalTitle("Model-of-Design Tools")
      return
    }
  ...
  command.register(() => [
    ...
    ...(Flag.MOD_EXPERIMENTAL_WORKSPACES
      ? [
          {
  ...
  sdk.event.on("installation.update-available", async (evt) => {
    ...
    await DialogAlert.show(
      dialog,
      "Update Complete",
      `Successfully updated to Model-of-Design Tools v${result.data.version}. Please restart the application.`,
    )
