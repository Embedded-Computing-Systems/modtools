...
import type { TuiThemeCurrent } from "@modtools-ai/plugin/tui"
  ...
  init: (props: { mode: "dark" | "light" }) => {
    ...
    setStore(
      produce((draft) => {
        ...
        draft.lock = lock
        const active = config.theme ?? kv.get("theme", "modtools")
        draft.active = typeof active === "string" ? active : "modtools"
        draft.ready = false
      }),
    )
