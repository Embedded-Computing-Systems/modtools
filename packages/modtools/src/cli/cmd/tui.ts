...
import { errorMessage } from "@modtools-ai/tui/util/error"
import { withTimeout } from "@/util/timeout"
import { withNetworkOptions, resolveNetworkOptionsNoConfig, hasArg } from "@/cli/network"
import { Filesystem } from "@/util/filesystem"
import type { GlobalEvent } from "@modtools-ai/sdk/v2"
import type { EventSource } from "@modtools-ai/tui/context/sdk"
import { writeHeapSnapshot } from "v8"
import { ServerAuth } from "@/server/auth"
import { validateSession } from "../tui/validate-session"
import { win32InstallCtrlCGuard } from "@modtools-ai/tui/terminal-win32"
...
async function target() {
  if (typeof MODTOOLS_WORKER_PATH !== "undefined") return MODTOOLS_WORKER_PATH
