...
import { normalizePromptContent } from "@modtools-ai/tui/editor"
...
import { MODTOOLS_BASE_MODE, useBindings } from "@modtools-ai/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close Mod" } satisfies SlashOption,
    ]
