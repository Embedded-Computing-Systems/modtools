...
import { openEditor } from "@modtools-ai/tui/editor"
import { registerModKeymap } from "@modtools-ai/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerModKeymap(keymap, renderer, input.tuiConfig)
