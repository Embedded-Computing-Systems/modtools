...
import { EventSequenceTable, EventTable } from "@modtools-ai/core/event/sql"
...
export class Service extends Context.Service<Service, Interface>()("@MOD/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        MODTOOLS_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        MODTOOLS_WORKSPACE_ID: config.id,
        MODTOOLS_EXPERIMENTAL_WORKSPACES: "true",
