import type { Hooks, PluginInput } from "@modtools-ai/plugin"
...
<html>
  <head><title>Mod - Snowflake Authorization Successful</title></head>
  <body style="font-family: system-ui; display:flex; align-items:center; justify-content:center; height:100vh; margin:0; background:#111; color:#eee;">
    <div style="text-align:center; max-width:36rem; padding:2rem;">
      ...
      <p>You can close this window and return to Mod.</p>
    </div>
...
<html>
  <head><title>Mod - Snowflake Authorization Failed</title></head>
  <body style="font-family: system-ui; display:flex; align-items:center; justify-content:center; height:100vh; margin:0; background:#111; color:#eee;">
        ...
        return {
          ...
          async fetch(requestInput: RequestInfo | URL, init?: RequestInit) {
            ...
            const prepareRequest = () => {
              ...
              headers.set("User-Agent", `MOD/${InstallationVersion}`)
      ...
      methods: [
        {
          ...
          async authorize(inputs = {}) {
            ...
            return {
              url,
              instructions:
                "Complete Snowflake sign-in in your browser. Mod will capture the OAuth callback and store the bearer token automatically.",
