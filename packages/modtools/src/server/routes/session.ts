  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all Model-of-Design Tools sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific Model-of-Design Tools session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new Model-of-Design Tools session for interacting with AI assistants and managing conversations.",
