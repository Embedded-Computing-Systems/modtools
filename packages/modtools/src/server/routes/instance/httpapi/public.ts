...
const LegacyComponentDescriptions: Record<string, string> = {
  LogLevel: "Log level",
  ServerConfig: "Server configuration for MOD serve and web commands",
...
function fixSelfReferencingComponents(spec: OpenApiSpec) {
  ...
  const raw: OpenApiSpec = OpenApi.fromApi(ModHttpApi)
...
export const PublicApi = ModHttpApi.annotateMerge(
  OpenApi.annotations({
    title: "MOD",
    version: "1.0.0",
    description: "MOD api",
