...
>()("@MOD/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@MOD/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.MODTOOLS_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.MODTOOLS_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-MOD-directory"] || process.cwd()
}
