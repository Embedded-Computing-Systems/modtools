...
import { makeApi } from "@modtools-ai/protocol/api"
import { LocationMiddleware } from "@modtools-ai/server/location"
import { SessionLocationMiddleware } from "@modtools-ai/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("mod-root")
...
export const InstanceHttpApi = HttpApi.make("mod-instance")
...
export const OpenCodeHttpApi = HttpApi.make("mod")
