...
export const ProjectApi = HttpApi.make("project")
      ...
      .add(
        HttpApiEndpoint.get("list", root, {
          ...
          OpenApi.annotations({
            ...
            description: "Get a list of projects that have been opened with MOD Tools.",
          }),
        ),
        HttpApiEndpoint.get("current", `${root}/current`, {
          ...
          OpenApi.annotations({
            ...
            description: "Retrieve the currently active project that MOD Tools is working with.",
          }),
        ),
      )
      .annotateMerge(
  ...
  .annotateMerge(
    OpenApi.annotations({
      title: "modtools experimental HttpApi",
      version: "0.0.1",
