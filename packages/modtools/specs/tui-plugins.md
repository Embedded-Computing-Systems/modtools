...
- Local plugins persist installed themes under the local `.mod/themes` area near the plugin config source.
...
- Local smoke plugin: `.mod/plugins/tui-smoke.tsx`
- Local vim plugin: `.mod/plugins/tui-vim.tsx`
- Local smoke config: `.mod/tui.json`
- Local smoke theme: `.mod/plugins/smoke-theme.json`
