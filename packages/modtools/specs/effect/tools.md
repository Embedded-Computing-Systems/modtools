...
Practical reference for the current tool-migration state in `packages/modtools`.
...
Tool tests should use the existing Effect helpers in `packages/modtools/test/lib/effect.ts`:
