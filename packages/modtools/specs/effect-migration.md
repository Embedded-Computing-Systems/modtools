...
Practical reference for new and migrated Effect code in `packages/modtools`.
...
export namespace Foo {
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@modtools/Foo") {}
