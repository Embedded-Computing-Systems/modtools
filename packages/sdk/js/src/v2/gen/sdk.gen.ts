...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new ModtoolsClient()" to fix this error.`)
    }
    return instance
  }
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global Model-of-Design Tools configuration settings and preferences.
   */
   ...
   *
   * Update global Model-of-Design Tools configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the Model-of-Design Tools server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the Model-of-Design Tools system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all Model-of-Design Tools instances, releasing all resources.
   */
   ...
   * Upgrade modtools
   *
   * Upgrade modtools to the specified version or latest if not specified.
   */
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the Model-of-Design Tools system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the Model-of-Design Tools system.
   */
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with Model-of-Design Tools.
   */
   ...
   * Get current project
   *
   * Retrieve the currently active project that Model-of-Design Tools is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by Model-of-Design Tools.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current Model-of-Design Tools configuration settings and preferences.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   *
   * Update Model-of-Design Tools configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all Model-of-Design Tools sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new Model-of-Design Tools session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific Model-of-Design Tools session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current Model-of-Design Tools instance, releasing all resources.
   */
...
export class Path extends HeyApiClient {
   ...
   * Get paths
   *
   * Retrieve the current working directory and related path information for the Model-of-Design Tools instance.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the Model-of-Design Tools system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class ModtoolsClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<ModtoolsClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    ModtoolsClient.__registry.set(this, args?.key)
  }
