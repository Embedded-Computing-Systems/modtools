...
const releaseId = process.env.MODTOOLS_RELEASE
if (!releaseId) throw new Error("MODTOOLS_RELEASE is required")

const version = process.env.MODTOOLS_VERSION
if (!version) throw new Error("MODTOOLS_VERSION is required")
...
const macxTarGz = "mod-desktop-mac-x64.app.tar.gz"
const macaTarGz = "mod-desktop-mac-arm64.app.tar.gz"
