...
const releaseId = process.env.MOD_RELEASE
if (!releaseId) throw new Error("MOD_RELEASE is required")

const version = process.env.MOD_VERSION
if (!releaseId) throw new Error("MOD_VERSION is required")
...
const targets = [
  { key: "linux-x86_64-deb", asset: "modtools-desktop-linux-amd64.deb" },
  { key: "linux-x86_64-rpm", asset: "modtools-desktop-linux-x86_64.rpm" },
  { key: "linux-aarch64-deb", asset: "modtools-desktop-linux-arm64.deb" },
  { key: "linux-aarch64-rpm", asset: "modtools-desktop-linux-aarch64.rpm" },
  { key: "windows-aarch64-nsis", asset: "modtools-desktop-windows-arm64.exe" },
  { key: "windows-x86_64-nsis", asset: "modtools-desktop-windows-x64.exe" },
  { key: "darwin-x86_64-app", asset: "modtools-desktop-darwin-x64.app.tar.gz" },
  {
    key: "darwin-aarch64-app",
    asset: "modtools-desktop-darwin-aarch64.app.tar.gz",
  },
]
