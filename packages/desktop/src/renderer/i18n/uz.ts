export const dict = {
  ...
  "desktop.updater.none.message": "Siz allaqachon MOD ning oxirgi versiyasidan foydalanyapsiz",
  ...
  "desktop.updater.downloaded.prompt":
    "MODning {{version}} versiyasi yuklab olindi, uni oʻrnatib, qayta ishga tushirmoqchimisiz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} manziliga o'rnatildi\n\n'mod' buyrug'ini ishlatish uchun terminalni qayta ishga tushiring.",
