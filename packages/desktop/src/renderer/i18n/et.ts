export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse MOD uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "MOD'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
  ...
  "desktop.cli.installed.message":
    "CLI installitud asukohta {{path}}\n\nKäsu „mod” kasutamiseks taaskäivitage terminal.",
