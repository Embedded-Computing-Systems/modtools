export const dict = {
  ...
  "desktop.updater.none.message": "Käytät jo MODin uusinta versiota",
  ...
  "desktop.updater.downloaded.prompt":
    "MODin versio {{version}} on ladattu. Haluatko asentaa sen ja käynnistää MODin uudelleen?",
  ...
  "desktop.cli.installed.message":
    "CLI on asennettu polkuun {{path}}\n\nKäynnistä terminaali uudelleen, jotta voit käyttää 'mod'-komentoa.",
