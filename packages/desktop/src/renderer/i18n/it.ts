export const dict = {
  ...
  "desktop.updater.none.message": "Stai già utilizzando l'ultima versione di MOD",
  ...
  "desktop.updater.downloaded.prompt":
    "La versione {{version}} di MOD è stata scaricata. Vuoi installarla e riavviare l'app?",
  ...
  "desktop.cli.installed.message":
    "CLI installata in {{path}}\n\nRiavvia il terminale per utilizzare il comando 'mod'.",
