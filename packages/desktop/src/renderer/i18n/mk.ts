export const dict = {
  ...
  "desktop.updater.none.message": "Веќе ја користите најновата верзија на MOD",
  ...
  "desktop.updater.downloaded.prompt":
    "Верзијата {{version}} од MOD е преземена, дали сакате да ја инсталирате и повторно да ја стартувате?",
  ...
  "desktop.cli.installed.message":
    "CLI инсталиран на {{path}}\n\nРестартирајте го терминалот за да ја користите командата „mod“.",
