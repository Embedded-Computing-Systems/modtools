export const dict = {
  ...
  "desktop.updater.none.message": "თქვენ უკვე იყენებთ MOD-ის უახლეს ვერსიას",
  ...
  "desktop.updater.downloaded.prompt":
    "MOD-ის {{version}} ვერსია ჩამოტვირთულია, გსურთ მისი ინსტალაცია და ხელახლა გაშვება?",
  ...
  "desktop.cli.installed.message":
    "CLI დაინსტალირებულია {{path}}-ზე\n\nგადატვირთეთ ტერმინალი „mod“ ბრძანების გამოსაყენებლად.",
