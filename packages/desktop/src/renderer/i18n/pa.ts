export const dict = {
  ...
  "desktop.updater.none.message": "تسی پہلے ای MOD دا تازہ ترین ورژن استعمال کر رئے او",
  ...
  "desktop.updater.downloaded.prompt":
    "MOD دا ورژن {{version}} ڈاؤن لوڈ کر دتا گیا اے، کی تسی اینوں انسٹال کرنا تے دوبارہ لانچ کرنا چاہندے او؟",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} تے انسٹال کیتا گیا\n\n'mod' کمانڈ ورتن لئی اپنے ٹرمینل نوں دوبارہ شروع کرو۔",
