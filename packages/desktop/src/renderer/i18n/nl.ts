export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van MOD",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van MOD is gedownload. Wil je deze installeren en MOD opnieuw starten?",
  ...
  "desktop.cli.installed.message":
    "CLI geïnstalleerd op {{path}}\n\nStart je terminal opnieuw om de opdracht 'mod' te gebruiken.",
