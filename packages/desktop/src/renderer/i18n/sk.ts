export const dict = {
  ...
  "desktop.updater.none.message": "Používate najnovšiu verziu MOD",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzia {{version}} MOD bola stiahnutá. Chcete ju nainštalovať a reštartovať?",
  ...
  "desktop.cli.installed.message":
    "CLI bolo nainštalované do {{path}}\n\nReštartujte terminál, aby ste mohli používať príkaz 'mod'.",
