export const dict = {
  ...
  "desktop.updater.none.message": "MOD'un en son sürümünü zaten kullanıyorsunuz",
  ...
  "desktop.updater.downloaded.prompt":
    "MOD'un {{version}} sürümü indirildi. Şimdi yükleyip yeniden başlatmak ister misiniz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} konumuna yüklendi\n\n'mod' komutunu kullanmak için terminalinizi yeniden başlatın.",
