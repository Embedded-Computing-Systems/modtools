export const dict = {
  ...
  "desktop.updater.none.message": "Դուք արդեն օգտագործում եք MOD-ի վերջին տարբերակը",
  ...
  "desktop.updater.downloaded.prompt":
    "MOD-ի {{version}} տարբերակը ներբեռնվել է: Ցանկանու՞մ եք տեղադրել այն և վերագործարկել:",
  ...
  "desktop.cli.installed.message":
    "CLI-ն տեղադրված է {{path}}-ում\n\nՎերագործարկեք ձեր տերմինալը՝ «mod» հրամանն օգտագործելու համար:",
