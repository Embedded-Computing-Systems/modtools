export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de MOD",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de MOD. ¿Quieres instalarla y reiniciar?",
