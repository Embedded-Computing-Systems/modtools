export const dict = {
  ...
  "desktop.updater.none.message": "Artıq MOD-un ən son versiyasından istifadə edirsiniz",
  ...
  "desktop.updater.downloaded.prompt":
    "MOD-un {{version}} versiyası yüklənib. Onu quraşdırıb tətbiqi yenidən başlatmaq istəyirsiniz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} ünvanına quraşdırıldı\n\n'mod' əmrindən istifadə etmək üçün terminalı yenidən başladın.",
