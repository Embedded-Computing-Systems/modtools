export const dict = {
  ...
  "desktop.updater.none.message": "አሁን የቅርብ ጊዜውን የMOD ስሪት እየተጠቀሙ ነው",
  ...
  "desktop.updater.downloaded.prompt": "ስሪት {{version}} ከMOD ወርዷል፣ መጫን እና እንደገና ማስጀመር ይፈልጋሉ?",
