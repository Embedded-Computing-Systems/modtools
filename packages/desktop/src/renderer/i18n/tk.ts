export const dict = {
  ...
  "desktop.updater.none.message": "MOD-iň iň soňky wersiýasyny eýýäm ulanýarsyňyz",
  ...
  "desktop.updater.downloaded.prompt":
    "MOD-iň {{version}} wersiýasy göçürildi, ony gurup täzeden işletmek isleýärsiňizmi?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} salgysyna guruldy\n\n'mod' buýrugyny ulanmak üçin terminalyňyzy täzeden açyň.",
