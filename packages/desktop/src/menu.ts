    ...
    items: [
      ...
      await Submenu.new({
        ...
        items: [
          ...
          await MenuItem.new({
            action: () => openUrl("https://mod.ai/docs"),
            text: "MOD Documentation",
          }),
          await MenuItem.new({
            action: () => openUrl("https://discord.com/invite/mod"),
            text: "Support Forum",
          }),
          await PredefinedMenuItem.new({
            item: "Separator",
          ...
          await MenuItem.new({
            action: () => openUrl("https://github.com/anomalyco/mod/issues/new?template=feature_request.yml"),
            text: "Share Feedback",
          }),
          await MenuItem.new({
            action: () => openUrl("https://github.com/anomalyco/mod/issues/new?template=bug_report.yml"),
            text: "Report a Bug",
          }),
        ],
      }),
