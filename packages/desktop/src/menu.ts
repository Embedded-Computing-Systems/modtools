    ...
    items: [
      ...
      await Submenu.new({
        ...
        items: [
          ...
          await MenuItem.new({
            action: () => openUrl("https://modtools.ai/docs"),
            text: t("desktop.menu.help.documentation"),
          }),
          await MenuItem.new({
            action: () => openUrl("https://discord.com/invite/modtools"),
          ...
          await MenuItem.new({
            action: () => openUrl("https://github.com/Embedded-Computing-Systems/modtools/issues/new?template=feature_request.yml"),
            text: t("desktop.menu.help.shareFeedback"),
          }),
          await MenuItem.new({
            action: () => openUrl("https://github.com/Embedded-Computing-Systems/modtools/issues/new?template=bug_report.yml"),
