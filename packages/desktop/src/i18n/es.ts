export const dict = {
  ...
  "desktop.menu.help.documentation": "Documentación de Model-of-Design Tools",
  ...
  "desktop.cli.error.sidecarMissing":
    "Falta el binario de la CLI de Model-of-Design Tools. Intenta reinstalar la aplicación de escritorio.",
