export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de MOD Tools",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de MOD Tools. ¿Quieres instalarla y reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentación de MOD Tools",
  ...
  "desktop.cli.error.sidecarMissing":
    "Falta el binario de la CLI de MOD Tools. Intenta reinstalar la aplicación de escritorio.",
