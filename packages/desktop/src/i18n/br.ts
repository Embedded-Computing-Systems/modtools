export const dict = {
  ...
  "desktop.menu.help.documentation": "Documentação do Model-of-Design Tools",
  ...
  "desktop.cli.error.sidecarMissing":
    "O binário da CLI do Model-of-Design Tools está ausente. Tente reinstalar o aplicativo de desktop.",
