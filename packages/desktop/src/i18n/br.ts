export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do MOD Tools",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do MOD Tools foi baixada. Você gostaria de instalá-la e reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentação do MOD Tools",
  ...
  "desktop.cli.error.sidecarMissing":
    "O binário da CLI do MOD Tools está ausente. Tente reinstalar o aplicativo de desktop.",
