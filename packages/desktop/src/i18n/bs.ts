export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju MOD Tools-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} MOD Tools-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
  ...
  "desktop.menu.help.documentation": "MOD Tools Dokumentacija",
  ...
  "desktop.cli.error.sidecarMissing":
    "Nedostaje binarna datoteka MOD Tools CLI-a. Pokušaj ponovo instalirati desktop aplikaciju.",
