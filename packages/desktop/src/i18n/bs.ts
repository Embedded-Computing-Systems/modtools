export const dict = {
  ...
  "desktop.menu.help.documentation": "Model-of-Design Tools Dokumentacija",
  ...
  "desktop.cli.error.sidecarMissing":
    "Nedostaje binarna datoteka Model-of-Design Tools CLI-a. Pokušaj ponovo instalirati desktop aplikaciju.",
