export const dict = {
  ...
  "desktop.updater.none.message": "Вы уже используете последнюю версию MOD Tools",
  ...
  "desktop.updater.downloaded.prompt": "Версия MOD Tools {{version}} загружена. Хотите установить и перезапустить?",
  ...
  "desktop.menu.help.documentation": "Документация MOD Tools",
  ...
  "desktop.cli.error.sidecarMissing":
    "Отсутствует бинарный файл MOD Tools CLI. Попробуйте переустановить настольное приложение.",
