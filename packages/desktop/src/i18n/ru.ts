export const dict = {
  ...
  "desktop.menu.help.documentation": "Документация Model-of-Design Tools",
  ...
  "desktop.cli.error.sidecarMissing":
    "Отсутствует бинарный файл Model-of-Design Tools CLI. Попробуйте переустановить настольное приложение.",
