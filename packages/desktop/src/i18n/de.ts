export const dict = {
  ...
  "desktop.menu.help.documentation": "Model-of-Design Tools-Dokumentation",
  ...
  "desktop.cli.error.sidecarMissing":
    "Das Model-of-Design Tools CLI-Binary fehlt. Versuchen Sie, die Desktop-App neu zu installieren.",
