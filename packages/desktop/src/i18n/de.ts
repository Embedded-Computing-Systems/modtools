export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von MOD Tools",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von MOD Tools wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
  ...
  "desktop.menu.help.documentation": "MOD Tools-Dokumentation",
  ...
  "desktop.cli.error.sidecarMissing":
    "Das MOD Tools CLI-Binary fehlt. Versuchen Sie, die Desktop-App neu zu installieren.",
