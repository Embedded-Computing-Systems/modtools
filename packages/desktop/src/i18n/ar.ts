export const dict = {
  ...
  "desktop.menu.help.documentation": "وثائق Model-of-Design Tools",
  ...
  "desktop.cli.error.sidecarMissing": "ملف Model-of-Design Tools CLI الثنائي مفقود. حاول إعادة تثبيت تطبيق سطح المكتب.",
