export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من MOD Tools",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من MOD Tools، هل ترغب في تثبيته وإعادة تشغيله؟",
  ...
  "desktop.menu.help.documentation": "وثائق MOD Tools",
  ...
  "desktop.cli.error.sidecarMissing": "ملف MOD Tools CLI الثنائي مفقود. حاول إعادة تثبيت تطبيق سطح المكتب.",
