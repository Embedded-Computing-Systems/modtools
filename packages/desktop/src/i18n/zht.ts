export const dict = {
  ...
  "desktop.updater.none.message": "你已在使用最新版的 MOD Tools",
  ...
  "desktop.updater.downloaded.prompt": "已下載 MOD Tools {{version}} 版本，是否安裝並重新啟動？",
  ...
  "desktop.menu.help.documentation": "MOD Tools 文件",
  ...
  "desktop.cli.error.sidecarMissing": "MOD Tools CLI 執行檔遺失。請嘗試重新安裝桌面應用程式。",
