export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの MOD Tools を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "MOD Tools のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.menu.help.documentation": "MOD Tools ドキュメント",
  ...
  "desktop.cli.error.sidecarMissing":
    "MOD Tools CLI のバイナリが見つかりません。デスクトップアプリを再インストールしてみてください。",
