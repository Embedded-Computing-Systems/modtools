export const dict = {
  ...
  "desktop.menu.help.documentation": "Dokumentacja Model-of-Design Tools",
  ...
  "desktop.cli.error.sidecarMissing":
    "Brakuje pliku binarnego Model-of-Design Tools CLI. Spróbuj ponownie zainstalować aplikację na komputer.",
