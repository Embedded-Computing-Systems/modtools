export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji MOD Tools",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} MOD Tools. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.menu.help.documentation": "Dokumentacja MOD Tools",
  ...
  "desktop.cli.error.sidecarMissing":
    "Brakuje pliku binarnego MOD Tools CLI. Spróbuj ponownie zainstalować aplikację na komputer.",
