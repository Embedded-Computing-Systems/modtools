export const dict = {
  ...
  "desktop.menu.help.documentation": "Model-of-Design Tools Documentation",
  ...
  "desktop.cli.error.sidecarMissing": "Model-of-Design Tools CLI binary is missing. Try reinstalling the desktop app.",
