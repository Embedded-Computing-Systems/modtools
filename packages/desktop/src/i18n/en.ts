export const dict = {
  ...
  "desktop.menu.help.documentation": "MOD Tools Documentation",
  ...
  "desktop.updater.none.message": "You are already using the latest version of MOD Tools",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of MOD Tools has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.cli.error.sidecarMissing": "MOD Tools CLI binary is missing. Try reinstalling the desktop app.",
