export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'MOD Tools",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'MOD Tools a été téléchargée. Voulez-vous l'installer et redémarrer ?",
  ...
  "desktop.menu.help.documentation": "Documentation d'MOD Tools",
  ...
  "desktop.cli.error.sidecarMissing":
    "Le binaire de la CLI MOD Tools est manquant. Essayez de réinstaller l'application de bureau.",
