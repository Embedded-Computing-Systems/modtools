export const dict = {
  ...
  "desktop.menu.help.documentation": "Documentation d'Model-of-Design Tools",
  ...
  "desktop.cli.error.sidecarMissing":
    "Le binaire de la CLI Model-of-Design Tools est manquant. Essayez de réinstaller l'application de bureau.",
