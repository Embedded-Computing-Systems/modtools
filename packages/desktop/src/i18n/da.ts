export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af MOD Tools",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af MOD Tools er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.cli.error.sidecarMissing": "MOD Tools CLI-binærfil mangler. Prøv at geninstallere desktop-appen.",
