export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Model-of-Design Tools",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Model-of-Design Tools. ¿Quieres instalarla y reiniciar?",
