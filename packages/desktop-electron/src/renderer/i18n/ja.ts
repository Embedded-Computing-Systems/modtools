export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの Model-of-Design Tools を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "Model-of-Design Tools のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.cli.installed.message":
    "CLI を {{path}} にインストールしました\n\nターミナルを再起動して 'modtools' コマンドを使用してください。",
