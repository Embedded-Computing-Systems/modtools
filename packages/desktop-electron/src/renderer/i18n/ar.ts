export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من Model-of-Design Tools",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من Model-of-Design Tools، هل ترغب في تثبيته وإعادة تشغيله؟",
