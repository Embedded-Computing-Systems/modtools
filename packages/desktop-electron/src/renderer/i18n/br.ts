export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do Model-of-Design Tools",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do Model-of-Design Tools foi baixada. Você gostaria de instalá-la e reiniciar?",
