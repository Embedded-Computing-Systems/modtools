...
const deepLinkEvent = "modtools:deep-link"
...
const listenForDeepLinks = () => {
  const startUrls = window.__MOD__?.deepLinks ?? []
...
render(() => {
  ...
  const loadLocale = async () => {
    const current = await platform.storage?.("modtools.global.dat").getItem("language")
