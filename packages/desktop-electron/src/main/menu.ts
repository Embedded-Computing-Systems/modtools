...
export function createMenu(deps: Deps) {
  ...
  const template: Electron.MenuItemConstructorOptions[] = [
    ...
    { role: "windowMenu" },
    {
      label: "Help",
      submenu: [
        { label: "Model-of-Design Tools Documentation", click: () => shell.openExternal("https://modtools.ai/docs") },
        { label: "Support Forum", click: () => shell.openExternal("https://discord.com/invite/modtools") },
        { type: "separator" },
        { type: "separator" },
        {
          label: "Share Feedback",
          click: () =>
            shell.openExternal("https://github.com/Embedded-Computing-Systems/modtools/issues/new?template=feature_request.yml"),
        },
        {
          label: "Report a Bug",
          click: () => shell.openExternal("https://github.com/Embedded-Computing-Systems/modtools/issues/new?template=bug_report.yml"),
        },
      ],
    },
  ]
