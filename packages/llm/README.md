...
Schema-first LLM core for MOD. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@modtools-ai/llm"
import { OpenAI } from "@modtools-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@modtools-ai/llm/providers"
