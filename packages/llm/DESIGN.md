...
> current private `@modtools-ai/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@modtools-ai/ai`
...
- Secondary audience: MOD and other durable agent runtimes
...
import { LLM } from "@modtools-ai/ai"
import { OpenAI } from "@modtools-ai/ai/providers/openai"
...
```ts
import { Message } from "@modtools-ai/ai"
...
import { LLM, Tool } from "@modtools-ai/ai"
...
MOD and other durable runtimes need to own persistence, tool settlement,
...
```ts
import { LLM } from "@modtools-ai/ai/promise"
import { OpenAI } from "@modtools-ai/ai/providers/openai"
...
```ts
import { LLMSchema } from "@modtools-ai/ai/schema"
...
```ts
import { Provider, Protocol } from "@modtools-ai/ai/provider"
...
@modtools-ai/ai/promise
  Promise/AsyncIterable LLM facade

@modtools-ai/ai/schema
  serializable domain schemas

@modtools-ai/ai/provider
  experimental Provider and Protocol authoring APIs

@modtools-ai/ai/providers/openai
@modtools-ai/ai/providers/anthropic
@modtools-ai/ai/providers/google
...
```
...
| Current                                 | Proposed                                                    |
| --------------------------------------- | ----------------------------------------------------------- |
| `@modtools-ai/llm`                      | `@modtools-ai/ai`                                           |
...
MOD should migrate to `generateTurn` / `streamTurn`, preserving its durable
