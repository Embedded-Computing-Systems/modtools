...
const shareDisabled = process.env.MOD_DISABLE_SHARE === "true" || process.env.MOD_DISABLE_SHARE === "1"
...
test("/share and /unshare update session share state", async ({ page, project }) => {
  test.skip(shareDisabled, "Share is disabled in this environment (MOD_DISABLE_SHARE).")
