...
const GLOBAL_STORAGE = "mod.global.dat"
const WINDOW_STORAGE = "mod.window"
const LOCAL_PREFIX = "mod."
...
function workspaceStorage(dir: string) {
  ...
  return `mod.workspace.${head}.${sum}.dat`
}
