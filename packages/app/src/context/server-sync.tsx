import type { Config, ModClient, Path, Project, ProviderAuthResponse, Todo } from "@modtools-ai/sdk/v2/client"
...
import { createSimpleContext, NormalizedProviderListResponse } from "@modtools-ai/ui/context"
...
export const loadMcpQuery = (scope: ServerScope, directory: string, sdk: ModClient) =>
  queryOptions({
    queryKey: [scope, directory, "mcp"] as const,
    queryFn: () => sdk.mcp.status().then((r) => r.data ?? {}),
  })

export const loadLspQuery = (scope: ServerScope, directory: string, sdk: ModClient) =>
  queryOptions({
...
export function createServerSyncContextInner(serverSDK: ServerSDK) {
  ...
  const sdkCache = new Map<string, ModClient>()
