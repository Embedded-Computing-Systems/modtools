...
import { NormalizedProviderListResponse } from "@modtools-ai/session-ui/context"
...
export const loadGlobalConfigQuery = (scope: ServerScope, sdk: ModClient, protocol?: Promise<ServerProtocol>) =>
  queryOptions({
