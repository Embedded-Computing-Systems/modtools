...
import { base64Encode } from "@modtools-ai/shared/util/encode"
...
import { getFilename } from "@modtools-ai/shared/util/path"
import { Session, type Message } from "@modtools-ai/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@modtools-ai/ui/toast"
...
import { retry } from "@modtools-ai/shared/util/retry"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://modtools.ai/desktop-feedback")}
      renderPanel={() =>
