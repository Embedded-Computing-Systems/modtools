...
import { ProjectAvatar } from "@modtools-ai/ui/v2/project-avatar-v2"
        ...
        <Match when>
          ...
          >
            ...
            <div
              ...
              onMouseDown={drag}
            >
              <div id="MOD-titlebar-right" class="flex items-center gap-1 shrink-0 justify-end" />
              <Show when={windows()}>
...
function TitlebarV2Right(props: { state: TitlebarV2RightState }) {
  return (
    <div class="relative z-20 flex shrink-0 items-center justify-end gap-0 overflow-visible">
      ...
      <div id="MOD-titlebar-right" class="flex shrink-0 items-center justify-end gap-0" />
    </div>
  )
}
