...
beforeAll(async () => {
  ...
  mock.module("@modtools-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@modtools-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@modtools-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@modtools-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
