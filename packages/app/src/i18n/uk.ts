export const dict = {
  ...
  "desktop.menu.documentation": "Документація MOD",
  ...
  "desktop.menu.ariaLabel": "Меню MOD",
  ...
  "desktop.recovery.loadFailed": "Не вдалося завантажити MOD",
  "desktop.recovery.terminated": "Роботу вікна MOD несподівано завершено",
  "desktop.recovery.unresponsive": "MOD не відповідає",
  ...
  "desktop.wsl.error.installMod": "Не вдалося встановити MOD",
  "desktop.wsl.error.alreadyAdded": "{{distro}} уже додано",
  "desktop.wsl.error.modMissing": "mod не встановлено в цьому дистрибутиві",
  "desktop.wsl.error.modCannotRun": "mod встановлено, але його не вдалося запустити",
  "desktop.wsl.error.modNotInstalled": "MOD не встановлено в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Оновлення MOD завершено, але {{distro}} усе ще повідомляє про версію {{installed}}; очікувалася {{expected}}",
  ...
  "dialog.provider.mod.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.mod.tagline": "Надійні оптимізовані моделі",
  "dialog.provider.modGo.tagline": "Недорога підписка для всіх",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від MOD",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у MOD.",
  ...
  "provider.connect.modZen.line1":
    "MOD Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  "provider.connect.modZen.line2":
    "З одним ключем API ви отримаєте доступ до таких моделей, як Claude, GPT, Gemini, GLM та інших.",
  "provider.connect.modZen.visit.prefix": "Відвідайте ",
  "provider.connect.modZen.visit.link": "opencode.ai/zen",
  "provider.connect.modZen.visit.suffix": ", щоб отримати ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Відвідайте ",
  "provider.connect.oauth.code.visit.link": "це посилання",
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у MOD.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у MOD.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в MOD.json",
  ...
  "dialog.server.description": "Перемкніть сервер MOD, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingMod": "Перевірка MOD...",
  "wsl.onboarding.checkingModIn": "Перевірка MOD у {{distro}}...",
  "wsl.onboarding.updatingMod": "Оновлення MOD...",
  "wsl.onboarding.updatingModIn": "Оновлення MOD у {{distro}}...",
  "wsl.onboarding.updateModIn": "Оновіть MOD у {{distro}}.",
  "wsl.onboarding.updateMod": "Оновити MOD",
  "wsl.onboarding.modReadyIn": "MOD готовий до роботи у {{distro}}.",
  "wsl.onboarding.modReady": "MOD готовий до роботи.",
  "wsl.onboarding.installModIn": "Встановіть MOD у {{distro}}.",
  "wsl.onboarding.installMod": "Встановити MOD",
  ...
  "wsl.onboarding.distroStatus.modMissing": "MOD не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в MOD потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "MOD не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте MOD.",
  ...
  "help.tabs.introduction": "MOD Desktop тепер побудовано навколо вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Нова версія MOD ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді MOD",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (MOD.json)",
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, MOD ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "MOD містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер MOD всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу MOD",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд MOD на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи MOD використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему MOD.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску MOD",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію MOD.",
