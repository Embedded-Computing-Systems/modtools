export const dict = {
  ...
  "desktop.menu.documentation": "MOD Dokumentacija",
  ...
  "desktop.recovery.loadFailed": "MOD ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno MOD se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "MOD se ne odziva",
  ...
  "desktop.wsl.error.installMod": "Namestitev MOD ni uspela",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je že dodan",
  "desktop.wsl.error.modMissing": "mod ni nameščen v tej distribuciji",
  "desktop.wsl.error.modCannotRun": "mod je nameščen, vendar se ne more zagnati",
  "desktop.wsl.error.modNotInstalled": "MOD ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev MOD je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.provider.mod.note": "Izbrani modeli, vključno z Claude, GPT, Gemini in drugimi",
  "dialog.provider.mod.tagline": "Zanesljivi optimizirani modeli",
  "dialog.provider.modGo.tagline": "Poceni naročnina za vsakogar",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja MOD",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v MOD.",
  ...
  "provider.connect.modZen.line1":
    "MOD Zen vam omogoča dostop do izbranega nabora zanesljivih optimiziranih modelov za agente za kodiranje.",
  "provider.connect.modZen.line2":
    "Z enim samim ključem API boste dobili dostop do modelov, kot so Claude, GPT, Gemini, GLM in več.",
  "provider.connect.modZen.visit.prefix": "Obisk ",
  "provider.connect.modZen.visit.link": "opencode.ai/zen",
  "provider.connect.modZen.visit.suffix": " za prevzem ključa API.",
  "provider.connect.oauth.code.visit.prefix": "Obisk ",
  "provider.connect.oauth.code.visit.link": "ta povezava",
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v MOD.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v MOD.",
  ...
  "dialog.plugins.empty": "Vtičniki, konfigurirani v MOD.json",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom MOD se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingMod": "Preverjanje MOD ...",
  "wsl.onboarding.checkingModIn": "Preverjanje MOD v {{distro}} ...",
  "wsl.onboarding.updatingMod": "Posodabljanje MOD ...",
  "wsl.onboarding.updatingModIn": "Posodabljanje MOD v {{distro}} ...",
  "wsl.onboarding.updateModIn": "Posodobite MOD v {{distro}}.",
  "wsl.onboarding.updateMod": "Posodobite MOD",
  "wsl.onboarding.modReadyIn": "MOD je pripravljen v {{distro}}.",
  "wsl.onboarding.modReady": "MOD je pripravljen.",
  "wsl.onboarding.installModIn": "Namestite MOD v {{distro}}.",
  "wsl.onboarding.installMod": "Namestite MOD",
  ...
  "wsl.onboarding.distroStatus.modMissing": "MOD ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko MOD doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "MOD ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite MOD.",
  ...
  "help.tabs.introduction": "MOD Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica MOD ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi MOD",
  ...
  "error.chain.checkConfig": "Preverite imena ponudnikov/modelov konfiguracije (MOD.json).",
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, MOD še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "MOD vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik MOD znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za MOD",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako MOD izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali MOD sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo MOD.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene MOD",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico MOD.",
