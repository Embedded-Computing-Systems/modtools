...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða MOD",
  "MOD-glugganum var óvænt lokað",
  "MOD svarar ekki",
  ...
  "Uppsetning MOD mistókst",
  "{{distro}} hefur þegar verið bætt við",
  "mod er ekki uppsett í þessari dreifingu",
  "mod er uppsett en ekki var hægt að keyra það",
  "MOD er ekki uppsett í {{distro}}",
  "Uppfærslu MOD lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "dialog.provider.mod.note": "Sýndar gerðir þar á meðal Claude, GPT, Gemini og fleira",
  "dialog.provider.mod.tagline": "Áreiðanleg bjartsýni módel",
  "dialog.provider.modGo.tagline": "Lággjaldaáskrift fyrir alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá MOD",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í MOD.",
  ...
  "provider.connect.modZen.line1":
    "MOD Zen veitir þér aðgang að safni af áreiðanlegum og fínstilltum gerðum fyrir kóðunarmiðla.",
  "provider.connect.modZen.line2":
    "Með einum API lykli færðu aðgang að gerðum eins og Claude, GPT, Gemini, GLM og fleira.",
  "provider.connect.modZen.visit.prefix": "Heimsókn",
  "provider.connect.modZen.visit.link": "opencode.ai/zen",
  "provider.connect.modZen.visit.suffix": "til að safna API lykilnum þínum.",
  "provider.connect.oauth.code.visit.prefix": "Heimsókn",
  "provider.connect.oauth.code.visit.link": "þennan hlekk",
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í MOD.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í MOD.",
  ...
  "dialog.plugins.empty": "Viðbætur stilltar í MOD.json",
  ...
  "dialog.server.description": "Skiptu um hvaða MOD miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingMod": "Athugar MOD...",
  "wsl.onboarding.checkingModIn": "Athugar MOD í {{distro}}...",
  "wsl.onboarding.updatingMod": "Uppfærir MOD...",
  "wsl.onboarding.updatingModIn": "Uppfærir MOD í {{distro}}...",
  "wsl.onboarding.updateModIn": "Uppfærðu MOD í {{distro}}.",
  "wsl.onboarding.updateMod": "Uppfærðu MOD",
  "wsl.onboarding.modReadyIn": "MOD er tilbúið í {{distro}}.",
  "wsl.onboarding.modReady": "MOD er tilbúinn.",
  "wsl.onboarding.installModIn": "Settu upp MOD í {{distro}}.",
  "wsl.onboarding.installMod": "Settu upp MOD",
  ...
  "wsl.onboarding.distroStatus.modMissing": "MOD ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en MOD getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "MOD gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan MOD aftur.",
  ...
  "help.tabs.introduction": "MOD Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af MOD ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til MOD teymisins",
  ...
  "error.chain.checkConfig": "Athugaðu stillingar (MOD.json) þjónustuveitu/módelheiti",
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, MOD styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "MOD inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "settings.desktop.wsl.description": "Keyrðu MOD netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir MOD",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig MOD lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort MOD fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig MOD er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar MOD ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af MOD.",
