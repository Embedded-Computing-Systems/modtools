export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do MOD",
  ...
  "desktop.menu.ariaLabel": "Menu do MOD",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o MOD",
  "desktop.recovery.terminated": "A janela do MOD foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O MOD não está respondendo",
  ...
  "desktop.wsl.error.installMod": "Falha na instalação do MOD",
  "desktop.wsl.error.alreadyAdded": "{{distro}} já foi adicionada",
  "desktop.wsl.error.modMissing": "O mod não está instalado nesta distribuição",
  "desktop.wsl.error.modCannotRun": "O mod está instalado, mas não pôde ser executado",
  "desktop.wsl.error.modNotInstalled": "O MOD não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do MOD foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.provider.mod.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.mod.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.modGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo MOD",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no MOD.",
  ...
  "provider.connect.modZen.line1":
    "MOD Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.modZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.modZen.visit.prefix": "Visite ",
  "provider.connect.modZen.visit.link": "opencode.ai/zen",
  "provider.connect.modZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no MOD.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no MOD.",
  ...
  "dialog.plugins.empty": "Plugins configurados em MOD.json",
  ...
  "dialog.server.description": "Trocar para qual servidor MOD este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingMod": "Verificando o MOD...",
  "wsl.onboarding.checkingModIn": "Verificando o MOD em {{distro}}...",
  "wsl.onboarding.updatingMod": "Atualizando o MOD...",
  "wsl.onboarding.updatingModIn": "Atualizando o MOD em {{distro}}...",
  "wsl.onboarding.updateModIn": "Atualize o MOD em {{distro}}.",
  "wsl.onboarding.updateMod": "Atualizar o MOD",
  "wsl.onboarding.modReadyIn": "O MOD está pronto em {{distro}}.",
  "wsl.onboarding.modReady": "O MOD está pronto.",
  "wsl.onboarding.installModIn": "Instale o MOD em {{distro}}.",
  "wsl.onboarding.installMod": "Instalar o MOD",
  ...
  "wsl.onboarding.distroStatus.modMissing": "MOD não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o MOD possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O MOD não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o MOD novamente.",
  ...
  "help.tabs.introduction": "Agora, o MOD Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do MOD ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do MOD",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (MOD.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: MOD ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "MOD inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor MOD dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do MOD",
  ...
  "settings.general.row.appearance.description": "Personalize como o MOD aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o MOD segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o MOD é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o MOD iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do MOD.",
