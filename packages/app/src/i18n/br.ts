export const dict = {
  ...
  "dialog.provider.modtools.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.modtools.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.modtoolsGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Model-of-Design Tools",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Model-of-Design Tools.",
  ...
  "provider.connect.modtoolsZen.line1":
    "Model-of-Design Tools Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.modtoolsZen.visit.prefix": "Visite ",
  "provider.connect.modtoolsZen.visit.link": "modtools.ai/zen",
  "provider.connect.modtoolsZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Model-of-Design Tools.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Model-of-Design Tools.",
  ...
  "dialog.plugins.empty": "Plugins configurados em modtools.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Model-of-Design Tools este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do Model-of-Design Tools ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Model-of-Design Tools",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (modtools.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Model-of-Design Tools ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Model-of-Design Tools inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Model-of-Design Tools dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Model-of-Design Tools",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Model-of-Design Tools aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Model-of-Design Tools segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Model-of-Design Tools é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Model-of-Design Tools iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Model-of-Design Tools.",
