export const dict = {
  ...
  "desktop.menu.documentation": "MOD-documentatie",
  ...
  "desktop.recovery.loadFailed": "MOD kan niet worden geladen",
  "desktop.recovery.terminated": "Het MOD-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "MOD reageert niet",
  ...
  "desktop.wsl.error.installMod": "Installatie van MOD is mislukt",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is al toegevoegd",
  "desktop.wsl.error.modMissing": "mod is niet geïnstalleerd in deze distributie",
  "desktop.wsl.error.modCannotRun": "mod is geïnstalleerd, maar kan niet worden uitgevoerd",
  "desktop.wsl.error.modNotInstalled": "MOD is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De MOD-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.provider.mod.note": "Samengestelde modellen, waaronder Claude, GPT, Gemini en meer",
  "dialog.provider.mod.tagline": "Betrouwbare geoptimaliseerde modellen",
  "dialog.provider.modGo.tagline": "Goedkoop abonnement voor iedereen",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door MOD",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in MOD te gebruiken.",
  ...
  "provider.connect.modZen.line1":
    "MOD Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  "provider.connect.modZen.line2":
    "Met één API-sleutel krijg je toegang tot modellen zoals Claude, GPT, Gemini, GLM en meer.",
  "provider.connect.modZen.visit.prefix": "Ga naar ",
  "provider.connect.modZen.visit.link": "opencode.ai/zen",
  "provider.connect.modZen.visit.suffix": " om je API-sleutel op te halen.",
  "provider.connect.oauth.code.visit.prefix": "Ga naar ",
  "provider.connect.oauth.code.visit.link": "deze link",
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in MOD te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in MOD te gebruiken.",
  ...
  "dialog.plugins.empty": "Plug-ins geconfigureerd in MOD.json",
  ...
  "dialog.server.description": "Wijzig met welke MOD-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingMod": "MOD controleren...",
  "wsl.onboarding.checkingModIn": "MOD controleren in {{distro}}...",
  "wsl.onboarding.updatingMod": "MOD bijwerken...",
  "wsl.onboarding.updatingModIn": "MOD bijwerken in {{distro}}...",
  "wsl.onboarding.updateModIn": "Werk MOD bij in {{distro}}.",
  "wsl.onboarding.updateMod": "MOD bijwerken",
  "wsl.onboarding.modReadyIn": "MOD is gereed in {{distro}}.",
  "wsl.onboarding.modReady": "MOD is klaar.",
  "wsl.onboarding.installModIn": "Installeer MOD in {{distro}}.",
  "wsl.onboarding.installMod": "Installeer MOD",
  ...
  "wsl.onboarding.distroStatus.modMissing": "MOD niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat MOD een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "MOD kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens MOD opnieuw.",
  ...
  "help.tabs.introduction": "MOD Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van MOD ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het MOD-team",
  ...
  "error.chain.checkConfig": "Controleer de provider- en modelnamen in je configuratie (MOD.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: MOD ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "MOD bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de MOD-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor MOD",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe MOD eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of MOD het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van MOD aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer MOD wordt gestart",
  ...
  "settings.updates.toast.latest.title": "MOD is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van MOD.",
