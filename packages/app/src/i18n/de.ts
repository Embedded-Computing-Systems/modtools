...
export const dict = {
  ...
  "dialog.provider.mod.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.mod.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.modGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von MOD",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in MOD zu nutzen.",
  ...
  "provider.connect.modZen.line1":
    "MOD Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.modZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.modZen.visit.link": "opencode.ai/zen",
  "provider.connect.modZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in MOD zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in MOD zu nutzen.",
  ...
  "dialog.plugins.empty": "In MOD.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den MOD-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingMod": "MOD wird geprüft…",
  "wsl.onboarding.checkingModIn": "MOD in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingMod": "MOD wird aktualisiert…",
  "wsl.onboarding.updatingModIn": "MOD in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateModIn": "Aktualisieren Sie MOD in {{distro}}.",
  "wsl.onboarding.updateMod": "MOD aktualisieren",
  "wsl.onboarding.modReadyIn": "MOD ist in {{distro}} bereit.",
  "wsl.onboarding.modReady": "MOD ist bereit.",
  "wsl.onboarding.installModIn": "Installieren Sie MOD in {{distro}}.",
  "wsl.onboarding.installMod": "MOD installieren",
  ...
  "wsl.onboarding.distroStatus.modMissing": "MOD nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor MOD einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "MOD konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann MOD erneut.",
  ...
  "toast.update.description": "Eine neue Version von MOD ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem MOD-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie die Anbieter- und Modellnamen in Ihrer Konfiguration (MOD.json)",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: MOD unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "MOD mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "MOD enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "MOD-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für MOD ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie MOD auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob MOD dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von MOD anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von MOD automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "MOD ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von MOD wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "MOD konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das MOD-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "MOD reagiert nicht",
  ...
  "desktop.wsl.error.installMod": "MOD-Installation fehlgeschlagen",
  "desktop.wsl.error.alreadyAdded": "{{distro}} wurde bereits hinzugefügt",
  "desktop.wsl.error.modMissing": "mod ist in dieser Distribution nicht installiert",
  "desktop.wsl.error.modCannotRun": "mod ist installiert, konnte aber nicht ausgeführt werden",
  "desktop.wsl.error.modNotInstalled": "MOD ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das MOD-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "MOD Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
