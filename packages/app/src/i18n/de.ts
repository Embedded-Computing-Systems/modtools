...
export const dict = {
  ...
  "dialog.provider.modtools.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.modtools.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.modtoolsGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Model-of-Design Tools",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Model-of-Design Tools zu nutzen.",
  ...
  "provider.connect.modtoolsZen.line1":
    "Model-of-Design Tools Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.modtoolsZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.modtoolsZen.visit.link": "modtools.ai/zen",
  "provider.connect.modtoolsZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Model-of-Design Tools zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Model-of-Design Tools zu nutzen.",
  ...
  "dialog.plugins.empty": "In modtools.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Model-of-Design Tools-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von Model-of-Design Tools ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Model-of-Design Tools-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (modtools.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Model-of-Design Tools unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Model-of-Design Tools enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "Model-of-Design Tools-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Model-of-Design Tools ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie Model-of-Design Tools auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Model-of-Design Tools dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Model-of-Design Tools anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Model-of-Design Tools automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Model-of-Design Tools.",
