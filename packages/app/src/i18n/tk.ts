export const dict = {
  ...
  "desktop.menu.documentation": "MOD Resminamalar",
  ...
  "desktop.menu.ariaLabel": "MOD menýusy",
  ...
  "desktop.recovery.loadFailed": "MOD ýükläp bilmedi",
  "desktop.recovery.terminated": "MOD penjiresi garaşylmadyk ýagdaýda bes edildi",
  "desktop.recovery.unresponsive": "MOD jogap berenok",
  ...
  "desktop.wsl.error.installMod": "MOD gurmak şowsuz",
  "desktop.wsl.error.alreadyAdded": "{{distro}} eýýäm goşuldy",
  "desktop.wsl.error.modMissing": "açyk kod bu distroda gurlanok",
  "desktop.wsl.error.modCannotRun": "mod guruldy, ýöne işledip bilmedi",
  "desktop.wsl.error.modNotInstalled": "MOD {{distro}} gurulmady",
  "desktop.wsl.error.updateVersion":
    "MOD täzelenmesi gutardy, ýöne {{distro}} henizem {{installed}} habar berýär; garaşylýan {{expected}}",
  ...
  "dialog.provider.mod.note": "Claude, GPT, Gemini we ş.m.",
  "dialog.provider.mod.tagline": "Ygtybarly optimal modeller",
  "dialog.provider.modGo.tagline": "Hemmeler üçin arzan bahaly abuna",
  ...
  "dialog.model.unpaid.freeModels.title": "MOD tarapyndan mugt modeller",
  ...
  "provider.connect.apiKey.description":
    "Hasabyňyzy birikdirmek we MOD-da {{provider}} modellerini ulanmak üçin {{provider}} API açaryňyzy giriziň.",
  ...
  "provider.connect.modZen.line1":
    "MOD Zen kodlaşdyrmak serişdeleri üçin ygtybarly optimallaşdyrylan modelleriň toplumyna girmäge mümkinçilik berýär.",
  "provider.connect.modZen.line2":
    "Zekeje API açary bilen Claude, GPT, Gemini, GLM we başgalar ýaly modellere girip bilersiňiz.",
  "provider.connect.modZen.visit.prefix": "Sapar ",
  "provider.connect.modZen.visit.link": "opencode.ai/zen",
  "provider.connect.modZen.visit.suffix": " API açaryňyzy ýygnamak.",
  "provider.connect.oauth.code.visit.prefix": "Sapar ",
  "provider.connect.oauth.code.visit.link": "Bu baglanyşyk",
  "provider.connect.oauth.code.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini MOD-de ulanmak üçin ygtyýarnama koduňyzy ýygnamak.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini MOD-de ulanmak üçin aşakdaky kody giriziň.",
  ...
  "dialog.plugins.empty": "MOD.json-de düzülen pluginler",
  ...
  "dialog.server.description": "Bu programmanyň haýsy MOD serwerine birikýändigini üýtgediň.",
  ...
  "wsl.onboarding.checkingMod": "MOD barlamak ...",
  "wsl.onboarding.checkingModIn": "{{distro}} içinde MOD barlanýar...",
  "wsl.onboarding.updatingMod": "MOD täzelenmek ...",
  "wsl.onboarding.updatingModIn": "{{distro}}-de MOD täzelenmek ...",
  "wsl.onboarding.updateModIn": "MOD-ni {{distro}}-de täzeläň.",
  "wsl.onboarding.updateMod": "MOD täzeläň",
  "wsl.onboarding.modReadyIn": "MOD {{distro}}-de taýýar.",
  "wsl.onboarding.modReady": "MOD taýýar.",
  "wsl.onboarding.installModIn": "{{distro}}-de MOD guruň.",
  "wsl.onboarding.installMod": "MOD guruň",
  ...
  "wsl.onboarding.distroStatus.modMissing": "MOD gurulmady",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux üçin Windows kiçi ulgamy) MOD WSL serwerini goşmazdan ozal talap edilýär",
  "wsl.onboarding.wslUnavailable.title": "WSL elýeterli däl",
  "wsl.onboarding.wslUnavailable.description": "MOD bu enjamda WSL barlap bilmedi.",
  "wsl.onboarding.installWsl": "WSL guruň",
  "wsl.onboarding.windowsRestartRequired": "WSL gurnamagy gutarmak üçin Windows-i täzeden açyň, soňra MOD açyň.",
  ...
  "help.tabs.introduction": "MOD Desktop indi goýmalaryň töwereginde guruldy.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Indi gurmak üçin MOD ({{version}}) -iň täze wersiýasy bar.",
  ...
  "error.page.report.prefix": "Bu ýalňyşlygy MOD toparyna habar bermegiňizi haýyş edýäris",
  ...
  "error.chain.checkConfig": "Konfigurasiýaňyzy (MOD.json) üpjün edijiniň / model atlaryny barlaň",
  "error.chain.mcpFailed": 'MCP serweri "{{name}}" şowsuz. Üns beriň, MOD entek MCP tassyklamasyny goldamaýar.',
  ...
  "sidebar.gettingStarted.line1": "MOD mugt modelleri öz içine alýar, derrew başlap bilersiňiz.",
  ...
  "settings.desktop.wsl.description": "MOD serwerini WSL-de Windows-de işlediň.",
  ...
  "settings.general.row.language.description": "MOD üçin displeý dilini üýtgediň",
  ...
  "settings.general.row.appearance.description": "MOD enjamyňyzda nähili görünýändigini düzüň",
  "settings.general.row.colorScheme.title": "Reňk shemasy",
  "settings.general.row.colorScheme.description":
    "MOD ulgamy, ýagtylygy ýa-da garaňky temany yzarlaýandygyny saýlaň",
  "settings.general.row.theme.title": "Mowzuk",
  "settings.general.row.theme.description": "MOD-iň mowzuklydygyny düzüň.",
  ...
  "settings.updates.row.startup.description": "MOD işe başlanda täzelenmeleri awtomatiki barlaň",
  ...
  "settings.updates.toast.latest.description": "MOD-iň iň soňky wersiýasyny işleýärsiňiz.",
