export const dict = {
  ...
  "desktop.recovery.loadFailed": "โหลด MOD ไม่สำเร็จ",
  "desktop.recovery.terminated": "หน้าต่าง MOD หยุดทำงานโดยไม่คาดคิด",
  "desktop.recovery.unresponsive": "MOD ไม่ตอบสนอง",
  ...
  "desktop.wsl.error.installMod": "การติดตั้ง MOD ล้มเหลว",
  "desktop.wsl.error.alreadyAdded": "เพิ่ม {{distro}} แล้ว",
  "desktop.wsl.error.modMissing": "ไม่ได้ติดตั้ง mod ในดิสโทรนี้",
  "desktop.wsl.error.modCannotRun": "ติดตั้ง mod แล้ว แต่ไม่สามารถเรียกใช้ได้",
  "desktop.wsl.error.modNotInstalled": "ไม่ได้ติดตั้ง MOD ใน {{distro}}",
  "desktop.wsl.error.updateVersion":
    "อัปเดต MOD เสร็จแล้ว แต่ {{distro}} ยังคงรายงานเวอร์ชัน {{installed}} ทั้งที่ควรเป็น {{expected}}",
  ...
  "dialog.provider.mod.note": "โมเดลที่คัดสรร รวมถึง Claude, GPT, Gemini และอื่น ๆ",
  "dialog.provider.mod.tagline": "โมเดลที่เชื่อถือได้และปรับให้เหมาะสม",
  "dialog.provider.modGo.tagline": "การสมัครสมาชิกราคาประหยัดสำหรับทุกคน",
  ...
  "dialog.model.unpaid.freeModels.title": "โมเดลฟรีที่จัดหาให้โดย MOD",
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน MOD",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน MOD",
  ...
  "dialog.plugins.empty": "ปลั๊กอินที่กำหนดค่าใน MOD.json",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ MOD ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "wsl.onboarding.checkingMod": "กำลังตรวจสอบ MOD...",
  "wsl.onboarding.checkingModIn": "กำลังตรวจสอบ MOD ใน {{distro}}...",
  "wsl.onboarding.updatingMod": "กำลังอัปเดต MOD...",
  "wsl.onboarding.updatingModIn": "กำลังอัปเดต MOD ใน {{distro}}...",
  "wsl.onboarding.updateModIn": "อัปเดต MOD ใน {{distro}}",
  "wsl.onboarding.updateMod": "อัปเดต MOD",
  "wsl.onboarding.modReadyIn": "MOD พร้อมใช้งานใน {{distro}} แล้ว",
  "wsl.onboarding.modReady": "MOD พร้อมใช้งานแล้ว",
  "wsl.onboarding.installModIn": "ติดตั้ง MOD ใน {{distro}}",
  "wsl.onboarding.installMod": "ติดตั้ง MOD",
  ...
  "wsl.onboarding.distroStatus.modMissing": "ยังไม่ได้ติดตั้ง MOD",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ต้องมี WSL (Windows Subsystem for Linux) ก่อนที่ MOD จะเพิ่มเซิร์ฟเวอร์ WSL ได้",
  "wsl.onboarding.wslUnavailable.title": "WSL ไม่พร้อมใช้งาน",
  "wsl.onboarding.wslUnavailable.description": "MOD ไม่สามารถตรวจสอบ WSL บนเครื่องนี้ได้",
  "wsl.onboarding.installWsl": "ติดตั้ง WSL",
  "wsl.onboarding.windowsRestartRequired":
    "รีสตาร์ท Windows เพื่อให้การติดตั้ง WSL เสร็จสมบูรณ์ แล้วเปิด MOD อีกครั้ง",
  ...
  "help.tabs.introduction": "ตอนนี้ MOD Desktop สร้างขึ้นโดยใช้แท็บเป็นหลัก",
  "help.tabs.sessions":
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ MOD ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม MOD",
  ...
  "error.chain.checkConfig": "ตรวจสอบการกำหนดค่าของคุณ (MOD.json) ชื่อผู้ให้บริการ/โมเดล",
  "error.chain.mcpFailed": 'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า MOD ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
  ...
  "sidebar.gettingStarted.line1": "MOD รวมถึงโมเดลฟรีเพื่อให้คุณเริ่มต้นได้ทันที",
  ...
  "settings.desktop.wsl.description": "เรียกใช้เซิร์ฟเวอร์ MOD ภายใน WSL บน Windows",
  ...
  "settings.general.row.language.description": "เปลี่ยนภาษาที่แสดงสำหรับ MOD",
  ...
  "settings.general.row.appearance.description": "ปรับแต่งรูปลักษณ์ของ MOD บนอุปกรณ์ของคุณ",
  "settings.general.row.colorScheme.title": "โทนสี",
  "settings.general.row.colorScheme.description": "เลือกว่าจะให้ MOD ใช้ธีมตามระบบ สว่าง หรือมืด",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งธีมของ MOD",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ MOD เปิดใช้งาน",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้งาน MOD เวอร์ชันล่าสุด",
