export const dict = {
  ...
  "desktop.menu.documentation": "MOD Documentació",
  ...
  "desktop.menu.ariaLabel": "menú MOD.",
  ...
  "desktop.recovery.loadFailed": "MOD no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra MOD s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "MOD no respon",
  ...
  "desktop.wsl.error.installMod": "La instal·lació de MOD ha fallat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ja està afegit",
  "desktop.wsl.error.modMissing": "mod no està instal·lat en aquesta distribució",
  "desktop.wsl.error.modCannotRun": "mod està instal·lat però no s'ha pogut executar",
  "desktop.wsl.error.modNotInstalled": "MOD no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "MOD actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "dialog.provider.mod.note": "Models seleccionats que inclouen Claude, GPT, Gemini i més",
  "dialog.provider.mod.tagline": "Models optimitzats fiables",
  "dialog.provider.modGo.tagline": "Subscripció de baix cost per a tothom",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per MOD",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a MOD.",
  ...
  "provider.connect.modZen.line1":
    "MOD Zen us ofereix accés a un conjunt seleccionat de models optimitzats fiables per a agents de codificació.",
  ...
  "provider.connect.modZen.visit.suffix": " per recollir la teva clau API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "aquest enllaç",
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a MOD.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a MOD.",
  ...
  "dialog.plugins.empty": "Connectors configurats a MOD.json",
  ...
  "dialog.server.description": "Canvia a quin MOD servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingMod": "S'està comprovant MOD...",
  "wsl.onboarding.checkingModIn": "S'està registrant MOD a {{distro}}...",
  "wsl.onboarding.updatingMod": "S'està actualitzant MOD...",
  "wsl.onboarding.updatingModIn": "S'està actualitzant MOD a {{distro}}...",
  "wsl.onboarding.updateModIn": "Actualitza MOD a {{distro}}.",
  "wsl.onboarding.updateMod": "Actualització MOD",
  "wsl.onboarding.modReadyIn": "MOD està llest a {{distro}}.",
  "wsl.onboarding.modReady": "MOD està llest.",
  "wsl.onboarding.installModIn": "Instal·leu MOD a {{distro}}.",
  "wsl.onboarding.installMod": "Instal·la MOD",
  ...
  "wsl.onboarding.distroStatus.modMissing": "MOD no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que MOD pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "MOD no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir MOD.",
  ...
  "help.tabs.introduction": "MOD L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de MOD ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip MOD.",
  ...
  "error.chain.checkConfig": "Comproveu els noms del vostre proveïdor/model de configuració (MOD.json).",
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que MOD encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "MOD inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "MOD Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor MOD dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a MOD",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu MOD al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si MOD segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de MOD.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï MOD.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de MOD.",
