export const dict = {
  ...
  "desktop.menu.documentation": "MOD დოკუმენტაცია",
  ...
  "desktop.menu.ariaLabel": "MOD მენიუ",
  ...
  "desktop.recovery.loadFailed": "MOD ვერ ჩაიტვირთა",
  "desktop.recovery.terminated": "MOD ფანჯარა მოულოდნელად შეწყდა",
  "desktop.recovery.unresponsive": "MOD არ პასუხობს",
  ...
  "desktop.wsl.error.installMod": "MOD ინსტალაცია ვერ მოხერხდა",
  "desktop.wsl.error.alreadyAdded": "{{distro}} უკვე დამატებულია",
  "desktop.wsl.error.modMissing": "mod არ არის დაინსტალირებული ამ დისტროში",
  "desktop.wsl.error.modCannotRun": "mod დაინსტალირებულია, მაგრამ ვერ გაშვება",
  "desktop.wsl.error.modNotInstalled": "MOD არ არის დაინსტალირებული {{distro}}",
  "desktop.wsl.error.updateVersion":
    "MOD განახლება დასრულდა, მაგრამ {{distro}} კვლავ იუწყება {{installed}}; მოსალოდნელია {{expected}}",
  ...
  "dialog.provider.mod.note": "კურირებული მოდელები, მათ შორის Claude, GPT, Gemini და სხვა",
  "dialog.provider.mod.tagline": "სანდო ოპტიმიზებული მოდელები",
  "dialog.provider.modGo.tagline": "დაბალფასიანი გამოწერა ყველასთვის",
  ...
  "dialog.model.unpaid.freeModels.title": "უფასო მოდელები მოწოდებულია MOD",
  ...
  "provider.connect.apiKey.description":
    "შეიყვანეთ თქვენი {{provider}} API გასაღები თქვენი ანგარიშის დასაკავშირებლად და გამოიყენეთ {{provider}} მოდელები MOD-ში.",
  ...
  "provider.connect.modZen.line1":
    "MOD Zen გაძლევთ წვდომას კოდირების აგენტებისთვის საიმედო ოპტიმიზირებული მოდელების კურირებულ კომპლექტზე.",
  ...
  "provider.connect.modZen.visit.prefix": "ეწვიეთ ",
  "provider.connect.modZen.visit.link": "opencode.ai/zen",
  "provider.connect.modZen.visit.suffix": " თქვენი API გასაღების შესაგროვებლად.",
  "provider.connect.oauth.code.visit.prefix": "ეწვიეთ ",
  "provider.connect.oauth.code.visit.link": "ეს ბმული",
  "provider.connect.oauth.code.visit.suffix":
    " შეაგროვეთ თქვენი ავტორიზაციის კოდი თქვენი ანგარიშის დასაკავშირებლად და გამოიყენოთ {{provider}} მოდელები MOD-ში.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " და შეიყვანეთ ქვემოთ კოდი თქვენი ანგარიშის დასაკავშირებლად და გამოიყენეთ {{provider}} მოდელები MOD-ში.",
  ...
  "dialog.plugins.empty": "პლაგინები კონფიგურირებულია MOD.json-ში",
  ...
  "dialog.server.description": "გადართეთ რომელ MOD სერვერს უკავშირდება ეს აპი.",
  ...
  "wsl.onboarding.checkingMod": "შემოწმებულია MOD...",
  "wsl.onboarding.checkingModIn": "შემოწმებულია MOD-ში {{distro}}...",
  "wsl.onboarding.updatingMod": "განახლება MOD...",
  "wsl.onboarding.updatingModIn": "MOD განახლება ხდება {{distro}}...",
  "wsl.onboarding.updateModIn": "განახლება MOD {{distro}}-ში.",
  "wsl.onboarding.updateMod": "განახლება MOD",
  "wsl.onboarding.modReadyIn": "MOD მზად არის {{distro}}-ში.",
  "wsl.onboarding.modReady": "MOD მზად არის.",
  "wsl.onboarding.installModIn": "დააინსტალირეთ MOD {{distro}}-ში.",
  "wsl.onboarding.installMod": "დააინსტალირეთ MOD",
  ...
  "wsl.onboarding.distroStatus.modMissing": "MOD არ არის დაინსტალირებული",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows ქვესისტემა Linux-ისთვის) საჭიროა, სანამ MOD შეძლებს WSL სერვერის დამატებას",
  "wsl.onboarding.wslUnavailable.title": "WSL მიუწვდომელია",
  "wsl.onboarding.wslUnavailable.description": "MOD ვერ დაადასტურა WSL ამ მოწყობილობაზე.",
  "wsl.onboarding.installWsl": "დააინსტალირეთ WSL",
  "wsl.onboarding.windowsRestartRequired":
    "გადატვირთეთ Windows WSL-ის ინსტალაციის დასასრულებლად, შემდეგ ხელახლა გახსენით MOD.",
  ...
  "help.tabs.introduction": "MOD სამუშაო მაგიდა ახლა აგებულია ჩანართების გარშემო.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "MOD-ის ({{version}}) ახალი ვერსია ახლა ხელმისაწვდომია დასაინსტალირებლად.",
  ...
  "error.page.report.prefix": "გთხოვთ, შეატყობინოთ ეს შეცდომა MOD გუნდს",
  ...
  "error.chain.checkConfig": "შეამოწმეთ თქვენი კონფიგურაცია (MOD.json) პროვაიდერის/მოდელების სახელები",
  "error.chain.mcpFailed":
    'MCP სერვერი "{{name}}" ვერ მოხერხდა. შენიშვნა, MOD ჯერ არ უჭერს მხარს MCP ავთენტიფიკაციას.',
  ...
  "sidebar.gettingStarted.line1": "MOD მოიცავს უფასო მოდელებს, ასე რომ თქვენ შეგიძლიათ დაუყოვნებლივ დაიწყოთ.",
  ...
  "app.name.desktop": "MOD სამუშაო მაგიდა",
  ...
  "settings.desktop.wsl.description": "გაუშვით MOD სერვერი WSL-ში Windows-ზე.",
  ...
  "settings.general.row.language.description": "შეცვალეთ ჩვენების ენა MOD",
  ...
  "settings.general.row.appearance.description": "მორგეთ, როგორ გამოიყურება MOD თქვენს მოწყობილობაზე",
  "settings.general.row.colorScheme.title": "ფერთა სქემა",
  "settings.general.row.colorScheme.description": "აირჩიეთ, მიჰყვება თუ არა MOD სისტემას, ღია თუ ბნელ თემას",
  "settings.general.row.theme.title": "თემა",
  "settings.general.row.theme.description": "მორგება, თუ როგორ არის MOD თემატური.",
  ...
  "settings.updates.row.startup.description": "ავტომატურად შეამოწმეთ განახლებები, როდესაც MOD გაშვება",
  ...
  "settings.updates.toast.latest.description": "თქვენ იყენებთ MOD-ის უახლეს ვერსიას.",
