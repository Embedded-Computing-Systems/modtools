...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "MOD failed to load",
  "desktop.recovery.terminated": "MOD window terminated unexpectedly",
  "desktop.recovery.unresponsive": "MOD is not responding",
  ...
  "desktop.wsl.error.installMod": "MOD installation failed",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is already added",
  "desktop.wsl.error.modMissing": "mod is not installed in this distro",
  "desktop.wsl.error.modCannotRun": "mod is installed but could not run",
  "desktop.wsl.error.modNotInstalled": "MOD is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "MOD update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
