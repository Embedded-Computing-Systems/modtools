export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi MOD",
  ...
  "desktop.recovery.loadFailed": "MOD gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap MOD ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "MOD tidak memberi respons",
  ...
  "desktop.wsl.error.installMod": "Pemasangan MOD gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} telah pun ditambah",
  "desktop.wsl.error.modMissing": "mod tidak dipasang dalam distro ini",
  "desktop.wsl.error.modCannotRun": "mod dipasang tetapi tidak dapat dijalankan",
  "desktop.wsl.error.modNotInstalled": "MOD tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini MOD selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.provider.mod.note": "Model terpilih termasuk Claude, GPT, Gemini dan banyak lagi",
  "dialog.provider.mod.tagline": "Model dioptimumkan yang boleh dipercayai",
  "dialog.provider.modGo.tagline": "Langganan kos rendah untuk semua",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh MOD",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam MOD.",
  ...
  "provider.connect.modZen.line1":
    "MOD Zen memberi anda akses kepada set model terpilih yang boleh dipercayai dan dioptimumkan untuk ejen pengekodan.",
  ...
  "provider.connect.modZen.visit.prefix": "Layari",
  "provider.connect.modZen.visit.link": "opencode.ai/zen",
  "provider.connect.modZen.visit.suffix": "untuk mendapatkan kunci API anda.",
  "provider.connect.oauth.code.visit.prefix": "Layari",
  "provider.connect.oauth.code.visit.link": "pautan ini",
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam MOD.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam MOD.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi dalam MOD.json",
  ...
  "dialog.server.description": "Tukar pelayan MOD yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingMod": "Sedang menyemak MOD...",
  "wsl.onboarding.checkingModIn": "Sedang menyemak MOD dalam {{distro}}...",
  "wsl.onboarding.updatingMod": "Sedang mengemas kini MOD...",
  "wsl.onboarding.updatingModIn": "Sedang mengemas kini MOD dalam {{distro}}...",
  "wsl.onboarding.updateModIn": "Kemas kini MOD dalam {{distro}}.",
  "wsl.onboarding.updateMod": "Kemas kini MOD",
  "wsl.onboarding.modReadyIn": "MOD sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.modReady": "MOD sedia digunakan.",
  "wsl.onboarding.installModIn": "Pasang MOD dalam {{distro}}.",
  "wsl.onboarding.installMod": "Pasang MOD",
  ...
  "wsl.onboarding.distroStatus.modMissing": "MOD belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum MOD boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "MOD tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula MOD.",
  ...
  "help.tabs.introduction": "MOD Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu MOD ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan MOD",
  ...
  "error.chain.checkConfig": "Semak konfigurasi anda (MOD.json) nama penyedia/model",
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, MOD belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "MOD merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan MOD dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk MOD",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa MOD pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada MOD mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema MOD.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila MOD dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini MOD.",
