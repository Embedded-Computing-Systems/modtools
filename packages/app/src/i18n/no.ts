...
export const dict = {
  ...
  "dialog.provider.modtools.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.modtools.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.modtoolsGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Model-of-Design Tools",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Model-of-Design Tools.",
  ...
  "provider.connect.modtoolsZen.line1":
    "Model-of-Design Tools Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.modtoolsZen.visit.prefix": "Besøk ",
  "provider.connect.modtoolsZen.visit.link": "modtools.ai/zen",
  "provider.connect.modtoolsZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Model-of-Design Tools.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Model-of-Design Tools.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i modtools.json",
  ...
  "dialog.server.description": "Bytt hvilken Model-of-Design Tools-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Model-of-Design Tools ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Model-of-Design Tools-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (modtools.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Model-of-Design Tools ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Model-of-Design Tools inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Model-of-Design Tools-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Model-of-Design Tools",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Model-of-Design Tools ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Model-of-Design Tools skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Model-of-Design Tools er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Model-of-Design Tools starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Model-of-Design Tools.",
