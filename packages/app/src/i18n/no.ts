...
export const dict = {
  ...
  "desktop.menu.documentation": "MOD-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "MOD-meny",
  ...
  "desktop.recovery.loadFailed": "MOD kunne ikke lastes inn",
  "desktop.recovery.terminated": "MOD-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "MOD svarer ikke",
  ...
  "desktop.wsl.error.installMod": "Installasjonen av MOD mislyktes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede lagt til",
  "desktop.wsl.error.modMissing": "mod er ikke installert i denne distribusjonen",
  "desktop.wsl.error.modCannotRun": "mod er installert, men kunne ikke kjøres",
  "desktop.wsl.error.modNotInstalled": "MOD er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av MOD er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.provider.mod.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.mod.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.modGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av MOD",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i MOD.",
  ...
  "provider.connect.modZen.line1":
    "MOD Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.modZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.modZen.visit.prefix": "Besøk ",
  "provider.connect.modZen.visit.link": "opencode.ai/zen",
  "provider.connect.modZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i MOD.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i MOD.",
  ...
  "dialog.plugins.empty": "Programtillegg konfigurert i MOD.json",
  ...
  "dialog.server.description": "Bytt hvilken MOD-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av MOD ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til MOD-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (MOD.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at MOD ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "MOD inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør MOD-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for MOD",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan MOD ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om MOD skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i MOD.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når MOD starter",
  ...
  "settings.updates.toast.latest.title": "MOD er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av MOD.",
  ...
  "wsl.onboarding.checkingMod": "Sjekker MOD...",
  "wsl.onboarding.checkingModIn": "Sjekker MOD i {{distro}}...",
  "wsl.onboarding.updatingMod": "Oppdaterer MOD...",
  "wsl.onboarding.updatingModIn": "Oppdaterer MOD i {{distro}}...",
  "wsl.onboarding.updateModIn": "Oppdater MOD i {{distro}}.",
  "wsl.onboarding.updateMod": "Oppdater MOD",
  "wsl.onboarding.modReadyIn": "MOD er klar i {{distro}}.",
  "wsl.onboarding.modReady": "MOD er klar.",
  "wsl.onboarding.installModIn": "Installer MOD i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.modMissing": "MOD er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før MOD kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "MOD kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter MOD på nytt.",
  ...
  "help.tabs.introduction": "MOD Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
