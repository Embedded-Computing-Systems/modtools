export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacioni MOD",
  ...
  "desktop.menu.ariaLabel": "Menuja MOD",
  ...
  "desktop.recovery.loadFailed": "MOD nuk u ngarkua",
  "desktop.recovery.terminated": "Dritarja MOD u mbyll papritur",
  "desktop.recovery.unresponsive": "MOD nuk po përgjigjet",
  ...
  "desktop.wsl.error.installMod": "Instalimi i MOD dështoi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} është shtuar tashmë",
  "desktop.wsl.error.modMissing": "Mod nuk është i instaluar në këtë shpërndarje",
  "desktop.wsl.error.modCannotRun": "Mod është instaluar por nuk mund të ekzekutohet",
  "desktop.wsl.error.modNotInstalled": "MOD nuk është i instaluar në {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Përditësimi i MOD përfundoi, por {{distro}} ende raporton {{installed}}; pritet {{expected}}",
  ...
  "dialog.provider.mod.note": "Modele të kuruara duke përfshirë Claude, GPT, Gemini dhe më shumë",
  "dialog.provider.mod.tagline": "Modele të besueshme të optimizuara",
  "dialog.provider.modGo.tagline": "Abonim me kosto të ulët për të gjithë",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele falas të ofruara nga MOD",
  ...
  "provider.connect.apiKey.description":
    "Futni çelësin API të {{provider}} për të lidhur llogarinë dhe për të përdorur modelet {{provider}} në MOD.",
  ...
  "provider.connect.modZen.line1":
    "MOD Zen ju jep akses në një grup të kuruar modelesh të optimizuara të besueshme për agjentët e kodimit.",
  ...
  "provider.connect.modZen.visit.prefix": "Vizitoni ",
  "provider.connect.modZen.visit.link": "opencode.ai/zen",
  "provider.connect.modZen.visit.suffix": " për të mbledhur çelësin tuaj API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitoni ",
  "provider.connect.oauth.code.visit.link": "kjo lidhje",
  "provider.connect.oauth.code.visit.suffix":
    " për të mbledhur kodin tuaj të autorizimit për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në MOD.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dhe futni kodin më poshtë për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në MOD.",
  ...
  "dialog.plugins.empty": "Shtojcat e konfiguruara në MOD.json",
  ...
  "dialog.server.description": "Ndrysho me cilin server MOD lidhet ky aplikacion.",
  ...
  "wsl.onboarding.checkingMod": "Po kontrollon MOD...",
  "wsl.onboarding.checkingModIn": "Po kontrollon MOD në {{distro}}...",
  "wsl.onboarding.updatingMod": "MOD po përditësohet...",
  "wsl.onboarding.updatingModIn": "Po përditëson MOD në {{distro}}...",
  "wsl.onboarding.updateModIn": "Përditëso MOD në {{distro}}.",
  "wsl.onboarding.updateMod": "Përditëso MOD",
  "wsl.onboarding.modReadyIn": "MOD është gati në {{distro}}.",
  "wsl.onboarding.modReady": "MOD është gati.",
  "wsl.onboarding.installModIn": "Instaloni MOD në {{distro}}.",
  "wsl.onboarding.installMod": "Instaloni MOD",
  ...
  "wsl.onboarding.distroStatus.modMissing": "MOD nuk është i instaluar",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Nënsistemi Windows për Linux) kërkohet përpara se MOD të shtojë një server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL i padisponueshëm",
  "wsl.onboarding.wslUnavailable.description": "MOD nuk mund ta verifikonte WSL në këtë makinë.",
  "wsl.onboarding.installWsl": "Instaloni WSL",
  "wsl.onboarding.windowsRestartRequired": "Rinis Windows për të përfunduar instalimin e WSL, më pas rihap MOD.",
  ...
  "help.tabs.introduction": "MOD Desktop tani është ndërtuar rreth skedave.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Një version i ri i MOD ({{version}}) është tani i disponueshëm për t'u instaluar.",
  ...
  "error.page.report.prefix": "Ju lutemi raportoni këtë gabim te ekipi i MOD",
  ...
  "error.chain.checkConfig": "Kontrolloni emrat e ofruesit/modelit tuaj të konfigurimit (MOD.json).",
  "error.chain.mcpFailed": 'Serveri MCP "{{name}}" dështoi. Shënim, MOD nuk e mbështet ende vërtetimin MCP.',
  ...
  "sidebar.gettingStarted.line1": "MOD përfshin modele falas, kështu që mund të filloni menjëherë.",
  ...
  "settings.desktop.wsl.description": "Ekzekutoni serverin MOD brenda WSL në Windows.",
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për MOD",
  ...
  "settings.general.row.appearance.description": "Personalizojeni se si duket MOD në pajisjen tuaj",
  "settings.general.row.colorScheme.title": "Skema e ngjyrave",
  "settings.general.row.colorScheme.description":
    "Zgjidhni nëse MOD ndjek temën e sistemit, të lehtë ose të errët",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizojeni se si është tema e MOD.",
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset MOD",
  ...
  "settings.updates.toast.latest.description": "Ju jeni duke ekzekutuar versionin më të fundit të MOD.",
