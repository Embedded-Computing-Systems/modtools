export const dict = {
  ...
  "dialog.provider.modtools.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.modtools.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.modtoolsGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Model-of-Design Tools",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Model-of-Design Tools.",
  ...
  "provider.connect.modtoolsZen.line1":
    "Model-of-Design Tools Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Model-of-Design Tools.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Model-of-Design Tools.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i modtools.json",
  ...
  "dialog.server.description": "Skift hvilken Model-of-Design Tools-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af Model-of-Design Tools ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Model-of-Design Tools-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (modtools.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Model-of-Design Tools understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Model-of-Design Tools inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Model-of-Design Tools-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Model-of-Design Tools",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan Model-of-Design Tools ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om Model-of-Design Tools følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Model-of-Design Tools er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Model-of-Design Tools starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Model-of-Design Tools.",
