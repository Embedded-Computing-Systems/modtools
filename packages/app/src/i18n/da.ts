export const dict = {
  ...
  "dialog.provider.mod.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.mod.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.modGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af MOD",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i MOD.",
  ...
  "provider.connect.modZen.line1":
    "MOD Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.modZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.modZen.visit.prefix": "Besøg ",
  "provider.connect.modZen.visit.link": "opencode.ai/zen",
  "provider.connect.modZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i MOD.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i MOD.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i MOD.json",
  ...
  "dialog.server.description": "Skift hvilken MOD-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingMod": "Tjekker MOD...",
  "wsl.onboarding.checkingModIn": "Tjekker MOD i {{distro}}...",
  "wsl.onboarding.updatingMod": "Opdaterer MOD...",
  "wsl.onboarding.updatingModIn": "Opdaterer MOD i {{distro}}...",
  "wsl.onboarding.updateModIn": "Opdater MOD i {{distro}}.",
  "wsl.onboarding.updateMod": "Opdater MOD",
  ...
  "wsl.onboarding.distroStatus.modMissing": "MOD er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før MOD kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "MOD kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter MOD igen.",
  ...
  "toast.update.description": "En ny version af MOD ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til MOD-teamet",
  ...
  "error.chain.checkConfig": "Kontrollér udbyder- og modelnavnene i din konfiguration (MOD.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, MOD understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "MOD inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør MOD-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for MOD",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan MOD ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om MOD skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når MOD starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af MOD.",
  ...
  "desktop.recovery.loadFailed": "MOD kunne ikke indlæses",
  "desktop.recovery.terminated": "MOD-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installMod": "Installationen af MOD mislykkedes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede tilføjet",
  "desktop.wsl.error.modMissing": "mod er ikke installeret i denne distribution",
  "desktop.wsl.error.modCannotRun": "mod er installeret, men kunne ikke køre",
  "desktop.wsl.error.modNotInstalled": "MOD er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af MOD er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "MOD Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
