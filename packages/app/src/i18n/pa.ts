export const dict = {
  ...
  "desktop.menu.documentation": "MOD دیاں دستاویزاں",
  ...
  "desktop.recovery.loadFailed": "MOD لوڈ نئیں ہو سکیا",
  "desktop.recovery.terminated": "MOD دی ونڈو اچانک بند ہو گئی",
  "desktop.recovery.unresponsive": "MOD جواب نئیں دے رہیا",
  ...
  "desktop.wsl.error.installMod": "MOD دی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ای شامل اے",
  "desktop.wsl.error.modMissing": "اس ڈسٹرو وچ mod انسٹال نئیں اے",
  "desktop.wsl.error.modCannotRun": "mod انسٹال اے پر چل نئیں سکیا",
  "desktop.wsl.error.modNotInstalled": "{{distro}} وچ MOD انسٹال نئیں اے",
  "desktop.wsl.error.updateVersion":
    "MOD دی اپ ڈیٹ پوری ہو گئی پر {{distro}} ہلے وی {{installed}} دس رہیا اے؛ {{expected}} چاہیدا سی",
  ...
  "dialog.provider.mod.note": "Claude، GPT، Gemini تے ہور سمیت کیوریٹڈ ماڈل",
  "dialog.provider.mod.tagline": "قابل اعتماد اصلاح شدہ ماڈل",
  "dialog.provider.modGo.tagline": "ہر اک لئی گھٹ قیمت دی رکنیت",
  ...
  "dialog.model.unpaid.freeModels.title": "MOD دے ذریعہ فراہم کردہ مفت ماڈل",
  ...
  "provider.connect.apiKey.description":
    "اپنے اکاؤنٹ نوں جوڑن لئی اپنی {{provider}} API کلید درج کرو تے MOD وچ {{provider}} ماڈل ورتو۔",
  ...
  "provider.connect.modZen.visit.prefix": "ویکھو ",
  "provider.connect.modZen.visit.link": "opencode.ai/zen",
  "provider.connect.modZen.visit.suffix": " اپنی API کلید حاصل کرن لئی۔",
  "provider.connect.oauth.code.visit.prefix": "ویکھو ",
  "provider.connect.oauth.code.visit.link": "ایہہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    " اپنے اکاؤنٹ نوں جوڑن تے MOD وچ {{provider}} ماڈل ورتن لئی اپنا اجازت کوڈ حاصل کرن لئی۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " تے اپنے اکاؤنٹ نوں جوڑن تے MOD وچ {{provider}} ماڈل ورتن لئی تھلے دتا کوڈ درج کرو۔",
  ...
  "dialog.plugins.empty": "MOD.json وچ سیٹ کیتے پلگ اِن",
  ...
  "dialog.server.description": "ایہہ ایپ کس MOD سرور نال جڑدی اے، اس نوں سوئچ کرو۔",
  ...
  "wsl.onboarding.checkingMod": "MOD چیک کر رئے آں...",
  "wsl.onboarding.checkingModIn": "{{distro}} چ MOD دی جانچ پڑتال...",
  "wsl.onboarding.updatingMod": "MOD نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updatingModIn": "{{distro}} وچ MOD نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updateModIn": "{{distro}} وچ MOD نو اپ ڈیٹ کرو۔",
  "wsl.onboarding.updateMod": "MOD اپ ڈیٹ کرو",
  "wsl.onboarding.modReadyIn": "MOD {{distro}} چ تیار اے۔",
  "wsl.onboarding.modReady": "MOD تیار اے۔",
  "wsl.onboarding.installModIn": "{{distro}} وچ MOD انسٹال کرو۔",
  "wsl.onboarding.installMod": "MOD انسٹال کرو",
  ...
  "wsl.onboarding.distroStatus.modMissing": "MOD انسٹال نئیں کیتا گیا",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "MOD دے WSL سرور شامل کرن توں پہلاں WSL (Windows Subsystem for Linux) دی لوڑ اے",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نئیں",
  "wsl.onboarding.wslUnavailable.description": "MOD ایس مشین تے WSL دی تصدیق نئیں کر سکیا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کرو",
  "wsl.onboarding.windowsRestartRequired":
    "WSL دی تنصیب پوری کرن لئی Windows نوں دوبارہ شروع کرو، فیر MOD دوبارہ کھولو۔",
  ...
  "help.tabs.introduction": "MOD Desktop ہن ٹیباں دے گرد بنایا گیا اے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "MOD ({{version}}) دا اک نواں ورژن ہن انسٹال کرن لئی دستیاب اے۔",
  ...
  "error.page.report.prefix": "مہربانی کر کے اس غلطی دی اطلاع MOD ٹیم نوں دیو",
  ...
  "error.chain.checkConfig": "اپنی کنفگ (MOD.json) وچ پرووائیڈر/ماڈل دے ناں چیک کرو",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، MOD ہلے تک MCP تصدیق دی حمایت نئیں کردا۔',
  ...
  "sidebar.gettingStarted.line1": "MOD چ مفت ماڈل شامل نیں تاکہ تسی فوری طور تے شروع کر سکو۔",
  ...
  "settings.desktop.wsl.description": "Windows تے WSL دے اندر MOD سرور چلاؤ۔",
  ...
  "settings.general.row.language.description": "MOD لئی ڈسپلے دی بولی بدلو",
  ...
  "settings.general.row.appearance.description": "اپنے آلے تے MOD کیویں لگدا اے، اپنی مرضی دے مطابق بناؤ",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description": "چنو کہ آیا MOD سسٹم، لائٹ، یا ڈارک تھیم دی پیروی کردا اے",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "MOD نوں کس طرح تھیم کیتا گیا اے، اپنی مرضی دے مطابق بناؤ۔",
  ...
  "settings.updates.row.startup.description": "جدوں MOD لانچ ہوندا اے تے خودبخود اپ ڈیٹس چیک کرو",
  ...
  "settings.updates.toast.latest.description": "تسی MOD دا تازہ ترین ورژن چلا رئے او۔",
