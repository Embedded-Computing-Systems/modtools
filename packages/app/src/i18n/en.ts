...
export const dict = {
  ...
  "dialog.provider.mod.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.mod.tagline": "Reliable optimized models",
  "dialog.provider.modGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by MOD",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in MOD.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.modZen.line1":
    "MOD Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.modZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.modZen.visit.prefix": "Visit ",
  "provider.connect.modZen.visit.link": "opencode.ai/zen",
  "provider.connect.modZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in MOD.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in MOD.",
  ...
  "dialog.plugins.empty": "Plugins configured in MOD.json",
  ...
  "dialog.server.description": "Switch which MOD server this app connects to.",
  ...
  "wsl.onboarding.checkingMod": "Checking MOD...",
  "wsl.onboarding.checkingModIn": "Checking MOD in {{distro}}...",
  "wsl.onboarding.updatingMod": "Updating MOD...",
  "wsl.onboarding.updatingModIn": "Updating MOD in {{distro}}...",
  "wsl.onboarding.updateModIn": "Update MOD in {{distro}}.",
  "wsl.onboarding.updateMod": "Update MOD",
  "wsl.onboarding.modReadyIn": "MOD is ready in {{distro}}.",
  "wsl.onboarding.modReady": "MOD is ready.",
  "wsl.onboarding.installModIn": "Install MOD in {{distro}}.",
  "wsl.onboarding.installMod": "Install MOD",
  ...
  "wsl.onboarding.distroStatus.modMissing": "MOD not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before MOD can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "MOD could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen MOD.",
  ...
  "help.tabs.introduction": "MOD Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of MOD ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the MOD team",
  ...
  "error.chain.checkConfig": "Check your config (MOD.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, MOD does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "MOD includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the MOD server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for MOD",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how MOD looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether MOD follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how MOD is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when MOD launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of MOD.",
