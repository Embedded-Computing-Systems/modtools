...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "MOD se nije uspio učitati",
  "Prozor aplikacije MOD neočekivano je zatvoren",
  "MOD ne reagira",
  ...
  "Instalacija aplikacije MOD nije uspjela",
  "Distribucija {{distro}} već je dodana",
  "mod nije instaliran u ovoj distribuciji",
  "mod je instaliran, ali se ne može pokrenuti",
  "MOD nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije MOD je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.provider.mod.note": "Odabrani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.mod.tagline": "Pouzdani optimizirani modeli",
  "dialog.provider.modGo.tagline": "Niska cijena pretplate za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi MOD",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u MOD.",
  ...
  "provider.connect.modZen.line1":
    "MOD Zen vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "provider.connect.modZen.visit.prefix": "Posjetiti",
  "provider.connect.modZen.visit.link": "otvoreni kod.ai/zen",
  "provider.connect.modZen.visit.suffix": "da preuzmete svoj ključ API.",
  "provider.connect.oauth.code.visit.prefix": "Posjetiti",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u MOD.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u MOD.",
  ...
  "dialog.plugins.empty": "Dodaci konfigurirani u MOD.json",
  ...
  "dialog.server.description": "Promijenite na koji se MOD poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingModIn": "Provjera MOD u {{distro}}...",
  "wsl.onboarding.updatingMod": "Ažuriranje MOD...",
  "wsl.onboarding.updatingModIn": "Ažuriranje MOD u {{distro}}...",
  "wsl.onboarding.updateModIn": "Ažurirajte MOD u {{distro}}.",
  "wsl.onboarding.updateMod": "Ažurirajte MOD",
  "wsl.onboarding.modReadyIn": "MOD je spreman u {{distro}}.",
  "wsl.onboarding.modReady": "MOD je spreman.",
  "wsl.onboarding.installModIn": "Instalirajte MOD u {{distro}}.",
  "wsl.onboarding.installMod": "Instalirajte MOD",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što MOD može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "MOD nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite MOD.",
  ...
  "help.tabs.introduction": "Radna površina MOD sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija MOD ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku MOD timu",
  ...
  "error.chain.checkConfig": "Provjerite nazive dobavljača/modela svoje konfiguracije (MOD.json).",
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, MOD još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "MOD uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "MOD Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite MOD poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za MOD",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako MOD izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li MOD slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je MOD tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se MOD pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju MOD.",
