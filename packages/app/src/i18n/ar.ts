export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل MOD",
  "desktop.recovery.terminated": "توقفت نافذة MOD بشكل غير متوقع",
  "desktop.recovery.unresponsive": "MOD لا يستجيب",
  ...
  "desktop.wsl.error.installMod": "فشل تثبيت MOD",
  "desktop.wsl.error.alreadyAdded": "تمت إضافة {{distro}} بالفعل",
  "desktop.wsl.error.modMissing": "mod غير مثبت في هذه التوزيعة",
  "desktop.wsl.error.modCannotRun": "mod مثبت، لكن تعذر تشغيله",
  "desktop.wsl.error.modNotInstalled": "MOD غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث MOD، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.provider.mod.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.mod.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.modGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من MOD",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في MOD.",
  ...
  "provider.connect.modZen.line1":
    "يمنحك MOD Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.modZen.visit.prefix": "قم بزيارة ",
  "provider.connect.modZen.visit.link": "opencode.ai/zen",
  "provider.connect.modZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في MOD.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في MOD.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في MOD.json",
  ...
  "dialog.server.description": "تبديل خادم MOD الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingMod": "جارٍ التحقق من MOD...",
  "wsl.onboarding.checkingModIn": "جارٍ التحقق من MOD في {{distro}}...",
  "wsl.onboarding.updatingMod": "جارٍ تحديث MOD...",
  "wsl.onboarding.updatingModIn": "جارٍ تحديث MOD في {{distro}}...",
  "wsl.onboarding.updateModIn": "حدّث MOD في {{distro}}.",
  "wsl.onboarding.updateMod": "تحديث MOD",
  "wsl.onboarding.modReadyIn": "MOD جاهز في {{distro}}.",
  "wsl.onboarding.modReady": "MOD جاهز.",
  "wsl.onboarding.installModIn": "ثبّت MOD في {{distro}}.",
  "wsl.onboarding.installMod": "تثبيت MOD",
  ...
  "wsl.onboarding.distroStatus.modMissing": "MOD غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن MOD من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على MOD التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح MOD.",
  ...
  "help.tabs.introduction": "أصبح MOD Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من MOD ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق MOD",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (MOD.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن MOD لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن MOD نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم MOD داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ MOD",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور MOD على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان MOD يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة MOD.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل MOD",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من MOD.",
