export const dict = {
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في MOD.",
  ...
  "toast.update.description": "نسخة جديدة من MOD ({{version}}) متاحة الآن للتثبيت.",
