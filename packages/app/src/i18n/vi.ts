export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu MOD",
  ...
  "desktop.recovery.loadFailed": "Không tải được MOD",
  "desktop.recovery.terminated": "Cửa sổ MOD đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "MOD không phản hồi",
  ...
  "desktop.wsl.error.installMod": "Không cài đặt được MOD",
  "desktop.wsl.error.alreadyAdded": "{{distro}} đã được thêm",
  "desktop.wsl.error.modMissing": "mod chưa được cài đặt trong bản phân phối này",
  "desktop.wsl.error.modCannotRun": "mod đã được cài đặt nhưng không thể chạy",
  "desktop.wsl.error.modNotInstalled": "MOD chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật MOD nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.provider.mod.note": "Các mô hình được tuyển chọn, gồm Claude, GPT, Gemini và nhiều mô hình khác",
  "dialog.provider.mod.tagline": "Các mô hình tối ưu hóa đáng tin cậy",
  "dialog.provider.modGo.tagline": "Đăng ký chi phí thấp cho mọi người",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do MOD cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong MOD.",
  ...
  "provider.connect.modZen.line1":
    "MOD Zen cho phép bạn truy cập một bộ mô hình được tuyển chọn, tối ưu hóa và đáng tin cậy dành cho tác nhân lập trình.",
  ...
  "provider.connect.modZen.visit.prefix": "Truy cập ",
  "provider.connect.modZen.visit.link": "opencode.ai/zen",
  "provider.connect.modZen.visit.suffix": " để lấy khóa API của bạn.",
  "provider.connect.oauth.code.visit.prefix": "Truy cập ",
  "provider.connect.oauth.code.visit.link": "liên kết này",
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong MOD.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong MOD.",
  ...
  "dialog.plugins.empty": "Các plugin được định cấu hình trong MOD.json",
  ...
  "dialog.server.description": "Chuyển máy chủ MOD mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingMod": "Đang kiểm tra MOD...",
  "wsl.onboarding.checkingModIn": "Đang kiểm tra MOD trong {{distro}}...",
  "wsl.onboarding.updatingMod": "Đang cập nhật MOD...",
  "wsl.onboarding.updatingModIn": "Đang cập nhật MOD trong {{distro}}...",
  "wsl.onboarding.updateModIn": "Cập nhật MOD trong {{distro}}.",
  "wsl.onboarding.updateMod": "Cập nhật MOD",
  "wsl.onboarding.modReadyIn": "MOD đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.modReady": "MOD đã sẵn sàng.",
  "wsl.onboarding.installModIn": "Cài đặt MOD trong {{distro}}.",
  "wsl.onboarding.installMod": "Cài đặt MOD",
  ...
  "wsl.onboarding.distroStatus.modMissing": "MOD chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi MOD có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "MOD không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại MOD.",
  ...
  "help.tabs.introduction": "MOD Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của MOD ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm MOD",
  ...
  "error.chain.checkConfig": "Kiểm tra tên nhà cung cấp/mô hình cấu hình (MOD.json) của bạn",
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: MOD chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "MOD bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ MOD bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho MOD",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của MOD trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem MOD tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của MOD.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi MOD khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của MOD.",
