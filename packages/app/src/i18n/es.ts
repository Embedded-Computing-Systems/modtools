export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de MOD",
  ...
  "desktop.menu.ariaLabel": "Menú de MOD",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar MOD",
  "desktop.recovery.terminated": "La ventana de MOD se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "MOD no responde",
  ...
  "desktop.wsl.error.installMod": "No se pudo instalar MOD",
  "desktop.wsl.error.alreadyAdded": "Ya se ha añadido {{distro}}",
  "desktop.wsl.error.modMissing": "mod no está instalado en esta distribución",
  "desktop.wsl.error.modCannotRun": "mod está instalado, pero no se pudo ejecutar",
  "desktop.wsl.error.modNotInstalled": "MOD no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de MOD finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.provider.mod.note": "Selección de modelos como Claude, GPT, Gemini y otros",
  "dialog.provider.mod.tagline": "Modelos optimizados y fiables",
  "dialog.provider.modGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por MOD",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en MOD.",
  ...
  "provider.connect.modZen.line1":
    "MOD Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.modZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en MOD.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en MOD.",
  ...
  "dialog.plugins.empty": "Plugins configurados en MOD.json",
  ...
  "dialog.server.description": "Cambiar el servidor de MOD al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingMod": "Comprobando MOD...",
  "wsl.onboarding.checkingModIn": "Comprobando MOD en {{distro}}...",
  "wsl.onboarding.updatingMod": "Actualizando MOD...",
  "wsl.onboarding.updatingModIn": "Actualizando MOD en {{distro}}...",
  "wsl.onboarding.updateModIn": "Actualiza MOD en {{distro}}.",
  "wsl.onboarding.updateMod": "Actualizar MOD",
  "wsl.onboarding.modReadyIn": "MOD está listo en {{distro}}.",
  "wsl.onboarding.modReady": "MOD está listo.",
  "wsl.onboarding.installModIn": "Instala MOD en {{distro}}.",
  "wsl.onboarding.installMod": "Instalar MOD",
  ...
  "wsl.onboarding.distroStatus.modMissing": "MOD no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que MOD pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "MOD no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir MOD.",
  ...
  "help.tabs.introduction": "MOD Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de MOD ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de MOD",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (MOD.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: MOD aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "MOD incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor MOD dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para MOD",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve MOD en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si MOD sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de MOD.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia MOD",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de MOD.",
