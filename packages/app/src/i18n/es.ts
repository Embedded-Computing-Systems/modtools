export const dict = {
  ...
  "dialog.provider.modtools.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.modtools.tagline": "Modelos optimizados y fiables",
  "dialog.provider.modtoolsGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Model-of-Design Tools",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Model-of-Design Tools.",
  ...
  "provider.connect.modtoolsZen.line1":
    "Model-of-Design Tools Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.modtoolsZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.modtoolsZen.visit.prefix": "Visita ",
  "provider.connect.modtoolsZen.visit.link": "modtools.ai/zen",
  "provider.connect.modtoolsZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Model-of-Design Tools.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Model-of-Design Tools.",
  ...
  "dialog.plugins.empty": "Plugins configurados en modtools.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Model-of-Design Tools se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de Model-of-Design Tools ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Model-of-Design Tools",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (modtools.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Model-of-Design Tools no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Model-of-Design Tools incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Model-of-Design Tools dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Model-of-Design Tools",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve Model-of-Design Tools en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Model-of-Design Tools sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Model-of-Design Tools.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Model-of-Design Tools",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Model-of-Design Tools.",
