export const dict = {
  ...
  "dialog.provider.mod.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  ...
  "dialog.server.description": "Cambiar a qué servidor de MOD se conecta esta app.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de MOD",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, MOD no soporta autenticación MCP todavía.',
