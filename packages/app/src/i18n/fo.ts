export const dict = {
  ...
  "desktop.menu.documentation": "MOD Skjøl",
  ...
  "desktop.menu.ariaLabel": "MOD valmynd",
  ...
  "desktop.recovery.loadFailed": "MOD miseydnaðist at heinta",
  "desktop.recovery.terminated": "MOD vindeygað endað óvæntað",
  "desktop.recovery.unresponsive": "MOD svarar ikki",
  ...
  "desktop.wsl.error.installMod": "MOD uppsetingin miseydnaðist",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er longu lagt afturat .",
  "desktop.wsl.error.modMissing": "mod er ikki sett upp í hesi distro",
  "desktop.wsl.error.modCannotRun": "mod er sett upp men kundi ikki koyra",
  "desktop.wsl.error.modNotInstalled": "MOD er ikki sett upp í {{distro}}",
  "desktop.wsl.error.updateVersion":
    "MOD dagføring liðug men {{distro}} greiðir enn frá {{installed}}; væntað {{expected}}.",
  ...
  "dialog.provider.mod.note": "Kuraterað modell íroknað Claude, GPT, Gemini og fleiri",
  "dialog.provider.mod.tagline": "Álítandi optimerað modell",
  "dialog.provider.modGo.tagline": "Lágkostnaðarhald fyri øll",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis modellir veitt av MOD",
  ...
  "provider.connect.apiKey.description":
    "Skriva {{provider}} API-lykilin fyri at knýta kontuna saman og brúka {{provider}}-modell í MOD.",
  ...
  "provider.connect.modZen.line1":
    "MOD Zen gevur tær atgongd til eitt kuraterað sett av álítandi optimeraðum modellum til kodingaragentar.",
  "provider.connect.modZen.line2":
    "Við einum API lykli fært tú atgongd til modellir sum Claude, GPT, Gemini, GLM og fleiri.",
  "provider.connect.modZen.visit.prefix": "Vitja ",
  "provider.connect.modZen.visit.link": "opencode.ai/zen",
  "provider.connect.modZen.visit.suffix": " fyri at savna tín API lykil.",
  "provider.connect.oauth.code.visit.prefix": "Vitja ",
  "provider.connect.oauth.code.visit.link": "hesa leinkjuna",
  "provider.connect.oauth.code.visit.suffix":
    " at savna inn tína heimildarkotu til at knýta tína kontu saman og brúka {{provider}} modellir í MOD.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriva kotuna niðanfyri fyri at knýta tína kontu saman og brúka {{provider}} modellir í MOD.",
  ...
  "dialog.plugins.empty": "Tilskot uppsett í MOD.json",
  ...
  "dialog.server.description": "Skift hvønn MOD ambætara henda appin hevur samband við.",
  ...
  "wsl.onboarding.checkingMod": "Kanna MOD...",
  "wsl.onboarding.checkingModIn": "Kanna MOD í {{distro}}...",
  "wsl.onboarding.updatingMod": "Dagføring MOD...",
  "wsl.onboarding.updatingModIn": "Dagføring MOD í {{distro}}...",
  "wsl.onboarding.updateModIn": "Dagfør MOD í {{distro}}.",
  "wsl.onboarding.updateMod": "Dagfør MOD",
  "wsl.onboarding.modReadyIn": "MOD er klárt í {{distro}}.",
  "wsl.onboarding.modReady": "MOD er klárt.",
  "wsl.onboarding.installModIn": "Set MOD upp í {{distro}}.",
  "wsl.onboarding.installMod": "Set upp MOD",
  ...
  "wsl.onboarding.distroStatus.modMissing": "MOD ikki innstillað",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Undirskipan til Linux) er kravd áðrenn MOD kann leggja ein WSL ambætara til",
  "wsl.onboarding.wslUnavailable.title": "WSL ikki tøkt",
  "wsl.onboarding.wslUnavailable.description": "MOD kundi ikki staðfesta WSL á hesi maskinuni.",
  "wsl.onboarding.installWsl": "Set upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurbyrja Windows fyri at klára at seta upp WSL, og opna síðani MOD aftur.",
  ...
  "help.tabs.introduction": "MOD Skrivaraborð er nú bygt rundan um flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ein nýggj útgáva av MOD ({{version}}) er nú tøk at seta upp.",
  ...
  "error.page.report.prefix": "Vinarliga melda hendan feilin til MOD toymið",
  ...
  "error.chain.checkConfig": "Kanna tíni uppseting (MOD.json) veitara/modell nøvn",
  "error.chain.mcpFailed": 'MCP ambætarin "{{name}}" miseydnaðist. Viðmæli, MOD stuðlar ikki MCP sannroynd enn.',
  ...
  "sidebar.gettingStarted.line1": "MOD inniheldur ókeypis modellir so tú kanst byrja beinanvegin.",
  ...
  "app.name.desktop": "MOD Skrivaraborð",
  ...
  "settings.desktop.wsl.description": "Koyr MOD ambætaran inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri MOD",
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu MOD sær út á tínari eind",
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um MOD fylgir skipanini, ljósa ella myrka temanum",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu MOD er tema.",
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá MOD byrjar",
  ...
  "settings.updates.toast.latest.description": "Tú koyrir nýggjastu útgávuna av MOD.",
