...
export const dict = {
  ...
  "dialog.provider.modtools.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.modtools.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.modtoolsGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Model-of-Design Tools tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Model-of-Design Tools'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.modtoolsZen.line1":
    "Model-of-Design Tools Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.modtoolsZen.visit.prefix": "",
  "provider.connect.modtoolsZen.visit.link": "modtools.ai/zen",
  "provider.connect.modtoolsZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve Model-of-Design Tools'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Model-of-Design Tools'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler modtools.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Model-of-Design Tools sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "Model-of-Design Tools'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Model-of-Design Tools ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (modtools.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Model-of-Design Tools henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Model-of-Design Tools ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Model-of-Design Tools Masaüstü",
  ...
  "settings.desktop.wsl.description": "Model-of-Design Tools sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Model-of-Design Tools'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "Model-of-Design Tools'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Model-of-Design Tools'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Model-of-Design Tools'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Model-of-Design Tools başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Model-of-Design Tools'un en son sürümünü kullanıyorsunuz.",
