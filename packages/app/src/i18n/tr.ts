...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "MOD yüklenemedi",
  "desktop.recovery.terminated": "MOD penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "MOD yanıt vermiyor",
  ...
  "desktop.wsl.error.installMod": "MOD kurulamadı",
  "desktop.wsl.error.alreadyAdded": "{{distro}} zaten eklendi",
  "desktop.wsl.error.modMissing": "mod bu dağıtımda kurulu değil",
  "desktop.wsl.error.modCannotRun": "mod kurulu ancak çalıştırılamadı",
  "desktop.wsl.error.modNotInstalled": "MOD, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "MOD güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.provider.mod.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.mod.tagline": "Güvenilir, optimize edilmiş modeller",
  "dialog.provider.modGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "MOD tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve MOD'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.modZen.line1":
    "MOD Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.modZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak MOD'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak MOD'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler MOD.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi MOD sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingMod": "MOD kontrol ediliyor...",
  "wsl.onboarding.checkingModIn": "{{distro}} içinde MOD kontrol ediliyor...",
  "wsl.onboarding.updatingMod": "MOD güncelleniyor...",
  "wsl.onboarding.updatingModIn": "{{distro}} içinde MOD güncelleniyor...",
  "wsl.onboarding.updateModIn": "{{distro}} içindeki MOD'u güncelleyin.",
  "wsl.onboarding.updateMod": "MOD'u güncelle",
  "wsl.onboarding.modReadyIn": "{{distro}} içinde MOD hazır.",
  "wsl.onboarding.modReady": "MOD hazır.",
  "wsl.onboarding.installModIn": "MOD'u {{distro}} içine kurun.",
  "wsl.onboarding.installMod": "MOD'u kur",
  ...
  "wsl.onboarding.distroStatus.modMissing": "MOD kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "MOD'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "MOD bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından MOD'u tekrar açın.",
  ...
  "help.tabs.introduction": "MOD Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "MOD'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı MOD ekibine",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızdaki (MOD.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: MOD henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "MOD ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "settings.desktop.wsl.description": "MOD sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "MOD'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "MOD'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "MOD'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "MOD'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "MOD başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "MOD'un en son sürümünü kullanıyorsunuz.",
