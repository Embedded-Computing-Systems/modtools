...
export const dict = {
  ...
  "error.page.report.prefix": "Lütfen bu hatayı MOD ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (MOD.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: MOD henüz MCP kimlik doğrulamasını desteklemiyor.',
