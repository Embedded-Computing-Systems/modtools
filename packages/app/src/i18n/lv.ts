export const dict = {
  ...
  "desktop.menu.documentation": "MOD dokumentācija",
  ...
  "desktop.menu.ariaLabel": "MOD izvēlne",
  ...
  "desktop.recovery.loadFailed": "Neizdevās ielādēt MOD",
  "desktop.recovery.terminated": "MOD logs negaidīti aizvērts",
  "desktop.recovery.unresponsive": "MOD neatbild",
  ...
  "desktop.wsl.error.installMod": "MOD instalēšana neizdevās",
  "desktop.wsl.error.alreadyAdded": "{{distro}} jau ir pievienota",
  "desktop.wsl.error.modMissing": "mod nav instalēts šajā distribūcijā",
  "desktop.wsl.error.modCannotRun": "mod ir instalēts, bet to nevar palaist",
  "desktop.wsl.error.modNotInstalled": "MOD nav instalēts {{distro}}",
  "desktop.wsl.error.updateVersion":
    "MOD atjaunināšana pabeigta, bet {{distro}} joprojām rāda {{installed}}; gaidīts {{expected}}",
  ...
  "dialog.provider.mod.note": "Atlasīti modeļi, tostarp Claude, GPT, Gemini un citi",
  "dialog.provider.mod.tagline": "Uzticami optimizēti modeļi",
  "dialog.provider.modGo.tagline": "Zemas cenas abonements visiem",
  ...
  "dialog.model.unpaid.freeModels.title": "Bezmaksas modeļi no MOD",
  ...
  "provider.connect.apiKey.description":
    "Ievadiet savu {{provider}} API atslēgu, lai savienotu kontu un izmantotu {{provider}} modeļus MOD.",
  ...
  "provider.connect.modZen.line1":
    "MOD Zen nodrošina piekļuvi atlasītiem uzticamiem optimizētiem modeļiem kodēšanas aģentiem.",
  "provider.connect.modZen.line2":
    "Ar vienu API atslēgu iegūsiet piekļuvi tādiem modeļiem kā Claude, GPT, Gemini, GLM un citiem.",
  "provider.connect.modZen.visit.prefix": "Apmeklējiet",
  "provider.connect.modZen.visit.link": "opencode.ai/zen",
  "provider.connect.modZen.visit.suffix": ", lai saņemtu savu API atslēgu.",
  "provider.connect.oauth.code.visit.prefix": "Apmeklējiet",
  "provider.connect.oauth.code.visit.link": "šo saiti",
  "provider.connect.oauth.code.visit.suffix":
    ", lai saņemtu autorizācijas kodu, savienotu kontu un izmantotu {{provider}} modeļus MOD.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " un ievadiet zemāk redzamo kodu, lai savienotu kontu un izmantotu {{provider}} modeļus MOD.",
  ...
  "dialog.plugins.empty": "Spraudņi konfigurēti MOD.json",
  ...
  "dialog.server.description": "Mainiet, pie kura MOD servera šī lietotne pieslēdzas.",
  ...
  "wsl.onboarding.checkingMod": "Pārbaudu MOD...",
  "wsl.onboarding.checkingModIn": "Pārbaudu MOD distribūcijā {{distro}}...",
  "wsl.onboarding.updatingMod": "Atjauninu MOD...",
  "wsl.onboarding.updatingModIn": "Atjauninu MOD distribūcijā {{distro}}...",
  "wsl.onboarding.updateModIn": "Atjauniniet MOD distribūcijā {{distro}}.",
  "wsl.onboarding.updateMod": "Atjauniniet MOD",
  "wsl.onboarding.modReadyIn": "MOD ir gatavs distribūcijā {{distro}}.",
  "wsl.onboarding.modReady": "MOD ir gatavs.",
  "wsl.onboarding.installModIn": "Instalējiet MOD distribūcijā {{distro}}.",
  "wsl.onboarding.installMod": "Instalējiet MOD",
  ...
  "wsl.onboarding.distroStatus.modMissing": "MOD nav instalēts",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Pirms MOD var pievienot WSL serveri, nepieciešams WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nav pieejams",
  "wsl.onboarding.wslUnavailable.description": "MOD neizdevās pārbaudīt WSL šajā datorā.",
  "wsl.onboarding.installWsl": "Instalēt WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartējiet Windows, lai pabeigtu WSL instalēšanu, pēc tam atveriet MOD no jauna.",
  ...
  "help.tabs.introduction": "MOD Desktop tagad balstās uz cilnēm.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Pieejama jauna MOD versija ({{version}}) instalēšanai.",
  ...
  "error.page.report.prefix": "Lūdzu, ziņojiet par šo kļūdu MOD komandai",
  ...
  "error.chain.checkConfig": "Pārbaudiet konfigurāciju (MOD.json) pakalpojuma/modela nosaukumus",
  "error.chain.mcpFailed":
    'MCP serveris "{{name}}" neizdevās. Ņemiet vērā, MOD vēl neatbalsta MCP autentifikāciju.',
  ...
  "sidebar.gettingStarted.line1": "MOD ietver bezmaksas modeļus, lai varētu sākt uzreiz.",
  ...
  "app.name.desktop": "MOD darbvirsma",
  ...
  "settings.desktop.wsl.description": "Palaist MOD serveri WSL vidē uz Windows.",
  ...
  "settings.general.row.language.description": "Mainīt MOD saskarnes valodu",
  ...
  "settings.general.row.appearance.description": "Pielāgojiet, kā MOD izskatās jūsu ierīcē",
  "settings.general.row.colorScheme.title": "Krāsu shēma",
  "settings.general.row.colorScheme.description":
    "Izvēlieties, vai MOD sekos sistēmas, gaišajai vai tumšajai tēmai",
  "settings.general.row.theme.title": "Tēma",
  "settings.general.row.theme.description": "Pielāgojiet MOD tēmu.",
  ...
  "settings.updates.row.startup.description": "Automātiski pārbaudīt atjauninājumus, palaižot MOD",
  ...
  "settings.updates.toast.latest.description": "Jūs izmantojat jaunāko MOD versiju.",
