export const dict = {
  ...
  "dialog.provider.modtools.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.modtools.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.modtoolsGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Model-of-Design Tools",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Model-of-Design Tools-u.",
  ...
  "provider.connect.modtoolsZen.line1":
    "Model-of-Design Tools Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.modtoolsZen.visit.prefix": "Posjeti ",
  "provider.connect.modtoolsZen.visit.link": "modtools.ai/zen",
  "provider.connect.modtoolsZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Model-of-Design Tools-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Model-of-Design Tools-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u modtools.json",
  ...
  "dialog.server.description": "Promijeni na koji se Model-of-Design Tools server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Model-of-Design Tools-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Model-of-Design Tools timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (modtools.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Model-of-Design Tools još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Model-of-Design Tools uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Model-of-Design Tools server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Model-of-Design Tools-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Model-of-Design Tools izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Model-of-Design Tools prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Model-of-Design Tools-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Model-of-Design Tools pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Model-of-Design Tools-a.",
