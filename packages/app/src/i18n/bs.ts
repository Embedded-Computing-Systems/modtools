export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za MOD",
  ...
  "desktop.menu.ariaLabel": "MOD meni",
  ...
  "desktop.recovery.loadFailed": "MOD se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor MOD-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "MOD ne reaguje",
  ...
  "desktop.wsl.error.installMod": "Instalacija MOD-a nije uspjela",
  "desktop.wsl.error.alreadyAdded": "Distribucija {{distro}} je već dodana",
  "desktop.wsl.error.modMissing": "mod nije instaliran u ovoj distribuciji",
  "desktop.wsl.error.modCannotRun": "mod je instaliran, ali se ne može pokrenuti",
  "desktop.wsl.error.modNotInstalled": "MOD nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje MOD-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.provider.mod.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.mod.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.modGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje MOD",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u MOD-u.",
  ...
  "provider.connect.modZen.line1":
    "MOD Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.modZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.modZen.visit.prefix": "Posjeti ",
  "provider.connect.modZen.visit.link": "opencode.ai/zen",
  "provider.connect.modZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u MOD-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u MOD-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u MOD.json",
  ...
  "dialog.server.description": "Promijeni na koji se MOD server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingMod": "Provjera MOD...",
  "wsl.onboarding.checkingModIn": "Provjera MOD u distribuciji {{distro}}...",
  "wsl.onboarding.updatingMod": "Ažuriranje MOD...",
  "wsl.onboarding.updatingModIn": "Ažuriranje MOD u distribuciji {{distro}}...",
  "wsl.onboarding.updateModIn": "Ažuriraj MOD u distribuciji {{distro}}.",
  "wsl.onboarding.updateMod": "Ažuriraj MOD",
  "wsl.onboarding.modReadyIn": "MOD je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.modReady": "MOD je spreman.",
  "wsl.onboarding.installModIn": "Instaliraj MOD u distribuciji {{distro}}.",
  "wsl.onboarding.installMod": "Instaliraj MOD",
  ...
  "wsl.onboarding.distroStatus.modMissing": "MOD nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi MOD mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "MOD nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori MOD.",
  ...
  "help.tabs.introduction": "MOD Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija MOD-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku MOD timu",
  ...
  "error.chain.checkConfig": "Provjeri nazive provajdera/modela u konfiguraciji (MOD.json)",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: MOD još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "MOD uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni MOD server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u MOD-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako MOD izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li MOD prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu MOD-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se MOD pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju MOD-a.",
