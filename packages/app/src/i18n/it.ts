export const dict = {
  ...
  "dialog.provider.mod.note": "Modelli selezionati tra cui Claude, GPT, Gemini e altri",
  "dialog.provider.mod.tagline": "Modelli affidabili e ottimizzati",
  "dialog.provider.modGo.tagline": "Abbonamento economico per tutti",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da MOD",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in MOD.",
  ...
  "provider.connect.modZen.line1":
    "MOD Zen offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  "provider.connect.modZen.line2":
    "Con una sola chiave API avrai accesso a modelli come Claude, GPT, Gemini, GLM e altri.",
  "provider.connect.modZen.visit.prefix": "Visita ",
  "provider.connect.modZen.visit.link": "opencode.ai/zen",
  "provider.connect.modZen.visit.suffix": " per ottenere la tua chiave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "questo collegamento",
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in MOD.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in MOD.",
  ...
  "dialog.plugins.empty": "Plugin configurati in MOD.json",
  ...
  "dialog.server.description": "Cambia il server MOD a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingMod": "Controllo MOD...",
  "wsl.onboarding.checkingModIn": "Controllo MOD in {{distro}}...",
  "wsl.onboarding.updatingMod": "Aggiornamento MOD...",
  "wsl.onboarding.updatingModIn": "Aggiornamento MOD in {{distro}}...",
  "wsl.onboarding.updateModIn": "Aggiorna MOD in {{distro}}.",
  "wsl.onboarding.updateMod": "Aggiorna MOD",
  "wsl.onboarding.modReadyIn": "MOD è pronto in {{distro}}.",
  "wsl.onboarding.modReady": "MOD è pronto.",
  "wsl.onboarding.installModIn": "Installa MOD in {{distro}}.",
  "wsl.onboarding.installMod": "Installa MOD",
  ...
  "wsl.onboarding.distroStatus.modMissing": "MOD non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che MOD possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "MOD non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri MOD.",
  ...
  "help.tabs.introduction": "MOD Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di MOD ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team MOD",
  ...
  "error.chain.checkConfig": "Controlla i nomi di provider e modelli nella configurazione (MOD.json)",
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: MOD non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "MOD include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server MOD all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per MOD",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di MOD sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se MOD segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di MOD.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di MOD",
  ...
  "settings.updates.toast.latest.title": "MOD è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di MOD.",
  ...
  "desktop.menu.documentation": "Documentazione di MOD",
  ...
  "desktop.menu.ariaLabel": "Menu MOD",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare MOD",
  "desktop.recovery.terminated": "La finestra di MOD si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "MOD non risponde",
  ...
  "desktop.wsl.error.installMod": "Installazione di MOD non riuscita",
  "desktop.wsl.error.alreadyAdded": "{{distro}} è già stata aggiunta",
  "desktop.wsl.error.modMissing": "mod non è installato in questa distribuzione",
  "desktop.wsl.error.modCannotRun": "mod è installato, ma non è stato possibile eseguirlo",
  "desktop.wsl.error.modNotInstalled": "MOD non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di MOD è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
