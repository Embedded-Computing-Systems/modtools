...
const desktop = [
  ...
  "MOD įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "mod šiame distributyve neįdiegtas",
  "mod įdiegtas, bet jo paleisti nepavyko",
  "MOD neįdiegtas distributyve {{distro}}",
  "MOD naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.provider.mod.note": "Kuruojami modeliai, įskaitant Claude, GPT, Gemini ir kt.",
  "dialog.provider.mod.tagline": "Patikimi optimizuoti modeliai",
  "dialog.provider.modGo.tagline": "Mažos kainos abonementas visiems",
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami MOD modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje MOD.",
  ...
  "provider.connect.modZen.line1":
    "MOD Zen suteikia prieigą prie kuruojamo patikimų optimizuotų kodavimo agentų modelių rinkinio.",
  "provider.connect.modZen.line2":
    "Su vienu API raktu galėsite pasiekti tokius modelius kaip Claude, GPT, Gemini, GLM ir kt.",
  "provider.connect.modZen.visit.prefix": "Aplankykite",
  "provider.connect.modZen.visit.link": "opencode.ai/zen",
  "provider.connect.modZen.visit.suffix": "norėdami pasiimti savo API raktą.",
  "provider.connect.oauth.code.visit.prefix": "Aplankykite",
  "provider.connect.oauth.code.visit.link": "šią nuorodą",
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius MOD.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius MOD.",
  ...
  "dialog.plugins.empty": "Papildiniai sukonfigūruoti MOD.json",
  ...
  "dialog.server.description": "Perjunkite, prie kurio MOD serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingMod": "Tikrinama MOD...",
  "wsl.onboarding.checkingModIn": "Tikrinama MOD {{distro}}...",
  "wsl.onboarding.updatingMod": "Atnaujinamas MOD...",
  "wsl.onboarding.updatingModIn": "Atnaujinamas MOD {{distro}}...",
  "wsl.onboarding.updateModIn": "Atnaujinkite MOD {{distro}}.",
  "wsl.onboarding.updateMod": "Atnaujinkite MOD",
  "wsl.onboarding.modReadyIn": "MOD yra paruoštas {{distro}}.",
  "wsl.onboarding.modReady": "MOD yra paruoštas.",
  "wsl.onboarding.installModIn": "Įdiekite MOD į {{distro}}.",
  "wsl.onboarding.installMod": "Įdiekite MOD",
  ...
  "wsl.onboarding.distroStatus.modMissing": "MOD neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad MOD galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "MOD nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite MOD.",
  ...
  "help.tabs.introduction": "MOD Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują MOD ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą MOD komandai",
  ...
  "error.chain.checkConfig": "Patikrinkite konfigūracijos (MOD.json) teikėjo / modelio pavadinimus",
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad MOD dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "MOD apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "MOD darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite MOD serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite MOD ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip MOD atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar MOD seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite MOD temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas MOD",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią MOD versiją.",
