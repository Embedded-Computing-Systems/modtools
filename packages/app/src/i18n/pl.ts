export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja MOD",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać MOD",
  "desktop.recovery.terminated": "Okno MOD zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "MOD nie odpowiada",
  ...
  "desktop.wsl.error.installMod": "Nie udało się zainstalować MOD",
  "desktop.wsl.error.alreadyAdded": "Dystrybucja {{distro}} została już dodana",
  "desktop.wsl.error.modMissing": "Program mod nie jest zainstalowany w tej dystrybucji",
  "desktop.wsl.error.modCannotRun": "Program mod jest zainstalowany, ale nie można go uruchomić",
  "desktop.wsl.error.modNotInstalled": "MOD nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja MOD została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.provider.mod.note": "Starannie dobrane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.mod.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.modGo.tagline": "Niedroga subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez MOD",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w MOD.",
  ...
  "provider.connect.modZen.line1":
    "MOD Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  ...
  "provider.connect.modZen.visit.prefix": "Odwiedź ",
  "provider.connect.modZen.visit.link": "opencode.ai/zen",
  "provider.connect.modZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w MOD.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w MOD.",
  ...
  "dialog.plugins.empty": "Wtyczki są skonfigurowane w pliku MOD.json",
  ...
  "dialog.server.description": "Przełącz serwer MOD, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingMod": "Sprawdzanie MOD...",
  "wsl.onboarding.checkingModIn": "Sprawdzanie MOD w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingMod": "Aktualizowanie MOD...",
  "wsl.onboarding.updatingModIn": "Aktualizowanie MOD w dystrybucji {{distro}}...",
  "wsl.onboarding.updateModIn": "Zaktualizuj MOD w dystrybucji {{distro}}.",
  "wsl.onboarding.updateMod": "Zaktualizuj MOD",
  "wsl.onboarding.modReadyIn": "MOD jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.modReady": "MOD jest gotowy.",
  "wsl.onboarding.installModIn": "Zainstaluj MOD w dystrybucji {{distro}}.",
  "wsl.onboarding.installMod": "Zainstaluj MOD",
  ...
  "wsl.onboarding.distroStatus.modMissing": "MOD nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim MOD będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "MOD nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz MOD.",
  ...
  "help.tabs.introduction": "MOD Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja MOD ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu MOD",
  ...
  "error.chain.checkConfig": "Sprawdź nazwy dostawców i modeli w konfiguracji (MOD.json)",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: MOD nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "MOD zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer MOD wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla MOD",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd MOD na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy MOD ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw MOD.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania MOD",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji MOD.",
