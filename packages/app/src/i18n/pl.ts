export const dict = {
  ...
  "dialog.provider.mod.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.mod.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.modGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "provider.connect.modZen.line1":
    "MOD Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w MOD.json",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (MOD.json) nazwy dostawców/modeli",
