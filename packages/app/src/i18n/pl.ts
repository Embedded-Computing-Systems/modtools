export const dict = {
  ...
  "dialog.provider.modtools.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.modtools.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.modtoolsGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Model-of-Design Tools",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Model-of-Design Tools.",
  ...
  "provider.connect.modtoolsZen.line1":
    "Model-of-Design Tools Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.modtoolsZen.visit.prefix": "Odwiedź ",
  "provider.connect.modtoolsZen.visit.link": "modtools.ai/zen",
  "provider.connect.modtoolsZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Model-of-Design Tools.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Model-of-Design Tools.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w modtools.json",
  ...
  "dialog.server.description": "Przełącz serwer Model-of-Design Tools, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Model-of-Design Tools ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Model-of-Design Tools",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (modtools.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Model-of-Design Tools does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Model-of-Design Tools zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Run the Model-of-Design Tools server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Model-of-Design Tools",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Model-of-Design Tools na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Model-of-Design Tools ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Model-of-Design Tools.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Model-of-Design Tools",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Model-of-Design Tools.",
