export const dict = {
  ...
  "desktop.recovery.loadFailed": "MOD laadimine ebaõnnestus",
  "desktop.recovery.terminated": "MOD aken suleti ootamatult",
  "desktop.recovery.unresponsive": "MOD ei vasta",
  ...
  "desktop.wsl.error.installMod": "MOD installimine ebaõnnestus",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on juba lisatud",
  "desktop.wsl.error.modMissing": "mod pole sellesse distrosse installitud",
  "desktop.wsl.error.modCannotRun": "mod on installitud, kuid seda ei saa käivitada",
  "desktop.wsl.error.modNotInstalled": "MOD pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "MOD värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.provider.mod.note": "Kureeritud mudelid, sealhulgas Claude, GPT, Gemini ja palju muud",
  "dialog.provider.mod.tagline": "Usaldusväärsed optimeeritud mudelid",
  "dialog.provider.modGo.tagline": "Madala hinnaga tellimus kõigile",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub MOD",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid MOD'is.",
  ...
  "provider.connect.modZen.line1":
    "MOD Zen annab teile juurdepääsu kodeerimisagentide usaldusväärsete optimeeritud mudelite kureeritud komplektile.",
  ...
  "provider.connect.modZen.visit.prefix": "Külastage ",
  "provider.connect.modZen.visit.link": "opencode.ai/zen",
  "provider.connect.modZen.visit.suffix": " API võtme kättesaamiseks.",
  "provider.connect.oauth.code.visit.prefix": "Külastage ",
  "provider.connect.oauth.code.visit.link": "see link",
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises MOD.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises MOD.",
  ...
  "dialog.plugins.empty": "Pluginad on konfigureeritud failis MOD.json",
  ...
  "dialog.server.description": "Lülitage, millise MOD serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingMod": "MOD kontrollimine...",
  "wsl.onboarding.checkingModIn": "MOD kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingMod": "MOD värskendamine...",
  "wsl.onboarding.updatingModIn": "MOD värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateModIn": "Värskenda MOD jaotises {{distro}}.",
  "wsl.onboarding.updateMod": "Värskenda MOD",
  "wsl.onboarding.modReadyIn": "MOD on valmis {{distro}}.",
  "wsl.onboarding.modReady": "MOD on valmis.",
  "wsl.onboarding.installModIn": "Installige MOD asukohta {{distro}}.",
  "wsl.onboarding.installMod": "Installige MOD",
  ...
  "wsl.onboarding.distroStatus.modMissing": "MOD pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui MOD saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "MOD ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti MOD.",
  ...
  "help.tabs.introduction": "MOD Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse MOD ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast MOD meeskonnale",
  ...
  "error.chain.checkConfig": "Kontrollige oma konfiguratsiooni (MOD.json) pakkuja/mudeli nimesid",
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, MOD ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "MOD sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "settings.desktop.wsl.description": "Käivitage MOD server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke MOD kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas MOD teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas MOD järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas MOD on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui MOD käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse MOD uusimat versiooni.",
