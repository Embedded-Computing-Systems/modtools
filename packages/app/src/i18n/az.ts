export const dict = {
  ...
  "desktop.recovery.loadFailed": "MOD yüklənə bilmədi",
  "desktop.recovery.terminated": "MOD pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "MOD cavab vermir",
  ...
  "desktop.wsl.error.installMod": "MOD quraşdırılması uğursuz oldu",
  "desktop.wsl.error.alreadyAdded": "{{distro}} artıq əlavə edilib",
  "desktop.wsl.error.modMissing": "Bu distribütivdə mod quraşdırılmayıb",
  "desktop.wsl.error.modCannotRun": "mod quraşdırılıb, lakin onu işə salmaq mümkün olmadı",
  "desktop.wsl.error.modNotInstalled": "MOD {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "MOD yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.provider.mod.note": "Claude, GPT, Gemini və daha çoxu daxil olmaqla seçilmiş modellər",
  "dialog.provider.mod.tagline": "Etibarlı optimallaşdırılmış modellər",
  "dialog.provider.modGo.tagline": "Hamı üçün aşağı qiymətli abunəlik",
  ...
  "dialog.model.unpaid.freeModels.title": "MOD tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və MOD-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.modZen.line1":
    "MOD Zen sizə kodlaşdırma agentləri üçün etibarlı optimallaşdırılmış seçilmiş modellər dəstinə giriş verir.",
  "provider.connect.modZen.line2":
    "Tək bir API açarı ilə Claude, GPT, Gemini, GLM və daha çox modellərə giriş əldə edəcəksiniz.",
  "provider.connect.modZen.visit.prefix": "",
  "provider.connect.modZen.visit.link": "opencode.ai/zen",
  "provider.connect.modZen.visit.suffix": " səhifəsinə daxil olub API açarınızı əldə edin.",
  "provider.connect.oauth.code.visit.prefix": "",
  "provider.connect.oauth.code.visit.link": "Bu linkə",
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və MOD-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və MOD-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.plugins.empty": "Plaginlər MOD.json-da konfiqurasiya edilib",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu MOD serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingMod": "MOD yoxlanılır...",
  "wsl.onboarding.checkingModIn": "{{distro}}-də MOD yoxlanılır...",
  "wsl.onboarding.updatingMod": "MOD yenilənir...",
  "wsl.onboarding.updatingModIn": "{{distro}}-də MOD yenilənir...",
  "wsl.onboarding.updateModIn": "{{distro}}-də MOD-u yeniləyin.",
  "wsl.onboarding.updateMod": "MOD-u yeniləyin",
  "wsl.onboarding.modReadyIn": "MOD {{distro}}-də hazırdır.",
  "wsl.onboarding.modReady": "MOD hazırdır.",
  "wsl.onboarding.installModIn": "MOD-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installMod": "MOD quraşdırın",
  ...
  "wsl.onboarding.distroStatus.modMissing": "MOD quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "MOD WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "MOD bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra MOD-u yenidən açın.",
  ...
  "help.tabs.introduction": "MOD Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "MOD-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı MOD komandasına",
  ...
  "error.chain.checkConfig": "Konfiqurasiyanızdakı (MOD.json) provayder/model adlarını yoxlayın",
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: MOD hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "MOD-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində MOD serverini işlət.",
  ...
  "settings.general.row.language.description": "MOD üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "MOD-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "MOD-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "MOD-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "MOD açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "MOD-un ən son versiyasından istifadə edirsiniz.",
