export const dict = {
  ...
  "desktop.menu.documentation": "MOD hujjatlari",
  ...
  "desktop.menu.ariaLabel": "MOD menyusi",
  ...
  "desktop.recovery.loadFailed": "MOD yuklanmadi",
  "desktop.recovery.terminated": "MOD oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "MOD javob bermayapti",
  ...
  "desktop.wsl.error.installMod": "MOD oʻrnatilmadi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} allaqachon qo'shilgan",
  "desktop.wsl.error.modMissing": "Mod ushbu tarqatishda o'rnatilmagan",
  "desktop.wsl.error.modCannotRun": "mod o'rnatilgan, lekin ishga tushirilmadi",
  "desktop.wsl.error.modNotInstalled": "MOD {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "MOD yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.provider.mod.note": "Tanlangan modellar, jumladan Claude, GPT, Gemini va boshqalar",
  "dialog.provider.mod.tagline": "Ishonchli optimallashtirilgan modellar",
  "dialog.provider.modGo.tagline": "Hamma uchun arzon obuna",
  ...
  "dialog.model.unpaid.freeModels.title": "MOD tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va MOD’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.modZen.line1":
    "MOD Zen sizga kodlash agentlari uchun ishonchli optimallashtirilgan modellar to'plamiga kirish imkonini beradi.",
  ...
  "provider.connect.modZen.visit.prefix": "Tashrif buyuring ",
  "provider.connect.modZen.visit.link": "opencode.ai/zen",
  "provider.connect.modZen.visit.suffix": " API kalitingizni olish uchun.",
  "provider.connect.oauth.code.visit.prefix": "Tashrif buyuring ",
  "provider.connect.oauth.code.visit.link": "bu havola",
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va MOD da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va MOD da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.plugins.empty": "MOD.json da sozlangan plaginlar",
  ...
  "dialog.server.description": "Ushbu ilova qaysi MOD serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingMod": "MOD tekshirilmoqda...",
  "wsl.onboarding.checkingModIn": "MOD {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingMod": "MOD yangilanmoqda...",
  "wsl.onboarding.updatingModIn": "MOD {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateModIn": "MOD-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateMod": "MOD-ni yangilang",
  "wsl.onboarding.modReadyIn": "MOD {{distro}} da tayyor.",
  "wsl.onboarding.modReady": "MOD tayyor.",
  "wsl.onboarding.installModIn": "MOD-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installMod": "MOD-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.modMissing": "MOD o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "MOD WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "MOD WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra MOD-ni qayta oching.",
  ...
  "help.tabs.introduction": "MOD Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "MOD ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida MOD jamoasiga xabar bering",
  ...
  "error.chain.checkConfig": "Konfiguratsiya (MOD.json) provayder/model nomlarini tekshiring",
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, MOD hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "MOD bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi MOD serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "MOD uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "MOD qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "MOD tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "MOD mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "MOD ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz MOD oxirgi versiyasini ishga tushiryapsiz.",
