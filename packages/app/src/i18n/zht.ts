...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "MOD 載入失敗",
  "desktop.recovery.terminated": "MOD 視窗意外終止",
  "desktop.recovery.unresponsive": "MOD 沒有回應",
  ...
  "desktop.wsl.error.installMod": "MOD 安裝失敗",
  "desktop.wsl.error.alreadyAdded": "已新增 {{distro}}",
  "desktop.wsl.error.modMissing": "此發行版中未安裝 mod",
  "desktop.wsl.error.modCannotRun": "已安裝 mod，但無法執行",
  "desktop.wsl.error.modNotInstalled": "{{distro}} 中未安裝 MOD",
  "desktop.wsl.error.updateVersion":
    "MOD 更新完成，但 {{distro}} 回報的版本仍為 {{installed}}；預期版本為 {{expected}}",
  ...
  "dialog.provider.mod.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  "dialog.provider.mod.tagline": "經過最佳化的可靠模型",
  "dialog.provider.modGo.tagline": "適合所有人的低成本訂閱",
  ...
  "dialog.model.unpaid.freeModels.title": "MOD 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 MOD 中使用 {{provider}} 模型。",
  ...
  "provider.connect.modZen.line1": "MOD Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.modZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.modZen.visit.prefix": "造訪 ",
  "provider.connect.modZen.visit.link": "opencode.ai/zen",
  "provider.connect.modZen.visit.suffix": " 取得你的 API 金鑰。",
  "provider.connect.oauth.code.visit.prefix": "造訪 ",
  "provider.connect.oauth.code.visit.link": "此連結",
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 MOD 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 MOD 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 MOD.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 MOD 伺服器。",
  ...
  "wsl.onboarding.checkingMod": "正在檢查 MOD...",
  "wsl.onboarding.checkingModIn": "正在檢查 {{distro}} 中的 MOD...",
  ...
  "wsl.onboarding.modReadyIn": "{{distro}} 中的 MOD 已就緒。",
  "wsl.onboarding.modReady": "MOD 已就緒。",
  "wsl.onboarding.installModIn": "在 {{distro}} 中安裝 MOD。",
  "wsl.onboarding.installMod": "安裝 MOD",
  ...
  "wsl.onboarding.distroStatus.modMissing": "未安裝 MOD",
  ...
  "wsl.onboarding.wslUnavailable.description": "MOD 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 MOD。",
  ...
  "help.tabs.introduction": "MOD Desktop 現在以分頁為核心。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "MOD 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 MOD 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (MOD.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": "MCP 伺服器「{{name}}」啟動失敗。注意：MOD 尚不支援 MCP 驗證。",
  ...
  "sidebar.gettingStarted.line1": "MOD 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 MOD 伺服器。",
  ...
  "settings.general.row.language.description": "變更 MOD 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 MOD 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 MOD 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 MOD 的主題。",
  ...
  "settings.updates.row.startup.description": "在 MOD 啟動時自動檢查更新",
