...
export const dict = {
  ...
  "dialog.provider.modtools.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  "dialog.provider.modtools.tagline": "可靠的優化模型",
  "dialog.provider.modtoolsGo.tagline": "適合所有人的低成本訂閱",
  ...
  "dialog.model.unpaid.freeModels.title": "Model-of-Design Tools 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 Model-of-Design Tools 中使用 {{provider}} 模型。",
  ...
  "provider.connect.modtoolsZen.line1": "Model-of-Design Tools Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.modtoolsZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.modtoolsZen.visit.prefix": "造訪 ",
  "provider.connect.modtoolsZen.visit.link": "modtools.ai/zen",
  "provider.connect.modtoolsZen.visit.suffix": " 取得你的 API 金鑰。",
  "provider.connect.oauth.code.visit.prefix": "造訪 ",
  "provider.connect.oauth.code.visit.link": "此連結",
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 Model-of-Design Tools 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 Model-of-Design Tools 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 modtools.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 Model-of-Design Tools 伺服器。",
  ...
  "toast.update.description": "Model-of-Design Tools 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 Model-of-Design Tools 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (modtools.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: Model-of-Design Tools 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "Model-of-Design Tools 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 Model-of-Design Tools 伺服器。",
  ...
  "settings.general.row.language.description": "變更 Model-of-Design Tools 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 Model-of-Design Tools 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 Model-of-Design Tools 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 Model-of-Design Tools 的主題。",
  ...
  "settings.updates.row.startup.description": "在 Model-of-Design Tools 啟動時自動檢查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Model-of-Design Tools。",
