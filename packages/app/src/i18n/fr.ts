export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'MOD",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'MOD",
  "desktop.recovery.terminated": "La fenêtre MOD s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "MOD ne répond pas",
  ...
  "desktop.wsl.error.installMod": "Échec de l'installation d'MOD",
  "desktop.wsl.error.alreadyAdded": "{{distro}} a déjà été ajoutée",
  "desktop.wsl.error.modMissing": "mod n'est pas installé dans cette distribution",
  "desktop.wsl.error.modCannotRun": "mod est installé, mais n'a pas pu s'exécuter",
  "desktop.wsl.error.modNotInstalled": "MOD n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'MOD est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.provider.mod.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.mod.tagline": "Modèles optimisés et fiables",
  "dialog.provider.modGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par MOD",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans MOD.",
  ...
  "provider.connect.modZen.line1":
    "MOD Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.modZen.visit.prefix": "Visitez ",
  "provider.connect.modZen.visit.link": "opencode.ai/zen",
  "provider.connect.modZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans MOD.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans MOD.",
  ...
  "dialog.plugins.empty": "Extensions configurées dans MOD.json",
  ...
  "dialog.server.description": "Changez le serveur MOD auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingMod": "Vérification d'MOD...",
  "wsl.onboarding.checkingModIn": "Vérification d'MOD dans {{distro}}...",
  "wsl.onboarding.updatingMod": "Mise à jour d'MOD...",
  "wsl.onboarding.updatingModIn": "Mise à jour d'MOD dans {{distro}}...",
  "wsl.onboarding.updateModIn": "Mettez à jour MOD dans {{distro}}.",
  "wsl.onboarding.updateMod": "Mettre à jour MOD",
  "wsl.onboarding.modReadyIn": "MOD est prêt dans {{distro}}.",
  "wsl.onboarding.modReady": "MOD est prêt.",
  "wsl.onboarding.installModIn": "Installez MOD dans {{distro}}.",
  "wsl.onboarding.installMod": "Installer MOD",
  ...
  "wsl.onboarding.distroStatus.modMissing": "MOD non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'MOD puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "MOD n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez MOD.",
  ...
  "help.tabs.introduction": "MOD Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'MOD ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe MOD",
  ...
  "error.chain.checkConfig": "Vérifiez les noms de fournisseur et de modèle dans votre configuration (MOD.json)",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'MOD ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "MOD inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur MOD dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour MOD",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'MOD sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si MOD suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'MOD.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'MOD",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'MOD.",
