export const dict = {
  ...
  "dialog.plugins.empty": "Plugins configurés dans MOD.json",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (MOD.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'MOD ne supporte pas encore l'authentification MCP.",
