export const dict = {
  ...
  "dialog.provider.modtools.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.modtools.tagline": "Modèles optimisés et fiables",
  "dialog.provider.modtoolsGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Model-of-Design Tools",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Model-of-Design Tools.",
  ...
  "provider.connect.modtoolsZen.line1":
    "Model-of-Design Tools Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.modtoolsZen.visit.prefix": "Visitez ",
  "provider.connect.modtoolsZen.visit.link": "modtools.ai/zen",
  "provider.connect.modtoolsZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Model-of-Design Tools.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Model-of-Design Tools.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans modtools.json",
  ...
  "dialog.server.description": "Changez le serveur Model-of-Design Tools auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Model-of-Design Tools ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Model-of-Design Tools",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (modtools.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Model-of-Design Tools ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Model-of-Design Tools inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "app.name.desktop": "Model-of-Design Tools Desktop",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Model-of-Design Tools dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Model-of-Design Tools",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Model-of-Design Tools sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Model-of-Design Tools suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Model-of-Design Tools.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Model-of-Design Tools",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Model-of-Design Tools.",
