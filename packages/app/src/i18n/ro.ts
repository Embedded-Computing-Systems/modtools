export const dict = {
  ...
  "desktop.menu.documentation": "Documentație MOD",
  ...
  "desktop.menu.ariaLabel": "Meniu MOD",
  ...
  "desktop.recovery.loadFailed": "MOD nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra MOD s-a închis neașteptat",
  "desktop.recovery.unresponsive": "MOD nu răspunde",
  ...
  "desktop.wsl.error.installMod": "Instalarea MOD a eșuat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} este deja adăugată",
  "desktop.wsl.error.modMissing": "mod nu este instalat în această distribuție",
  "desktop.wsl.error.modCannotRun": "mod este instalat, dar nu a putut fi pornit",
  "desktop.wsl.error.modNotInstalled": "MOD nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea MOD s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "dialog.provider.mod.note": "Modele selectate, inclusiv Claude, GPT, Gemini și altele",
  "dialog.provider.mod.tagline": "Modele optimizate, fiabile",
  "dialog.provider.modGo.tagline": "Abonament accesibil pentru toți",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de MOD",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în MOD.",
  ...
  "provider.connect.modZen.line1":
    "MOD Zen îți oferă acces la un set selectat de modele optimizate și fiabile pentru agenți de programare.",
  "provider.connect.modZen.line2":
    "Cu o singură cheie API ai acces la modele precum Claude, GPT, Gemini, GLM și altele.",
  "provider.connect.modZen.visit.prefix": "Vizitează",
  "provider.connect.modZen.visit.link": "opencode.ai/zen",
  "provider.connect.modZen.visit.suffix": "pentru a obține cheia ta API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitează",
  "provider.connect.oauth.code.visit.link": "acest link",
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în MOD.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în MOD.",
  ...
  "dialog.plugins.empty": "Pluginuri configurate în MOD.json",
  ...
  "dialog.server.description": "Schimbă serverul MOD la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingMod": "Se verifică MOD...",
  "wsl.onboarding.checkingModIn": "Se verifică MOD în {{distro}}...",
  "wsl.onboarding.updatingMod": "Se actualizează MOD...",
  "wsl.onboarding.updatingModIn": "Se actualizează MOD în {{distro}}...",
  "wsl.onboarding.updateModIn": "Actualizează MOD în {{distro}}.",
  "wsl.onboarding.updateMod": "Actualizează MOD",
  "wsl.onboarding.modReadyIn": "MOD este gata în {{distro}}.",
  "wsl.onboarding.modReady": "MOD este gata.",
  "wsl.onboarding.installModIn": "Instalează MOD în {{distro}}.",
  "wsl.onboarding.installMod": "Instalează MOD",
  ...
  "wsl.onboarding.distroStatus.modMissing": "MOD nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca MOD să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "MOD nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide MOD.",
  ...
  "help.tabs.introduction": "MOD Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune MOD ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei MOD",
  ...
  "error.chain.checkConfig": "Verifică numele provider/model în config (MOD.json)",
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, MOD nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "MOD include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul MOD în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru MOD",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul MOD pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă MOD urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema MOD.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea MOD",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune MOD.",
