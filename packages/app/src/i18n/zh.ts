...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "MOD 加载失败",
  "desktop.recovery.terminated": "MOD 窗口意外终止",
  "desktop.recovery.unresponsive": "MOD 未响应",
  ...
  "desktop.wsl.error.installMod": "MOD 安装失败",
  "desktop.wsl.error.alreadyAdded": "已添加 {{distro}}",
  "desktop.wsl.error.modMissing": "此发行版中未安装 mod",
  "desktop.wsl.error.modCannotRun": "已安装 mod，但无法运行",
  "desktop.wsl.error.modNotInstalled": "{{distro}} 中未安装 MOD",
  "desktop.wsl.error.updateVersion":
    "MOD 更新已完成，但 {{distro}} 仍报告版本 {{installed}}；预期版本为 {{expected}}",
  ...
  "dialog.provider.mod.note": "精选模型，包括 Claude、GPT、Gemini 等",
  "dialog.provider.mod.tagline": "可靠的优化模型",
  "dialog.provider.modGo.tagline": "适合所有人的低成本订阅",
  ...
  "dialog.model.unpaid.freeModels.title": "MOD 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接账户，并在 MOD 中使用 {{provider}} 模型。",
  ...
  "provider.connect.modZen.line1": "MOD Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.modZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.modZen.visit.prefix": "访问 ",
  "provider.connect.modZen.visit.link": "opencode.ai/zen",
  "provider.connect.modZen.visit.suffix": " 获取你的 API 密钥。",
  "provider.connect.oauth.code.visit.prefix": "访问 ",
  "provider.connect.oauth.code.visit.link": "此链接",
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的账户并在 MOD 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的账户并在 MOD 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 MOD.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 MOD 服务器。",
  ...
  "wsl.onboarding.checkingMod": "正在检查 MOD...",
  "wsl.onboarding.checkingModIn": "正在检查 {{distro}} 中的 MOD...",
  "wsl.onboarding.updatingMod": "正在更新 MOD...",
  "wsl.onboarding.updatingModIn": "正在更新 {{distro}} 中的 MOD...",
  "wsl.onboarding.updateModIn": "更新 {{distro}} 中的 MOD。",
  "wsl.onboarding.updateMod": "更新 MOD",
  "wsl.onboarding.modReadyIn": "{{distro}} 中的 MOD 已就绪。",
  "wsl.onboarding.modReady": "MOD 已就绪。",
  "wsl.onboarding.installModIn": "在 {{distro}} 中安装 MOD。",
  "wsl.onboarding.installMod": "安装 MOD",
  ...
  "wsl.onboarding.distroStatus.modMissing": "未安装 MOD",
  ...
  "wsl.onboarding.wslNotInstalled.description": "MOD 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "MOD 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 MOD。",
  ...
  "help.tabs.introduction": "MOD Desktop 现已采用以标签页为核心的设计。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "MOD 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 MOD 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (MOD.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意：MOD 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "MOD 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 MOD 服务器。",
  ...
  "settings.general.row.language.description": "更改 MOD 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 MOD 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 MOD 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 MOD 的主题。",
  ...
  "settings.updates.row.startup.description": "在 MOD 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 MOD。",
