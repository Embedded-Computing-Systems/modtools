export const dict = {
  ...
  "desktop.recovery.loadFailed": "MODを読み込めませんでした",
  "desktop.recovery.terminated": "MODのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "MODが応答していません",
  ...
  "desktop.wsl.error.installMod": "MODのインストールに失敗しました",
  "desktop.wsl.error.alreadyAdded": "{{distro}}はすでに追加されています",
  "desktop.wsl.error.modMissing": "このディストリビューションにはmodがインストールされていません",
  "desktop.wsl.error.modCannotRun": "modはインストールされていますが、実行できませんでした",
  "desktop.wsl.error.modNotInstalled": "{{distro}}にはMODがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "MODのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.provider.mod.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.mod.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.modGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "MODが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、MODで{{provider}}モデルを使用します。",
  ...
  "provider.connect.modZen.line1":
    "MOD Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.modZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.modZen.visit.prefix": " ",
  "provider.connect.modZen.visit.link": "opencode.ai/zen",
  "provider.connect.modZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してModで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、MODで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "MOD.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するModサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingMod": "MODを確認中...",
  "wsl.onboarding.checkingModIn": "{{distro}}内のMODを確認中...",
  "wsl.onboarding.updatingMod": "MODを更新中...",
  "wsl.onboarding.updatingModIn": "{{distro}}内のMODを更新中...",
  "wsl.onboarding.updateModIn": "{{distro}}内のMODを更新してください。",
  "wsl.onboarding.updateMod": "MODを更新",
  "wsl.onboarding.modReadyIn": "{{distro}}内のMODの準備ができました。",
  "wsl.onboarding.modReady": "MODの準備ができました。",
  "wsl.onboarding.installModIn": "{{distro}}にMODをインストールしてください。",
  "wsl.onboarding.installMod": "MODをインストール",
  ...
  "wsl.onboarding.distroStatus.modMissing": "MODがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "MODでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、MODをもう一度開いてください。",
  ...
  "help.tabs.introduction": "MOD Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "MODの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをModチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (MOD.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: MODはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "MODには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でModサーバーを実行します。",
  ...
  "settings.general.row.language.description": "MODの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのModの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "MODがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "MODのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "MOD の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "MOD は最新バージョンです。",
