export const dict = {
  ...
  "desktop.menu.documentation": "MOD دستاویزات",
  ...
  "desktop.menu.ariaLabel": "MOD مینو",
  ...
  "desktop.recovery.loadFailed": "MOD لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "MOD ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "MOD جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installMod": "MOD کی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ہی شامل ہے",
  "desktop.wsl.error.modMissing": "اس ڈسٹری بیوشن میں mod انسٹال نہیں ہے",
  "desktop.wsl.error.modCannotRun": "mod انسٹال ہے لیکن چل نہیں سکا",
  "desktop.wsl.error.modNotInstalled": "{{distro}} میں MOD انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "MOD کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "dialog.provider.mod.note": "کیوریٹ شدہ ماڈلز بشمول Claude، GPT، Gemini اور مزید",
  "dialog.provider.mod.tagline": "قابل اعتماد آپٹمائزڈ ماڈلز",
  "dialog.provider.modGo.tagline": "سب کے لیے کم لاگت کی رکنیت",
  ...
  "dialog.model.unpaid.freeModels.title": "MOD کے ذریعہ فراہم کردہ مفت ماڈلز",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور MOD میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.modZen.line1":
    "MOD Zen آپ کو کوڈنگ ایجنٹوں کے لیے قابل اعتماد اصلاح شدہ ماڈلز کے کیوریٹڈ سیٹ تک رسائی فراہم کرتا ہے۔",
  "provider.connect.modZen.line2":
    "ایک واحد API کلید کے ساتھ آپ Claude، GPT، Gemini، GLM اور مزید ماڈلز تک رسائی حاصل کریں گے۔",
  "provider.connect.modZen.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.modZen.visit.link": "opencode.ai/zen",
  "provider.connect.modZen.visit.suffix": " اور اپنی API کلید حاصل کریں۔",
  "provider.connect.oauth.code.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.oauth.code.visit.link": "یہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور MOD میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور MOD میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "dialog.plugins.empty": "MOD.json میں کنفیگر کردہ پلگ انز",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس MOD سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingMod": "MOD چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingModIn": "{{distro}} میں MOD چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingMod": "MOD کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingModIn": "{{distro}} میں MOD کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updateModIn": "{{distro}} میں MOD کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateMod": "MOD کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.modReadyIn": "MOD {{distro}} میں تیار ہے۔",
  "wsl.onboarding.modReady": "MOD تیار ہے۔",
  "wsl.onboarding.installModIn": "{{distro}} میں MOD انسٹال کریں۔",
  "wsl.onboarding.installMod": "MOD انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.modMissing": "MOD انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ MOD WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "MOD اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر MOD کو دوبارہ کھولیں۔",
  ...
  "help.tabs.introduction": "MOD Desktop اب ٹیبز پر مبنی ہے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "MOD ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم MOD ٹیم کو اس غلطی کی اطلاع دیں۔",
  ...
  "error.chain.checkConfig": "اپنی تشکیل (MOD.json) فراہم کنندہ/ماڈل کے نام چیک کریں۔",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، MOD ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "MOD میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر MOD سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "MOD کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر MOD کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description":
    "منتخب کریں کہ آیا MOD سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "MOD کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "MOD لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ MOD کا تازہ ترین ورژن چلا رہے ہیں۔",
