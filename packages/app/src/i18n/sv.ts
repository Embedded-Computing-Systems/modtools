export const dict = {
  ...
  "desktop.recovery.loadFailed": "MOD kunde inte läsas in",
  "desktop.recovery.terminated": "MOD-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "MOD svarar inte",
  ...
  "desktop.wsl.error.installMod": "Installationen av MOD misslyckades",
  "desktop.wsl.error.alreadyAdded": "{{distro}} har redan lagts till",
  "desktop.wsl.error.modMissing": "mod är inte installerat i den här distributionen",
  "desktop.wsl.error.modCannotRun": "mod är installerat men kunde inte köras",
  "desktop.wsl.error.modNotInstalled": "MOD är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "MOD-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.provider.mod.note": "Kurerade modeller inklusive Claude, GPT, Gemini och mer",
  "dialog.provider.mod.tagline": "Pålitliga optimerade modeller",
  "dialog.provider.modGo.tagline": "Lågprisprenumeration för alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av MOD",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i MOD.",
  ...
  "provider.connect.modZen.line1":
    "MOD Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  "provider.connect.modZen.line2":
    "Med en enda API-nyckel får du tillgång till modeller som Claude, GPT, Gemini, GLM och mer.",
  "provider.connect.modZen.visit.prefix": "Besök ",
  "provider.connect.modZen.visit.link": "opencode.ai/zen",
  "provider.connect.modZen.visit.suffix": " för att hämta din API-nyckel.",
  "provider.connect.oauth.code.visit.prefix": "Besök ",
  "provider.connect.oauth.code.visit.link": "denna länk",
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i MOD.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i MOD.",
  ...
  "dialog.plugins.empty": "Insticksprogram konfigurerade i MOD.json",
  ...
  "dialog.server.description": "Växla vilken MOD-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingMod": "Kontrollerar MOD...",
  "wsl.onboarding.checkingModIn": "Kontrollerar MOD i {{distro}}...",
  "wsl.onboarding.updatingMod": "Uppdaterar MOD...",
  "wsl.onboarding.updatingModIn": "Uppdaterar MOD i {{distro}}...",
  "wsl.onboarding.updateModIn": "Uppdatera MOD i {{distro}}.",
  "wsl.onboarding.updateMod": "Uppdatera MOD",
  "wsl.onboarding.modReadyIn": "MOD är redo i {{distro}}.",
  "wsl.onboarding.modReady": "MOD är redo.",
  "wsl.onboarding.installModIn": "Installera MOD i {{distro}}.",
  "wsl.onboarding.installMod": "Installera MOD",
  ...
  "wsl.onboarding.distroStatus.modMissing": "MOD är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan MOD kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "MOD kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan MOD igen.",
  ...
  "help.tabs.introduction": "MOD Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av MOD ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till MOD-teamet",
  ...
  "error.chain.checkConfig": "Kontrollera leverantörs- och modellnamnen i konfigurationen (MOD.json)",
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, MOD stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "MOD innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör MOD-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för MOD",
  ...
  "settings.general.row.appearance.description": "Anpassa hur MOD ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om MOD följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa MOD:s tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när MOD startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av MOD.",
