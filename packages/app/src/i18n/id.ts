export const dict = {
  ...
  "desktop.recovery.loadFailed": "MOD gagal dimuat",
  "desktop.recovery.terminated": "Jendela MOD berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "MOD tidak merespons",
  ...
  "desktop.wsl.error.installMod": "Instalasi MOD gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} sudah ditambahkan",
  "desktop.wsl.error.modMissing": "mod belum terinstal di distro ini",
  "desktop.wsl.error.modCannotRun": "mod telah terinstal, tetapi tidak dapat dijalankan",
  "desktop.wsl.error.modNotInstalled": "MOD belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan MOD selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.provider.mod.note": "Model pilihan, termasuk Claude, GPT, Gemini, dan lainnya",
  "dialog.provider.mod.tagline": "Model andal yang dioptimalkan",
  "dialog.provider.modGo.tagline": "Langganan terjangkau untuk semua orang",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh MOD",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di MOD.",
  ...
  "provider.connect.modZen.line1":
    "MOD Zen memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.modZen.visit.prefix": "Kunjungi ",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di MOD.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di MOD.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi di MOD.json",
  ...
  "dialog.server.description": "Ganti server MOD mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingMod": "Memeriksa MOD...",
  "wsl.onboarding.checkingModIn": "Memeriksa MOD di {{distro}}...",
  "wsl.onboarding.updatingMod": "Memperbarui MOD...",
  "wsl.onboarding.updatingModIn": "Memperbarui MOD di {{distro}}...",
  "wsl.onboarding.updateModIn": "Perbarui MOD di {{distro}}.",
  "wsl.onboarding.updateMod": "Perbarui MOD",
  "wsl.onboarding.modReadyIn": "MOD siap di {{distro}}.",
  "wsl.onboarding.modReady": "MOD siap.",
  "wsl.onboarding.installModIn": "Instal MOD di {{distro}}.",
  "wsl.onboarding.installMod": "Instal MOD",
  ...
  "wsl.onboarding.distroStatus.modMissing": "MOD belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum MOD dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "MOD tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali MOD.",
  ...
  "help.tabs.introduction": "MOD Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru MOD ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim MOD",
  ...
  "error.chain.checkConfig": "Periksa nama penyedia/model di konfigurasi Anda (MOD.json)",
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: MOD belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "MOD menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server MOD di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk MOD",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan MOD di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah MOD mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat MOD diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru MOD.",
