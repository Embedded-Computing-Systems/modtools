export const dict = {
  ...
  "dialog.provider.mod.note": "Kuratoituja malleja, kuten Claude, GPT, Gemini ja muita",
  "dialog.provider.mod.tagline": "Luotettavat optimoidut mallit",
  "dialog.provider.modGo.tagline": "Edullinen tilaus kaikille",
  ...
  "dialog.model.unpaid.freeModels.title": "MODin tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja MODissa.",
  ...
  "provider.connect.modZen.line1":
    "MOD Zen antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  "provider.connect.modZen.line2":
    "Yhdellä API-avaimella pääset käyttämään malleja, kuten Claude, GPT, Gemini, GLM ja paljon muuta.",
  "provider.connect.modZen.visit.prefix": "Avaa ",
  "provider.connect.modZen.visit.link": "opencode.ai/zen",
  "provider.connect.modZen.visit.suffix": " ja hae API-avaimesi.",
  "provider.connect.oauth.code.visit.prefix": "Avaa ",
  "provider.connect.oauth.code.visit.link": "tämä linkki",
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja MODissa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja MODissa.",
  ...
  "dialog.plugins.empty": "Laajennukset määritetään MOD.json-tiedostossa",
  ...
  "dialog.server.description": "Vaihda MOD-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingMod": "Tarkistetaan MODia...",
  "wsl.onboarding.checkingModIn": "Tarkistetaan MODia kohteessa {{distro}}...",
  "wsl.onboarding.updatingMod": "Päivitetään MODia...",
  "wsl.onboarding.updatingModIn": "Päivitetään MODia kohteessa {{distro}}...",
  "wsl.onboarding.updateModIn": "Päivitä MOD jakelussa {{distro}}.",
  "wsl.onboarding.updateMod": "Päivitä MOD",
  "wsl.onboarding.modReadyIn": "MOD on valmis jakelussa {{distro}}.",
  "wsl.onboarding.modReady": "MOD on valmis.",
  "wsl.onboarding.installModIn": "Asenna MOD jakeluun {{distro}}.",
  "wsl.onboarding.installMod": "Asenna MOD",
  ...
  "wsl.onboarding.distroStatus.modMissing": "MODia ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin MOD voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "MOD ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten MOD uudelleen.",
  ...
  "toast.update.description": "MODin uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä MOD-tiimille",
  ...
  "error.chain.checkConfig": "Tarkista määritysten (MOD.json) palveluntarjoajien ja mallien nimet",
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että MOD ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "MOD sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita MOD-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda MODin näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä MOD näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö MOD järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta MODin teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun MOD käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät MODin uusinta versiota.",
  ...
  "desktop.menu.documentation": "MOD-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "MOD-valikko",
  ...
  "desktop.recovery.loadFailed": "MODin lataaminen epäonnistui",
  "desktop.recovery.terminated": "MOD-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "MOD ei vastaa",
  ...
  "desktop.wsl.error.installMod": "MODin asennus epäonnistui",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on jo lisätty",
  "desktop.wsl.error.modMissing": "moda ei ole asennettu tähän jakeluun",
  "desktop.wsl.error.modCannotRun": "mod on asennettu, mutta sitä ei voitu suorittaa",
  "desktop.wsl.error.modNotInstalled": "MODia ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "MODin päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "MOD Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
