export const dict = {
  ...
  "desktop.menu.documentation": "ឯកសារ MOD",
  ...
  "desktop.menu.ariaLabel": "ម៉ឺនុយ MOD",
  ...
  "desktop.recovery.loadFailed": "MOD បានបរាជ័យក្នុងការផ្ទុក",
  "desktop.recovery.terminated": "បង្អួច MOD ត្រូវបានបញ្ចប់ដោយមិននឹកស្មានដល់",
  "desktop.recovery.unresponsive": "MOD មិនឆ្លើយតបទេ។",
  ...
  "desktop.wsl.error.installMod": "ការដំឡើង MOD បានបរាជ័យ",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ត្រូវបានបន្ថែមរួចហើយ",
  "desktop.wsl.error.modMissing": "mod មិនត្រូវបានដំឡើងនៅក្នុង distro នេះទេ។",
  "desktop.wsl.error.modCannotRun": "mod ត្រូវបានដំឡើង ប៉ុន្តែមិនអាចដំណើរការបានទេ។",
  "desktop.wsl.error.modNotInstalled": "MOD មិនត្រូវបានដំឡើងនៅក្នុង {{distro}} ទេ។",
  "desktop.wsl.error.updateVersion":
    "ការធ្វើបច្ចុប្បន្នភាព MOD បានបញ្ចប់ ប៉ុន្តែ {{distro}} នៅតែរាយការណ៍ {{installed}}; {{expected}} រំពឹងទុក",
  ...
  "dialog.provider.mod.note": "ម៉ូដែលដែលបានជ្រើសរើសរួមមាន Claude, GPT, Gemini និងច្រើនទៀត",
  "dialog.provider.mod.tagline": "ម៉ូដែលដែលបានកែលម្អដែលអាចទុកចិត្តបាន។",
  "dialog.provider.modGo.tagline": "ការជាវតម្លៃទាបសម្រាប់អ្នករាល់គ្នា",
  ...
  "dialog.model.unpaid.freeModels.title": "ម៉ូដែលឥតគិតថ្លៃដែលផ្តល់ដោយ MOD",
  ...
  "provider.connect.apiKey.description":
    "បញ្ចូល {{provider}} API key របស់អ្នក ដើម្បីភ្ជាប់គណនីរបស់អ្នក ហើយប្រើម៉ូដែល {{provider}} នៅក្នុង MOD។",
  ...
  "provider.connect.modZen.line1":
    "MOD Zen ផ្តល់ឱ្យអ្នកនូវម៉ូដែលដែលបានជ្រើសរើស និងកែលម្អសម្រាប់ភ្នាក់ងារសរសេរកូដ។",
  "provider.connect.modZen.line2":
    "ជាមួយនឹងសោ API តែមួយ អ្នកនឹងទទួលបានការចូលប្រើម៉ូដែលដូចជា Claude, GPT, Gemini, GLM និងច្រើនទៀត។",
  "provider.connect.modZen.visit.prefix": "ទស្សនា",
  "provider.connect.modZen.visit.link": "opencode.ai/zen",
  "provider.connect.modZen.visit.suffix": "ដើម្បីប្រមូលសោ API របស់អ្នក។",
  "provider.connect.oauth.code.visit.prefix": "ទស្សនា",
  "provider.connect.oauth.code.visit.link": "តំណនេះ។",
  "provider.connect.oauth.code.visit.suffix":
    "ដើម្បីប្រមូលលេខកូដអនុញ្ញាតរបស់អ្នកដើម្បីភ្ជាប់គណនីរបស់អ្នក និងប្រើម៉ូដែល {{provider}} នៅក្នុង MOD ។",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ហើយបញ្ចូលលេខកូដខាងក្រោមដើម្បីភ្ជាប់គណនីរបស់អ្នក ហើយប្រើម៉ូដែល {{provider}} នៅក្នុង MOD។",
  ...
  "dialog.plugins.empty": "កម្មវិធីជំនួយដែលបានកំណត់រចនាសម្ព័ន្ធនៅក្នុង MOD.json",
  ...
  "dialog.server.description": "ប្តូរម៉ាស៊ីនមេ MOD ដែលកម្មវិធីនេះភ្ជាប់ទៅ។",
  ...
  "wsl.onboarding.checkingMod": "កំពុងពិនិត្យមើលកូដ MOD...",
  "wsl.onboarding.checkingModIn": "កំពុងពិនិត្យកូដ MOD ក្នុង {{distro}}...",
  "wsl.onboarding.updatingMod": "កំពុងអាប់ដេត MOD...",
  "wsl.onboarding.updatingModIn": "កំពុងអាប់ដេត MOD ក្នុង {{distro}}...",
  "wsl.onboarding.updateModIn": "ធ្វើបច្ចុប្បន្នភាព MOD ក្នុង {{distro}} ។",
  "wsl.onboarding.updateMod": "ធ្វើបច្ចុប្បន្នភាព MOD",
  "wsl.onboarding.modReadyIn": "MOD គឺរួចរាល់នៅក្នុង {{distro}} ។",
  "wsl.onboarding.modReady": "MOD គឺរួចរាល់។",
  "wsl.onboarding.installModIn": "ដំឡើង MOD ក្នុង {{distro}} ។",
  "wsl.onboarding.installMod": "ដំឡើង MOD",
  ...
  "wsl.onboarding.distroStatus.modMissing": "MOD មិនត្រូវបានដំឡើងទេ។",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (ប្រព័ន្ធរងវីនដូសម្រាប់លីនុច) ត្រូវបានទាមទារ មុនពេល MOD អាចបន្ថែមម៉ាស៊ីនមេ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL មិនអាចប្រើបានទេ។",
  "wsl.onboarding.wslUnavailable.description": "MOD មិនអាចផ្ទៀងផ្ទាត់ WSL នៅលើម៉ាស៊ីននេះបានទេ។",
  "wsl.onboarding.installWsl": "ដំឡើង WSL",
  "wsl.onboarding.windowsRestartRequired":
    "ចាប់ផ្ដើម Windows ឡើងវិញ ដើម្បីបញ្ចប់ការដំឡើង WSL បន្ទាប់មកបើក MOD ឡើងវិញ។",
  ...
  "help.tabs.introduction": "MOD Desktop ឥឡូវនេះត្រូវបានបង្កើតឡើងនៅជុំវិញផ្ទាំង។",
  "help.tabs.sessions":
  ...
  "toast.update.description": "កំណែថ្មីនៃ MOD ({{version}}) ឥឡូវនេះមានសម្រាប់ដំឡើងហើយ។",
  ...
  "error.page.report.prefix": "សូមរាយការណ៍ពីកំហុសនេះទៅកាន់ក្រុម MOD",
  ...
  "error.chain.checkConfig": "ពិនិត្យការកំណត់រចនាសម្ព័ន្ធរបស់អ្នក (MOD.json) អ្នកផ្តល់សេវា/ឈ្មោះម៉ូដែល",
  "error.chain.mcpFailed": 'ម៉ាស៊ីនមេ MCP "{{name}}" បានបរាជ័យ។ ចំណាំ MOD មិនគាំទ្រការផ្ទៀងផ្ទាត់ MCP នៅឡើយទេ។',
  ...
  "sidebar.gettingStarted.line1": "MOD រួមបញ្ចូលម៉ូដែលឥតគិតថ្លៃ ដូច្នេះអ្នកអាចចាប់ផ្តើមភ្លាមៗ។",
  ...
  "settings.desktop.wsl.description": "ដំណើរការម៉ាស៊ីនមេ MOD នៅខាងក្នុង WSL នៅលើ Windows ។",
  ...
  "settings.general.row.language.description": "ប្តូរភាសាបង្ហាញសម្រាប់ MOD",
  ...
  "settings.general.row.appearance.description": "ប្ដូរតាមបំណងពីរបៀបដែល MOD មើលទៅលើឧបករណ៍របស់អ្នក។",
  "settings.general.row.colorScheme.title": "ពណ៌ចម្រុះ",
  "settings.general.row.colorScheme.description": "ជ្រើសរើសថាតើ MOD ធ្វើតាមប្រព័ន្ធ ពន្លឺ ឬរូបរាងងងឹត",
  "settings.general.row.theme.title": "ស្បែក",
  "settings.general.row.theme.description": "ប្ដូរតាមបំណងពីរបៀបដែល MOD មានប្រធានបទ។",
  ...
  "settings.updates.row.startup.description": "ពិនិត្យមើលការអាប់ដេតដោយស្វ័យប្រវត្តិនៅពេលដែល MOD ចាប់ផ្តើម",
  ...
  "settings.updates.toast.latest.description": "អ្នកកំពុងដំណើរការកំណែចុងក្រោយបំផុតនៃ MOD ។",
