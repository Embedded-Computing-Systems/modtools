export const dict = {
  ...
  "dialog.provider.mod.tagline": "Надежные оптимизированные модели",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в MOD.",
  ...
  "provider.connect.modZen.visit.suffix": " чтобы получить ваш API ключ.",
  ...
  "dialog.server.description": "Переключите сервер MOD к которому подключается приложение.",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в MOD требуется WSL (Windows Subsystem for Linux)",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера/модели в конфиге (MOD.json)",
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что MOD пока не поддерживает MCP авторизацию.',
  ...
  "settings.general.row.appearance.description": "Настройте как MOD выглядит на вашем устройстве",
