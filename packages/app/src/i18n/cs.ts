export const dict = {
  ...
  "desktop.menu.documentation": "MOD Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka MOD",
  ...
  "desktop.recovery.loadFailed": "MOD se nepodařilo načíst",
  "desktop.recovery.terminated": "MOD okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "MOD nereaguje",
  ...
  "desktop.wsl.error.installMod": "MOD instalace se nezdařila",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je již přidáno",
  "desktop.wsl.error.modMissing": "mod není v této distribuci nainstalováno",
  "desktop.wsl.error.modCannotRun": "mod je nainstalován, ale nelze jej spustit",
  "desktop.wsl.error.modNotInstalled": "MOD není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "MOD aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "dialog.provider.mod.note": "Vybrané modely včetně Claude, GPT, Gemini a dalších",
  "dialog.provider.mod.tagline": "Spolehlivé optimalizované modely",
  "dialog.provider.modGo.tagline": "Nízkonákladové předplatné pro každého",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v MOD.",
  ...
  "provider.connect.modZen.line1":
    "MOD Zen vám poskytuje přístup k upravené sadě spolehlivých optimalizovaných modelů pro kódovací agenty.",
  "provider.connect.modZen.line2":
    "Pomocí jediného tlačítka API získáte přístup k modelům jako Claude, GPT, Gemini, GLM a dalším.",
  "provider.connect.modZen.visit.prefix": "Návštěva ",
  "provider.connect.modZen.visit.link": "opencode.ai/zen",
  "provider.connect.modZen.visit.suffix": " vyzvedněte svůj klíč API.",
  "provider.connect.oauth.code.visit.prefix": "Návštěva ",
  "provider.connect.oauth.code.visit.link": "tento odkaz",
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v MOD.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v MOD.",
  ...
  "dialog.plugins.empty": "Pluginy nakonfigurované v MOD.json",
  ...
  "dialog.server.description": "Přepněte, ke kterému MOD serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingMod": "Kontrola MOD...",
  "wsl.onboarding.checkingModIn": "Kontrola MOD v {{distro}}...",
  "wsl.onboarding.updatingMod": "Aktualizace MOD...",
  "wsl.onboarding.updatingModIn": "Aktualizace MOD v {{distro}}...",
  "wsl.onboarding.updateModIn": "Aktualizace MOD v {{distro}}.",
  "wsl.onboarding.updateMod": "Aktualizovat MOD",
  "wsl.onboarding.modReadyIn": "MOD je připraveno v {{distro}}.",
  "wsl.onboarding.modReady": "MOD je připraven.",
  "wsl.onboarding.installModIn": "Nainstalujte MOD do {{distro}}.",
  "wsl.onboarding.installMod": "Instalovat MOD",
  ...
  "wsl.onboarding.distroStatus.modMissing": "MOD není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než MOD může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "MOD nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete MOD.",
  ...
  "help.tabs.introduction": "MOD Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze MOD ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu MOD",
  ...
  "error.chain.checkConfig": "Zkontrolujte název poskytovatele/modelu konfigurace (MOD.json).",
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: MOD zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "MOD obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server MOD uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro MOD",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled MOD na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude MOD následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma MOD.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění MOD",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi MOD.",
