...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    items: [
      { type: "item", labelKey: "desktop.menu.documentation", href: "https://modtools.ai/docs" },
      { type: "item", labelKey: "desktop.menu.supportForum", href: "https://discord.com/invite/mod" },
      { type: "item", labelKey: "desktop.menu.exportLogs", command: "logs.export" },
      { type: "separator" },
      {
        type: "item",
        labelKey: "desktop.menu.shareFeedback",
        href: "https://github.com/Embedded-Computing-Systems/modtools/issues/new?template=feature_request.yml",
      },
      {
        type: "item",
        labelKey: "desktop.menu.reportBug",
        href: "https://github.com/Embedded-Computing-Systems/modtools/issues/new?template=bug_report.yml",
      },
    ],
  },
]
