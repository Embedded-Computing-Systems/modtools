...
`~/.config/MOD/agents/` 또는 `.mod/agents/`의 Markdown 파일로 agent를 정의할 수도 있습니다. [더 알아보기](/docs/agents).
...
`~/.config/MOD/commands/` 또는 `.mod/commands/`의 Markdown 파일로 command를 정의할 수도 있습니다. [더 알아보기](/docs/commands).
...
plugin 파일은 `.mod/plugins/` 또는 `~/.config/MOD/plugins/`에 두세요. `plugin` 옵션으로 npm plugin을 로드할 수도 있습니다.
