...
1. TUI에서 `/connect` 명령을 실행하고 `Mod Zen`을 선택한 뒤, [modtools.ai/auth](https://modtools.ai/zen)로 이동합니다.
...
1. TUI에서 `/connect` 명령을 실행하고 `Mod Go`를 선택한 뒤 [modtools.ai/auth](https://modtools.ai/zen)로 이동하십시오.
...
Helicone의 [Sessions](https://docs.helicone.ai/features/sessions) 기능을 사용하면 관련 LLM 요청을 그룹화할 수 있습니다. [MOD-helicone-session](https://github.com/H2Shami/MOD-helicone-session) 플러그인을 사용하여 각 Mod 대화를 Helicone 세션으로 자동 기록하십시오.
