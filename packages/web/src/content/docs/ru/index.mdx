...
1. Запустите команду `/connect` в TUI, выберите opencode и перейдите по адресу [modtools.ai/auth](https://modtools.ai/auth).
...
Вот [пример диалога](https://modtools.ai/s/4XP1fce5) с opencode.
