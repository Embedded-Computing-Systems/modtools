...
- Конфигурация проекта: `.mod/skills/<name>/SKILL.md`
...
Он загружает все соответствующие `skills/*/SKILL.md` в `.mod/` и все соответствующие `.claude/skills/*/SKILL.md` или `.agents/skills/*/SKILL.md` по пути.
...
Создайте `.mod/skills/git-release/SKILL.md` следующим образом:
