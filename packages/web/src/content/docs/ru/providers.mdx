...
1. Запустите команду `/connect` в TUI, выберите `OpenCode Zen` и перейдите по адресу [modtools.ai/auth](https://modtools.ai/zen).
...
1. Запустите команду `/connect` в TUI, выберите `OpenCode Go` и перейдите по адресу [modtools.ai/auth](https://modtools.ai/zen).
