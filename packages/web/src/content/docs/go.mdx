...
| Qwen3.6 Plus | qwen3.6-plus | `https://modtools.ai/zen/go/v1/chat/completions` | `@ai-sdk/alibaba`           |
| Qwen3.5 Plus | qwen3.5-plus | `https://modtools.ai/zen/go/v1/chat/completions` | `@ai-sdk/alibaba`           |
