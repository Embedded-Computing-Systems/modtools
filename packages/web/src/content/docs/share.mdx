---
title: Share
description: Share your Model-of-Design Tools conversations.
---

Model-of-Design Tools's share feature allows you to create public links to your Model-of-Design Tools conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, Model-of-Design Tools:
...
Model-of-Design Tools supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, Model-of-Design Tools uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
To enforce this across your team for a given project, add it to the `modtools.json` in your project and check into Git.
...
[Learn more](/docs/enterprise) about using modtools in your organization.
