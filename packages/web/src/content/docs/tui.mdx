---
title: TUI
description: Using the Model-of-Design Tools terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Model-of-Design Tools provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running Model-of-Design Tools starts the TUI for the current directory.
...
When using the Model-of-Design Tools TUI, you can type `/` followed by a command name to quickly execute actions. For example:
...
Add a provider to Model-of-Design Tools. Allows you to select from available providers and add their API keys.
...
Exit Model-of-Design Tools. _Aliases_: `/quit`, `/q`
...
This is separate from `modtools.json`, which configures server/runtime behavior.
...
Use `MOD_TUI_CONFIG` to load a custom TUI config path.
