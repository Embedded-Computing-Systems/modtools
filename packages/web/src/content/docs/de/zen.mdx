---
title: Zen
description: Kuratierte Modellliste direkt von Mod.
---
...
Mod Zen ist eine Liste von getesteten und verifizierten Modellen, die vom Mod-Team bereitgestellt wird.

Zen funktioniert wie jeder andere Provider in Mod. Du meldest dich bei Mod Zen an und erhältst deinen API-Key. Es ist **vollständig optional** und du musst es nicht verwenden, um Mod zu nutzen.
...
:::tip
Wir haben eine ausgewählte Gruppe von Modellen und Providern getestet, die gut mit Mod funktionieren.
:::
...
Mod Zen ist ein AI-Gateway, das dir Zugriff auf diese Modelle gibt.

---

## So funktioniert es

Mod Zen funktioniert wie jeder andere Provider in Mod.

1. Du meldest dich bei **<a href={console}>Mod Zen</a>** an, hinterlegst deine Zahlungsdaten und kopierst deinen API-Key.
2. Du führst den Befehl `/connect` in der TUI aus, wählst Mod Zen aus und fügst deinen API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner Mod-Konfiguration verwendet das Format `MOD/<model-id>`. Für GPT 5.5 würdest du zum Beispiel `MOD/gpt-5.5` in deiner Konfiguration verwenden.
...
- DeepSeek V4 Flash Free ist für begrenzte Zeit auf Mod verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- MiMo-V2.5 Free ist für begrenzte Zeit auf Mod verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- North Mini Code Free ist für begrenzte Zeit auf Mod verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3 Ultra Free ist für begrenzte Zeit auf Mod verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das für begrenzte Zeit kostenlos auf Mod verfügbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
Wir haben Mod Zen geschaffen, um:
...
4. **keinen Lock-in** zu haben, indem du es mit jedem anderen Coding-Agenten verwenden kannst. Und dir außerdem immer zu erlauben, mit Mod auch jeden anderen Provider zu verwenden.
