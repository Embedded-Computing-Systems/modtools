---
title: Zen
description: Kuratierte Modellliste direkt von Model-of-Design Tools.
---
...
Model-of-Design Tools Zen ist eine Liste von getesteten und verifizierten Modellen, die vom Model-of-Design Tools-Team bereitgestellt wird.

:::note
Model-of-Design Tools Zen befindet sich derzeit in der Beta.
:::

Zen funktioniert wie jeder andere Provider in Model-of-Design Tools. Du meldest dich bei Model-of-Design Tools Zen an und erhältst deinen API-Key. Es ist **vollständig optional** und du musst es nicht verwenden, um Model-of-Design Tools zu nutzen.
...
:::tip
Wir haben eine ausgewählte Gruppe von Modellen und Providern getestet, die gut mit Model-of-Design Tools funktionieren.
:::
...
Model-of-Design Tools Zen ist ein AI-Gateway, das dir Zugriff auf diese Modelle gibt.

---

## So funktioniert es

Model-of-Design Tools Zen funktioniert wie jeder andere Provider in Model-of-Design Tools.

1. Du meldest dich bei **<a href={console}>Model-of-Design Tools Zen</a>** an, hinterlegst deine Zahlungsdaten und kopierst deinen API-Key.
2. Du führst den Befehl `/connect` in der TUI aus, wählst Model-of-Design Tools Zen aus und fügst deinen API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner Model-of-Design Tools-Konfiguration verwendet das Format `modtools/<model-id>`. Für GPT 5.3 Codex würdest du zum Beispiel `modtools/gpt-5.3-codex` in deiner Konfiguration verwenden.
...
- MiniMax M2.5 Free ist für begrenzte Zeit auf Model-of-Design Tools verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- MiMo V2 Pro Free ist für begrenzte Zeit auf Model-of-Design Tools verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- MiMo V2 Omni Free ist für begrenzte Zeit auf Model-of-Design Tools verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Qwen3.6 Plus Free ist für begrenzte Zeit auf Model-of-Design Tools verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3 Super Free ist für begrenzte Zeit auf Model-of-Design Tools verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das für begrenzte Zeit kostenlos auf Model-of-Design Tools verfügbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
Wir haben Model-of-Design Tools Zen geschaffen, um:
...
4. **keinen Lock-in** zu haben, indem du es mit jedem anderen Coding-Agenten verwenden kannst. Und dir außerdem immer zu erlauben, mit Model-of-Design Tools auch jeden anderen Provider zu verwenden.
