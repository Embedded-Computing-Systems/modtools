...
Erstellen Sie `.modtools/commands/test.md`:

```md title=".modtools/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die Model-of-Design Tools-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Model-of-Design Tools [config](/docs/config):

```json title="modtools.jsonc" {4-12}
{
...
- Global: `~/.config/modtools/commands/`
- Pro Projekt: `.modtools/commands/`

```markdown title="~/.config/modtools/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".modtools/commands/component.md"
---
...
```md title=".modtools/commands/create-file.md"
---
...
```md title=".modtools/commands/analyze-coverage.md"
---
...
```md title=".modtools/commands/review-changes.md"
---
...
```md title=".modtools/commands/review-component.md"
---
...
Model-of-Design Tools enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
