...
Sie können benutzerdefinierte Befehle über die Mod-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Mod [config](/docs/config):

```json title="MOD.jsonc" {4-12}
{
...
- Global: `~/.config/MOD/commands/`
- Pro Projekt: `.modtools/commands/`

```markdown title="~/.config/MOD/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
Mod enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
