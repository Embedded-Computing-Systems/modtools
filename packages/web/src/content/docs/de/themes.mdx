...
Mit Model-of-Design Tools kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet Model-of-Design Tools das `modtools`-Theme.
...
Model-of-Design Tools liefert mehrere eingebaute Themes mit.
...
- Model-of-Design Tools optisch ans Terminal anpassen wollen
...
Model-of-Design Tools unterstuetzt ein flexibles JSON-basiertes Theme-System.
...
2. **Benutzer-Config-Verzeichnis** - Definiert in `~/.config/modtools/themes/*.json` oder `$XDG_CONFIG_HOME/modtools/themes/*.json`
3. **Projekt-Root-Verzeichnis** - Definiert in `<project-root>/.modtools/themes/*.json`
4. **Aktuelles Arbeitsverzeichnis** - Definiert in `./.modtools/themes/*.json`
