...
Mit Mod kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet Mod das `MOD`-Theme.
...
Mod liefert mehrere eingebaute Themes mit.
...
- Mod optisch ans Terminal anpassen wollen
...
Mod unterstuetzt ein flexibles JSON-basiertes Theme-System.
...
2. **Benutzer-Config-Verzeichnis** - Definiert in `~/.config/MOD/themes/*.json` oder `$XDG_CONFIG_HOME/MOD/themes/*.json`
