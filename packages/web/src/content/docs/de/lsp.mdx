---
title: LSP Server
description: Model-of-Design Tools lässt sich in Ihren LSP-Server integrieren.
---

Model-of-Design Tools lässt sich in Ihr Language Server Protocol (LSP) integrieren, um die Interaktion von LLM mit Ihrer Codebasis zu unterstützen. Es verwendet Diagnosefunktionen, um dem LLM Feedback zu geben.

---

## Integriert

Model-of-Design Tools verfügt über mehrere integrierte LSP-Server für gängige Sprachen:
...
:::note
Sie können LSP-Server-Downloads automatisch deaktivieren, indem Sie die Umgebungsvariable `MOD_DISABLE_LSP_DOWNLOAD` auf `true` setzen.
:::
...
Wenn Model-of-Design Tools eine Datei öffnet, geschieht Folgendes:
...
Sie können LSP-Server über den Abschnitt `lsp` in Ihrer Model-of-Design Tools-Konfiguration anpassen.
