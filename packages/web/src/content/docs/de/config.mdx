...
Sie können Agenten auch mithilfe von Markdown-Dateien in `~/.config/MOD/agents/` oder `.mod/agents/` definieren. [Mehr erfahren](/docs/agents).
...
Sie können Befehle auch mithilfe von Markdown-Dateien in `~/.config/MOD/commands/` oder `.mod/commands/` definieren. [Mehr erfahren](/docs/commands).
...
Platzieren Sie Ihre Plugin-Dateien in `.mod/plugins/` oder `~/.config/MOD/plugins/`. Sie können Plugins auch über die Option `plugin` von npm laden.
