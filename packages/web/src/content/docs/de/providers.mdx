...
1. Führen Sie den Befehl `/connect` in der TUI aus, waehlen Sie `Mod Go` und gehen Sie zu [modtools.ai/auth](https://modtools.ai/zen).
...
Mit der [Sessions](https://docs.helicone.ai/features/sessions)-Funktion von Helicone können Sie zusammengehörige LLM-Anfragen gruppieren. Verwenden Sie das [MOD-helicone-session](https://github.com/H2Shami/MOD-helicone-session)-Plugin, um jede Mod-Konversation automatisch als Sitzung in Helicone zu protokollieren.
