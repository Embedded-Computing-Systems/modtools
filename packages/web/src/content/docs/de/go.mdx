...
Die [Modell-ID](/docs/config/#models) in deiner MOD Config verwendet das Format `MOD-go/<model-id>`. Für Kimi K3 würdest du beispielsweise `MOD-go/kimi-k3` in deiner Config verwenden.
