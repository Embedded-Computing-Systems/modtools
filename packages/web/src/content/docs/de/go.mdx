...
Model-of-Design Tools Go ist ein kostengünstiges Abonnement — **5 $ für deinen ersten Monat**, danach **10 $/Monat** —, das dir zuverlässigen Zugriff auf beliebte offene Coding-Modelle bietet.

:::note
Model-of-Design Tools Go befindet sich derzeit in der Beta-Phase.
:::

Go funktioniert wie jeder andere Provider in Model-of-Design Tools. Du abonnierst Model-of-Design Tools Go und
erhältst deinen API-Key. Es ist **völlig optional** und du musst es nicht nutzen, um
Model-of-Design Tools zu verwenden.
...
Model-of-Design Tools Go bietet dir Zugriff auf diese Modelle für **5 $ im ersten Monat**, danach **10 $/Monat**.

---

## Wie es funktioniert

Model-of-Design Tools Go funktioniert wie jeder andere Provider in Model-of-Design Tools.

1. Du meldest dich bei **<a href={console}>Model-of-Design Tools Zen</a>** an, abonnierst Go und kopierst deinen API-Key.
2. Du führst den Befehl `/connect` in der TUI aus, wählst `Model-of-Design Tools Go` und fügst deinen API-Key ein.
3. Führe `/models` in der TUI aus, um die Liste der über Go verfügbaren Modelle zu sehen.

:::note
Nur ein Mitglied pro Workspace kann Model-of-Design Tools Go abonnieren.
:::
...
Model-of-Design Tools Go beinhaltet die folgenden Limits:
...
Die [Modell-ID](/docs/config/#models) in deiner Model-of-Design Tools Config verwendet das Format `modtools-go/<model-id>`. Für Kimi K2.5 würdest du beispielsweise `modtools-go/kimi-k2.5` in deiner Config verwenden.
...
Wir haben Model-of-Design Tools Go entwickelt, um:
...
4. **Keinen Lock-in-Effekt** zu haben, indem wir dir ermöglichen, auch jeden anderen Provider mit Model-of-Design Tools zu nutzen.
