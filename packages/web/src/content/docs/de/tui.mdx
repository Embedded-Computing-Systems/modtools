---
title: TUI
description: Arbeite mit Model-of-Design Tools in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Model-of-Design Tools bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet Model-of-Design Tools die TUI im aktuellen Verzeichnis.
...
In der Model-of-Design Tools-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Fuegt einen Provider zu Model-of-Design Tools hinzu. Erlaubt die Auswahl aus verfuegbaren Providern und das Hinzufuegen ihrer API-Keys.
...
Beendet Model-of-Design Tools. _Aliase_: `/quit`, `/q`
...
Dies ist getrennt von `modtools.json`, welche das Server-/Runtime-Verhalten konfiguriert.
...
Verwende `MOD_TUI_CONFIG`, um einen benutzerdefinierten TUI-Konfigurationspfad zu laden.
