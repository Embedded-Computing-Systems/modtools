...
Dabei werden passende `skills/*/SKILL.md` in `.mod/` sowie passende Dateien unter `.claude/skills/*/SKILL.md` und `.agents/skills/*/SKILL.md` geladen.
...
Erstelle `.mod/skills/git-release/SKILL.md` zum Beispiel so:
