...
Es gibt zwei Arten von Agenten in Model-of-Design Tools; Primäragenten und Subagenten.
...
Model-of-Design Tools verfügt über zwei integrierte Primäragenten: **Build** und **Plan**. Auch
...
Konfigurieren Sie Agenten in Ihrer `modtools.json`-Konfigurationsdatei:
...
Wenn keine Temperatur angegeben ist, verwendet Model-of-Design Tools modellspezifische Standardwerte; typischerweise 0 für die meisten Modelle, 0.55 für Qwen-Modelle.
...
Dieser Pfad ist relativ zum Speicherort der Konfigurationsdatei. Dies funktioniert sowohl für die globale Model-of-Design Tools-Konfiguration als auch für die projektspezifische Konfiguration.
...
Die Modell-ID in Ihrer Model-of-Design Tools-Konfiguration verwendet das Format `provider/model-id`. Wenn Sie beispielsweise [Model-of-Design Tools Zen](/docs/zen) verwenden, würden Sie `modtools/gpt-5.1-codex` für GPT 5.1 Codex verwenden.
...
:::tip
Führen Sie `modtools models` aus, um eine Liste der verfügbaren Modelle anzubieten.
:::
...
:::tip
Haben Sie einen Agenten, den Sie gerne teilen möchten? [Reichen Sie einen PR ein](https://github.com/Embedded-Computing-Systems/modtools).
:::
