---
title: Teilen
description: Teile Mod-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Mod-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Mod Folgendes:
...
Mod hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Mod den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`MOD.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du MOD in deiner Organisation einsetzt.
