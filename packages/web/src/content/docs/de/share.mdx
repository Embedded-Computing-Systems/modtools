---
title: Teilen
description: Teile Model-of-Design Tools-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Model-of-Design Tools-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Model-of-Design Tools Folgendes:
...
Model-of-Design Tools hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Model-of-Design Tools den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`modtools.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du modtools in deiner Organisation einsetzt.
