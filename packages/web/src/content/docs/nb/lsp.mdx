---
title: LSP-servere
description: MOD integreres med LSP-serverne dine.
---

Mod kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

Mod kommer med flere innebygde LSP-servere for populære språk:
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `MODTOOLS_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktivert og MOD åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i Mod-konfigurasjonen.
