---
title: LSP-servere
description: modtools integreres med LSP-serverne dine.
---

Model-of-Design Tools integreres med din Language Server Protocol (LSP) for å hjelpe LLM med å samhandle med kodebasen din. Den bruker diagnostikk for å gi tilbakemelding til LLM.

---

## Innebygde servere

Model-of-Design Tools kommer med flere innebygde LSP-servere for populære språk:
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `MOD_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når modtools åpner en fil, gjør den:
...
Du kan tilpasse LSP-servere gjennom `lsp`-delen i Model-of-Design Tools-konfigurasjonen.
