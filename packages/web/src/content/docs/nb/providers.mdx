...
1. Kjør kommandoen `/connect` i TUI, velg `Mod Zen` og gå til [modtools.ai/auth](https://modtools.ai/zen).
...
1. Kjør kommandoen `/connect` i TUI, velg `Mod Go`, og gå til [modtools.ai/auth](https://modtools.ai/zen).
...
Helicones [Sessions](https://docs.helicone.ai/features/sessions) funksjon lar deg gruppere relaterte LLM forespørsler sammen. Bruk [MOD-helicone-session](https://github.com/H2Shami/MOD-helicone-session) plugin for automatisk å logge hver Mod-samtale som en økt i Helicone.
