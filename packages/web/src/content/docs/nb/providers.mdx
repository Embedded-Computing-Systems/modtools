...
1. Kjør kommandoen `/connect` i TUI, velg `OpenCode Zen` og gå til [modtools.ai/auth](https://modtools.ai/zen).
...
1. Kjør kommandoen `/connect` i TUI, velg `OpenCode Go`, og gå til [modtools.ai/auth](https://modtools.ai/zen).
