---
title: SDK
description: Typesikker JS-klient for Model-of-Design Tools-server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Model-of-Design Tools JS/TS SDK gir en typesikker klient for samhandling med serveren.
Bruk den til å bygge integrasjoner og kontrollere Model-of-Design Tools programmatisk.
...
Opprett en forekomst av Model-of-Design Tools:
...
Du kan sende et konfigurasjonsobjekt for å tilpasse virkemåten. Forekomsten henter fortsatt din `modtools.json`, men du kan overstyre eller legge til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av Model-of-Design Tools, kan du opprette en klientforekomst for å koble til den:
