---
title: TUI
description: Bruke modtools-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Model-of-Design Tools gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre Model-of-Design Tools starter TUI for gjeldende katalog.
...
Når du bruker Model-of-Design Tools TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til Model-of-Design Tools. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt Model-of-Design Tools. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `modtools.json`, som konfigurerer server-/kjøretidsoppførsel.
...
Bruk `MOD_TUI_CONFIG` for å laste en egendefinert TUI-konfigurasjonsbane.
