...
Du kan også definere agenter ved å bruke markdown-filer i `~/.config/MOD/agents/` eller `.mod/agents/`. [Les mer her](/docs/agents).
...
Du kan også definere kommandoer ved å bruke markdown-filer i `~/.config/MOD/commands/` eller `.mod/commands/`. [Les mer her](/docs/commands).
...
Plasser plugin-filer i `.mod/plugins/` eller `~/.config/MOD/plugins/`. Du kan også laste inn plugins fra npm gjennom alternativet `plugin`.
