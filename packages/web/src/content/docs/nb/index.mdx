...
1. Kjør kommandoen `/connect` i TUI, velg OpenCode og gå til [modtools.ai/auth](https://modtools.ai/auth).
...
Her er en [eksempelsamtale](https://modtools.ai/s/4XP1fce5) med OpenCode.
