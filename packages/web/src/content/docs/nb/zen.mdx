...
Du vil kanskje legge merke til [lavprismodeller](/docs/config/#models), som Haiku, Nano eller Flash, i brukshistorikken din. MOD bruker disse modellene til å generere økttitler.
...
- Hy3 Free er tilgjengelig på MOD i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
- Nemotron 3.5 Lightning Free er tilgjengelig på MOD i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
- Ox Alpha Free er en stealth-modell som er gratis på MOD i en begrenset periode. Leverandøren følger en nulloppbevaringspolicy og bruker ikke dataene dine til å trene modeller.
- Muse Spark 1.2 Contributor Free er tilgjengelig på MOD i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
