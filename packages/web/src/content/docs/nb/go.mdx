...
Model-of-Design Tools Go er et lavkostnadsabonnement — **$5 for din første måned**, deretter **$10/måned** — som gir deg pålitelig tilgang til populære åpne kodemodeller.

:::note
Model-of-Design Tools Go er for øyeblikket i beta.
:::

Go fungerer som enhver annen leverandør i Model-of-Design Tools. Du abonnerer på Model-of-Design Tools Go og
får din API-nøkkel. Det er **helt valgfritt**, og du trenger ikke å bruke det for å
bruke Model-of-Design Tools.
...
Model-of-Design Tools Go gir deg tilgang til disse modellene for **$5 for din første måned**, deretter **$10/måned**.

---

## Hvordan det fungerer

Model-of-Design Tools Go fungerer som enhver annen leverandør i Model-of-Design Tools.

1. Du logger inn på **<a href={console}>Model-of-Design Tools Zen</a>**, abonnerer på Go, og
   kopierer din API-nøkkel.
2. Du kjører kommandoen `/connect` i TUI-en, velger `Model-of-Design Tools Go`, og limer inn
   din API-nøkkel.
3. Kjør `/models` i TUI-en for å se listen over modeller som er tilgjengelige gjennom Go.

:::note
Kun ett medlem per arbeidsområde kan abonnere på Model-of-Design Tools Go.
:::
...
Model-of-Design Tools Go inkluderer følgende grenser:
...
[Modell-ID-en](/docs/config/#models) i din Model-of-Design Tools-konfigurasjon
bruker formatet `modtools-go/<model-id>`. For eksempel, for Kimi K2.5, vil du
bruke `modtools-go/kimi-k2.5` i konfigurasjonen din.
...
Vi opprettet Model-of-Design Tools Go for å:
...
4. Ha **ingen innelåsing** ved å la deg bruke en hvilken som helst annen leverandør med Model-of-Design Tools også.
