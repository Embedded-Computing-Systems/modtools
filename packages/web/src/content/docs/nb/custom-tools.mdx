...
description: Lag verktøy som LLM kan kalle inn Mod.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med Mod sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
...
- Eller globalt, ved å plassere dem i `~/.config/MOD/tools/`.
