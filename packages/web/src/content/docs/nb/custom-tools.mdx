...
description: Lag verktøy som LLM kan kalle inn Model-of-Design Tools.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med Model-of-Design Tools sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved å plassere dem i `.modtools/tools/`-katalogen til prosjektet ditt.
- Eller globalt, ved å plassere dem i `~/.config/modtools/tools/`.
