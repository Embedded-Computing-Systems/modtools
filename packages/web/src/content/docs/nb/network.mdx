...
Model-of-Design Tools støtter standard proxy-miljøvariabler og tilpassede sertifikater for bedriftsnettverksmiljøer.
...
Hvis bedriften din bruker egendefinerte CA-er for HTTPS-tilkoblinger, konfigurer Model-of-Design Tools til å stole på dem.
