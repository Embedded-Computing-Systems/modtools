...
Det er to typer agenter i Model-of-Design Tools; primære agenter og underagenter.
...
Model-of-Design Tools kommer med to innebygde primære agenter, **Build** og **Plan**. Vi ser nærmere på disse nedenfor.
...
Model-of-Design Tools kommer med to innebygde underagenter, **General** og **Explore**. Vi skal se på dette nedenfor.

---

## Innebygd

Model-of-Design Tools kommer med to innebygde primære agenter og to innebygde underagenter.
...
Konfigurer agenter i konfigurasjonsfilen `modtools.json`:
...
- Globalt: `~/.config/modtools/agents/`
...
Hvis ingen temperatur er spesifisert, bruker Model-of-Design Tools modellspesifikke standardinnstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne banen er i forhold til hvor konfigurasjonsfilen er plassert. Så dette fungerer for både den globale Model-of-Design Tools-konfigurasjonen og den prosjektspesifikke konfigurasjonen.
...
Modellen ID i Model-of-Design Tools-konfigurasjonen din bruker formatet `provider/model-id`. For eksempel, hvis du bruker [Model-of-Design Tools Zen](/docs/zen), vil du bruke `modtools/gpt-5.1-codex` for GPT 5.1 Codex.
...
:::tip
Kjør `modtools models` for å se en liste over tilgjengelige modeller.
:::
