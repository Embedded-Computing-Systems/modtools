...
Opprett `.modtools/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom Model-of-Design Tools-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i Model-of-Design Tools [config](/docs/config):
...
- Globalt: `~/.config/modtools/commands/`
- Per prosjekt: `.modtools/commands/`
...
Model-of-Design Tools inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
