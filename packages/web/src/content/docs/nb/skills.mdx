...
Agentferdigheter lar Model-of-Design Tools oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
modtools søker etter disse stedene:
...
For prosjektlokale stier går modtools opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
modtools viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `modtools.json`:
