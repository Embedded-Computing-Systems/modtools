...
Agentferdigheter lar Mod oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går MOD opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
MOD viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `MOD.json`:
