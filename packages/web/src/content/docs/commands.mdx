...
Create `.modtools/commands/test.md`:
...
You can add custom commands through the Model-of-Design Tools config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your Model-of-Design Tools [config](/docs/config):
...
modtools includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
