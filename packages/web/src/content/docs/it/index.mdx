...
1. Esegui il comando `/connect` nella TUI, seleziona opencode e vai su [modtools.ai/auth](https://modtools.ai/auth).
...
Ecco un'[esempio di conversazione](https://modtools.ai/s/4XP1fce5) con OpenCode.
