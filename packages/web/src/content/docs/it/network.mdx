...
Model-of-Design Tools supporta le variabili d'ambiente standard per i proxy e certificati personalizzati per ambienti di rete enterprise.

---

## Proxy

Model-of-Design Tools rispetta le variabili d'ambiente standard dei proxy.
...
Se la tua organizzazione usa CA personalizzate per connessioni HTTPS, configura Model-of-Design Tools in modo che si fidi di esse.
