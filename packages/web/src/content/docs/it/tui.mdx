---
title: TUI
description: Usa l'interfaccia utente da terminale (TUI) di Model-of-Design Tools.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Model-of-Design Tools fornisce un'interfaccia interattiva da terminale (TUI) per lavorare sui tuoi progetti con un LLM.

Eseguire Model-of-Design Tools avvia la TUI per la directory corrente.
...
Quando usi la TUI di Model-of-Design Tools, puoi digitare `/` seguito dal nome di un comando per eseguire rapidamente azioni. Per esempio:
...
Aggiunge un provider a Model-of-Design Tools. Ti permette di selezionare tra i provider disponibili e aggiungere le relative chiavi API.
...
Esce da Model-of-Design Tools. _Alias_: `/quit`, `/q`
...
Questo è separato da `modtools.json`, che configura il comportamento di server/runtime.
...
Usa `MOD_TUI_CONFIG` per caricare un path di configurazione TUI personalizzato.
