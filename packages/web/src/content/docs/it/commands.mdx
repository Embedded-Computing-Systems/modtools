...
Crea `.modtools/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di Model-of-Design Tools o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Model-of-Design Tools:
...
- Globale: `~/.config/modtools/commands/`
- Per progetto: `.modtools/commands/`
...
modtools include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
