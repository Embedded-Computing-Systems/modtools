---
title: Condivisione
description: Condividi le tue conversazioni Model-of-Design Tools.
---

La funzione di condivisione di Model-of-Design Tools ti permette di creare link pubblici alle tue conversazioni, cosi puoi collaborare con i colleghi o chiedere aiuto ad altre persone.
...
Quando condividi una conversazione, Model-of-Design Tools:
...
Model-of-Design Tools supporta tre modalita di condivisione che controllano come vengono condivise le conversazioni:

---

### Manuale (predefinito)

Per impostazione predefinita, Model-of-Design Tools usa la condivisione manuale. Le sessioni non vengono condivise automaticamente, ma puoi condividerle manualmente con il comando `/share`:
...
Per applicarlo al tuo team in un progetto specifico, aggiungilo a `modtools.json` nel progetto e versionalo su Git.
...
[Scopri di piu](/docs/enterprise) su come usare modtools nella tua organizzazione.
