...
Puoi anche definire agenti usando file markdown in `~/.config/MOD/agents/` o `.mod/agents/`. [Scopri di piu](/docs/agents).
...
Puoi anche definire comandi usando file markdown in `~/.config/MOD/commands/` o `.mod/commands/`. [Scopri di piu](/docs/commands).
...
Metti i file dei plugin in `.mod/plugins/` o `~/.config/MOD/plugins/`. Puoi anche caricare plugin da npm tramite l'opzione `plugin`.
