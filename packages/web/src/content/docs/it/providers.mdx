...
La funzionalità [Sessions](https://docs.helicone.ai/features/sessions) di Helicone ti permette di raggruppare richieste LLM correlate. Usa il plugin [MOD-helicone-session](https://github.com/H2Shami/MOD-helicone-session) per loggare automaticamente ogni conversazione di Mod come una sessione in Helicone.
