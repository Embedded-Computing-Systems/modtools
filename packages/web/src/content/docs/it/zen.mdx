...
Potresti notare [modelli a basso costo](/docs/config/#models), come Haiku, Nano o Flash, nella cronologia di utilizzo. MOD usa questi modelli per generare i titoli delle sessioni.
...
- Hy3 Free è disponibile su MOD per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
...
- Nemotron 3.5 Lightning Free è disponibile su MOD per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
...
- Ox Alpha Free è un modello stealth gratuito su MOD per un periodo limitato. Il suo provider segue una politica di conservazione zero e non usa i tuoi dati per addestrare modelli.
- Muse Spark 1.2 Contributor Free è disponibile su MOD per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
