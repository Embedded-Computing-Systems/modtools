---
title: Zen
description: Lista curata di modelli fornita da Model-of-Design Tools.
---
...
Model-of-Design Tools Zen è un elenco di modelli testati e verificati forniti dal team di Model-of-Design Tools.

:::note
Model-of-Design Tools Zen è attualmente in beta.
:::

Zen funziona come qualsiasi altro provider in Model-of-Design Tools. Accedi a Model-of-Design Tools Zen e ottieni
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con Model-of-Design Tools.
:::
...
Model-of-Design Tools Zen è un gateway AI che ti dà accesso a questi modelli.

---

## Come funziona

Model-of-Design Tools Zen funziona come qualsiasi altro provider in Model-of-Design Tools.

1. Accedi a **<a href={console}>Model-of-Design Tools Zen</a>**, aggiungi i dettagli di fatturazione,
   e copia la tua chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona Model-of-Design Tools Zen, e incolla la tua chiave API.
...
Il [model id](/docs/config/#models) nella config di Model-of-Design Tools
usa il formato `modtools/<model-id>`. Per esempio, per GPT 5.3 Codex, useresti
`modtools/gpt-5.3-codex` nella tua config.
...
- MiniMax M2.5 Free è disponibile su Model-of-Design Tools per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- MiMo V2 Pro Free è disponibile su Model-of-Design Tools per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- MiMo V2 Omni Free è disponibile su Model-of-Design Tools per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Qwen3.6 Plus Free è disponibile su Model-of-Design Tools per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Nemotron 3 Super Free è disponibile su Model-of-Design Tools per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Big Pickle è un modello stealth che è gratuito su Model-of-Design Tools per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
...
Abbiamo creato Model-of-Design Tools Zen per:
...
4. Non avere **lock-in** permettendoti di usarlo con qualsiasi altro agente di coding. E permettendoti sempre di usare anche qualsiasi altro provider con Model-of-Design Tools.
