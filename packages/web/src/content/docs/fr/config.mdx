...
Vous pouvez également définir des agents à l'aide de fichiers markdown dans `~/.config/MOD/agents/` ou `.mod/agents/`. [En savoir plus ici](/docs/agents).
...
Vous pouvez également définir des commandes à l'aide de fichiers markdown dans `~/.config/MOD/commands/` ou `.mod/commands/`. [En savoir plus ici](/docs/commands).
...
Placez les fichiers du plugin dans `.mod/plugins/` ou `~/.config/MOD/plugins/`. Vous pouvez également charger des plugins depuis npm via l'option `plugin`.
