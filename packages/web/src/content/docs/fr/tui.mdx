---
title: TUI
description: Utilisation de l’interface utilisateur du terminal Model-of-Design Tools.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Model-of-Design Tools fournit une interface de terminal interactif ou TUI pour travailler sur vos projets avec un LLM.

L’exécution de Model-of-Design Tools démarre le TUI pour le répertoire actuel.
...
Lorsque vous utilisez le Model-of-Design Tools TUI, vous pouvez taper `/` suivi d'un nom de commande pour exécuter rapidement des actions. Par exemple:
...
Ajoutez un fournisseur à Model-of-Design Tools. Vous permet de sélectionner parmi les fournisseurs disponibles et d’ajouter leurs clés API.
...
Quittez Model-of-Design Tools. *Alias* : `/quit`, `/q`
...
Ceci est séparé de `modtools.json`, qui configure le comportement du serveur/d'exécution.
...
Utilisez `MOD_TUI_CONFIG` pour charger un chemin de configuration TUI personnalisé.
