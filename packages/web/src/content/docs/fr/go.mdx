...
L'[ID de modèle](/docs/config/#models) dans votre configuration MOD utilise le format `MOD-go/<model-id>`. Par exemple, pour Kimi K3, vous utiliseriez `MOD-go/kimi-k3` dans votre configuration.
