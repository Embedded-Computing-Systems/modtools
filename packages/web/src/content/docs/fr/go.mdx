...
Model-of-Design Tools Go est un abonnement à bas coût — **5 $ pour votre premier mois**, puis **10 $/mois** — qui vous donne un accès fiable aux modèles de codage ouverts populaires.

:::note
Model-of-Design Tools Go est actuellement en version bêta.
:::

Go fonctionne comme n'importe quel autre fournisseur dans Model-of-Design Tools. Vous vous abonnez à Model-of-Design Tools Go et obtenez votre clé d'API. C'est **totalement facultatif** et vous n'avez pas besoin de l'utiliser pour utiliser Model-of-Design Tools.
...
Model-of-Design Tools Go vous donne accès à ces modèles pour **5 $ pour votre premier mois**, puis **10 $/mois**.

---

## Comment ça marche

Model-of-Design Tools Go fonctionne comme n'importe quel autre fournisseur dans Model-of-Design Tools.

1. Vous vous connectez à **<a href={console}>Model-of-Design Tools Zen</a>**, vous vous abonnez à Go et copiez votre clé d'API.
2. Vous exécutez la commande `/connect` dans la TUI, sélectionnez `Model-of-Design Tools Go` et collez votre clé d'API.
3. Exécutez `/models` dans la TUI pour voir la liste des modèles disponibles via Go.

:::note
Un seul membre par espace de travail peut s'abonner à Model-of-Design Tools Go.
:::
...
Model-of-Design Tools Go inclut les limites suivantes :
...
| Kimi K2.5    | kimi-k2.5    | `https://modtools.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiMo-V2-Pro  | mimo-v2-pro  | `https://modtools.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiMo-V2-Omni | mimo-v2-omni | `https://modtools.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
...
L'[ID de modèle](/docs/config/#models) dans votre configuration Model-of-Design Tools utilise le format `modtools-go/<model-id>`. Par exemple, pour Kimi K2.5, vous utiliseriez `modtools-go/kimi-k2.5` dans votre configuration.
...
Nous avons créé Model-of-Design Tools Go pour :
...
4. N'avoir **aucun verrouillage exclusif** en vous permettant d'utiliser n'importe quel autre fournisseur avec Model-of-Design Tools également.
