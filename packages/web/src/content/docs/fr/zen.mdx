---
title: Zen
description: Liste organisée de modèles fournis par Model-of-Design Tools.
---
...
Model-of-Design Tools Zen est une liste de modèles testés et vérifiés fournie par l'équipe Model-of-Design Tools.

:::note
Model-of-Design Tools Zen est actuellement en version bêta.
:::

Zen fonctionne comme n'importe quel autre fournisseur dans Model-of-Design Tools. Vous vous connectez à Model-of-Design Tools Zen et obtenez votre clé API. C'est **entièrement facultatif** et vous n'avez pas besoin de l'utiliser pour utiliser Model-of-Design Tools.
...
:::tip
Nous avons testé un groupe sélectionné de modèles et de fournisseurs qui fonctionnent bien avec Model-of-Design Tools.
:::
...
Model-of-Design Tools Zen est une passerelle AI qui vous donne accès à ces modèles.

---

## Comment ça marche

Model-of-Design Tools Zen fonctionne comme n'importe quel autre fournisseur dans Model-of-Design Tools.

1. Vous vous connectez à **<a href={console}>Model-of-Design Tools Zen</a>**, ajoutez vos informations de facturation et copiez votre clé API.
2. Vous exécutez la commande `/connect` dans le TUI, sélectionnez Model-of-Design Tools Zen et collez votre clé API.
...
| MiniMax M2.5 Free     | minimax-m2.5-free     | `https://modtools.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
...
| MiMo V2 Pro Free      | mimo-v2-pro-free      | `https://modtools.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| MiMo V2 Omni Free     | mimo-v2-omni-free     | `https://modtools.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Qwen3.6 Plus Free     | qwen3.6-plus-free     | `https://modtools.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Nemotron 3 Super Free | nemotron-3-super-free | `https://modtools.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |

Le [model id](/docs/config/#models) dans votre configuration Model-of-Design Tools utilise le format `modtools/<model-id>`. Par exemple, pour GPT 5.3 Codex, vous utiliseriez `modtools/gpt-5.3-codex` dans votre configuration.
...
- MiniMax M2.5 Free est disponible sur Model-of-Design Tools pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- MiMo V2 Pro Free est disponible sur Model-of-Design Tools pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- MiMo V2 Omni Free est disponible sur Model-of-Design Tools pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Qwen3.6 Plus Free est disponible sur Model-of-Design Tools pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Nemotron 3 Super Free est disponible sur Model-of-Design Tools pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Big Pickle est un modèle stealth gratuit sur Model-of-Design Tools pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
...
Nous avons créé Model-of-Design Tools Zen pour :
...
4. N'avoir **aucun lock-in** en vous permettant de l'utiliser avec n'importe quel autre agent de codage. Et toujours vous permettre d'utiliser n'importe quel autre fournisseur avec Model-of-Design Tools également.
