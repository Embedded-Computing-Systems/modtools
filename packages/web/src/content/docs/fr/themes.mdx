...
3. **Répertoire racine du projet** - Défini dans `<project-root>/.mod/themes/*.json`
4. **Répertoire de travail actuel** - Défini dans `./.mod/themes/*.json`
