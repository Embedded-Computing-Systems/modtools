...
Model-of-Design Tools prend en charge les variables d'environnement proxy standard et les certificats personnalisés pour les environnements réseau d'entreprise.

---

## Proxy

Model-of-Design Tools respecte les variables d'environnement proxy standard.
...
Si votre entreprise utilise des autorités de certification personnalisées pour les connexions HTTPS, configurez Model-of-Design Tools pour leur faire confiance.
