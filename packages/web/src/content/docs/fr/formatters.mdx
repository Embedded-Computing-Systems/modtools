---
title: Formateurs
description: Model-of-Design Tools utilise des formateurs spécifiques au langage.
---

Model-of-Design Tools formate automatiquement les fichiers après leur écriture ou leur modification à l'aide de formateurs spécifiques au langage. Cela garantit que le code généré suit les styles de code de votre projet.

---

## Formateurs intégrés

Model-of-Design Tools est livré avec plusieurs formateurs intégrés pour les langages et frameworks populaires. Vous trouverez ci-dessous une liste des formateurs, des extensions de fichiers prises en charge et des commandes ou options de configuration dont il a besoin.
...
Ainsi, si votre projet a `prettier` dans votre `package.json`, Model-of-Design Tools l'utilisera automatiquement.

---

## Comment ça marche

Lorsque Model-of-Design Tools écrit ou modifie un fichier, il :
...
Vous pouvez personnaliser les formateurs via la section `formatter` de votre configuration Model-of-Design Tools.
