...
1. Exécutez la commande `/connect` dans le TUI, sélectionnez opencode et allez sur [modtools.ai/auth](https://modtools.ai/auth).
...
Voici un [exemple de conversation](https://modtools.ai/s/4XP1fce5) avec OpenCode.
