...
You may notice [low-cost models](/docs/config/#models), such as Haiku, Nano, or Flash, in your usage history. MOD uses these models to generate session titles.
...
- Hy3 Free is available on MOD for a limited time. The team is using this time to collect feedback and improve the model.
...
- Nemotron 3.5 Lightning Free is available on MOD for a limited time. The team is using this time to collect feedback and improve the model.
...
- Ox Alpha Free is a stealth model that's free on MOD for a limited time. Its provider follows a zero-retention policy and does not use your data for model training.
- Muse Spark 1.2 Contributor Free is available on MOD for a limited time. The team is using this time to collect feedback and improve the model.
