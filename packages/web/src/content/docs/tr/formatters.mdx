...
description: MOD dile özgü biçimlendiriciler kullanır.
---

MOD, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

MOD, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, MOD bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

MOD bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri MOD yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
