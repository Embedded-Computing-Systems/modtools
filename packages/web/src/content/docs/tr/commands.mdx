...
`.modtools/commands/test.md` oluştur:
...
modtools işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

modtools [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/modtools/commands/`
- Proje başına: `.modtools/commands/`
...
modtools, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
