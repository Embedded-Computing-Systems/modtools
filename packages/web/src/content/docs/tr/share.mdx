---
title: Paylasim
description: MOD konusmalarini genel baglantilarla paylasin.
---

MOD'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda MOD:
...
MOD, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak MOD manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `MOD.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda MOD kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
