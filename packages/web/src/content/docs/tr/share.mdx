---
title: Paylasim
description: modtools konusmalarini genel baglantilarla paylasin.
---

modtools'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda modtools:
...
modtools, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak modtools manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `modtools.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda modtools kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
