...
MOD yapılandırmanızdaki [model id](/docs/config/#models) formatı `MOD-go/<model-id>` şeklindedir. Örneğin, Kimi K3 için yapılandırmanızda `MOD-go/kimi-k3` kullanmalısınız.
