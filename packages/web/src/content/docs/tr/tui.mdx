---
title: TUI
description: Model-of-Design Tools terminal kullanıcı arayüzünü kullanma.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Model-of-Design Tools, projelerinizde LLM ile çalışmak için etkileşimli bir terminal arayüzü (TUI) sunar.

Model-of-Design Tools'u çalıştırdığınızda mevcut dizin için TUI başlar.
...
Model-of-Design Tools TUI kullanırken `/` ve ardından komut adını yazarak hızlı eylemler çalıştırabilirsiniz. Örneğin:
...
Model-of-Design Tools'a bir sağlayıcı ekler. Mevcut sağlayıcıları seçip API anahtarları eklemenizi sağlar.
...
Model-of-Design Tools'dan çıkar. _Takma adlar_: `/quit`, `/q`
...
Bu, sunucu/çalışma zamanı davranışını yapılandıran `modtools.json` dosyasından ayrıdır.
...
Özel bir TUI yapılandırma yolu yüklemek için `MOD_TUI_CONFIG` kullanın.
