...
Ajan becerileri, modtools'un deponuzdan veya ev dizininizden tekrar kullanilabilir talimatlari kesfetmesini saglar.
...
modtools su konumlari tarar:

- Proje konfigurasyonu: `.modtools/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/modtools/skills/<name>/SKILL.md`
...
Proje yerel yollarinda modtools, mevcut calisma dizininizden baslayip git worktree kokune kadar yukari cikar.
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.modtools/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/modtools/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.modtools/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
modtools, `skill` araci aciklamasinda mevcut becerileri listeler.
...
`modtools.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`modtools.json` icinde):
