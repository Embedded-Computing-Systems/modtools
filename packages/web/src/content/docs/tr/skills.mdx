...
- Proje konfigurasyonu: `.mod/skills/<name>/SKILL.md`
...
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.mod/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.
...
`.mod/skills/git-release/SKILL.md` dosyasini soyle olusturun:
