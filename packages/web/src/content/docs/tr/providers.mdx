...
1. TUI'de `/connect` komutunu çalıştırın, `Mod Go`'yu seçin ve [modtools.ai/auth](https://modtools.ai/zen) adresine gidin.
...
Helicone'un [Sessions](https://docs.helicone.ai/features/sessions) özelliği, ilgili LLM isteklerini birlikte gruplandırmanıza olanak tanır. Her MOD görüşmesini Helicone'da bir oturum olarak otomatik olarak kaydetmek için [MOD-helicone-session](https://github.com/H2Shami/MOD-helicone-session) eklentisini kullanın.
