...
1. TUI'de `/connect` komutunu çalıştırın, opencode'u seçin ve [modtools.ai/auth](https://modtools.ai/auth)'ye gidin.
...
1. TUI'de `/connect` komutunu çalıştırın, `OpenCode Go`'yu seçin ve [modtools.ai/auth](https://modtools.ai/zen) adresine gidin.
