---
title: Zen
description: MOD tarafından sağlanan seçilmiş modeller listesi.
---
...
Mod Zen, Mod ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, Mod'daki diğer sağlayıcılar gibi çalışır. Mod Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve Mod kullanmak için buna ihtiyacınız yoktur.
...
:::tip
Mod ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
Mod Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

Mod Zen, Mod'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>Mod Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, Mod Zen'i seçin ve API anahtarınızı yapıştırın.
...
Mod yapılandırmanızdaki [model id](/docs/config/#models) `MOD/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `MOD/gpt-5.5` kullanırsınız.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için Mod'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için Mod'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- North Mini Code Free, sınırlı bir süre için Mod'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Ultra Free, sınırlı bir süre için Mod'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için Mod'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
Mod Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca Mod ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
