...
Kullanım geçmişinizde Haiku, Nano veya Flash gibi [düşük maliyetli modeller](/docs/config/#models) görebilirsiniz. MOD, oturum başlıklarını oluşturmak için bu modelleri kullanır.
...
- Hy3 Free, sınırlı bir süre için MOD'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
- Nemotron 3.5 Lightning Free, sınırlı bir süre için MOD'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
- Ox Alpha Free, sınırlı bir süre için MOD'da ücretsiz olan gizli bir modeldir. Sağlayıcısı sıfır saklama politikası uygular ve verilerinizi model eğitimi için kullanmaz.
- Muse Spark 1.2 Contributor Free, sınırlı bir süre için MOD'da kullanılabilir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
