...
description: Model-of-Design Tools, LSP sunucularınızla bütünleşir.
---

Model-of-Design Tools, LLM'in kod tabanınızla etkileşime girmesine yardımcı olmak için Dil Sunucusu Protokolünüzle (LSP) bütünleşir. LLM'ye geri bildirim sağlamak için tanılamayı kullanır.

---

## Yerleşik

Model-of-Design Tools, popüler diller için çeşitli yerleşik LSP sunucularıyla birlikte gelir:
...
:::note
`MOD_DISABLE_LSP_DOWNLOAD` ortam değişkenini `true` olarak ayarlayarak otomatik LSP sunucu indirmelerini devre dışı bırakabilirsiniz.
:::
...
modtools bir dosyayı açtığında:
...
LSP sunucularını, modtools yapılandırmanızdaki `lsp` bölümü aracılığıyla özelleştirebilirsiniz.
