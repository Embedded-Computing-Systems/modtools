---
title: Özel Araçlar
description: LLM'un modtools'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. modtools'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.modtools/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/modtools/tools/` içine yerleştirerek.
