---
title: Özel Araçlar
description: LLM'un MOD'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. MOD'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Veya küresel olarak bunları `~/.config/MOD/tools/` içine yerleştirerek.
