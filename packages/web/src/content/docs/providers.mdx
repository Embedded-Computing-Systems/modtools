...
1. Run the `/connect` command in the TUI, select `OpenCode Zen`, and head to [modtools.ai/auth](https://modtools.ai/zen).
...
1. Run the `/connect` command in the TUI, select `OpenCode Go`, and head to [modtools.ai/auth](https://modtools.ai/zen).
