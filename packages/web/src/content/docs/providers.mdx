...
1. Run the `/connect` command in the TUI, select `Mod Zen`, and head to [modtools.ai/auth](https://modtools.ai/zen).
...
1. Run the `/connect` command in the TUI, select `Mod Go`, and head to [modtools.ai/auth](https://modtools.ai/zen).
...
Helicone's [Sessions](https://docs.helicone.ai/features/sessions) feature lets you group related LLM requests together. Use the [MOD-helicone-session](https://github.com/H2Shami/MOD-helicone-session) plugin to automatically log each Mod conversation as a session in Helicone.
