...
You can also define agents using markdown files in `~/.config/MOD/agents/` or `.mod/agents/`. [Learn more here](/docs/agents).
...
You can also define commands using markdown files in `~/.config/MOD/commands/` or `.mod/commands/`. [Learn more here](/docs/commands).
...
Place plugin files in `.mod/plugins/` or `~/.config/MOD/plugins/`. You can also load plugins from npm through the `plugin` option.
