---
title: TUI
description: Usando a interface de usuário de terminal modtools.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

O modtools fornece uma interface de terminal interativa ou TUI para trabalhar em seus projetos com um LLM.

Executar modtools inicia o TUI para o diretório atual.
...
Ao usar o TUI do modtools, você pode digitar `/` seguido pelo nome de um comando para executar ações rapidamente. Por exemplo:
...
Adicione um provedor ao modtools. Permite que você selecione entre os provedores disponíveis e adicione suas chaves de API.
...
Saia do modtools. _Aliases_: `/quit`, `/q`
...
Isso é separado do `modtools.json`, que configura o comportamento do servidor/runtime.
...
Use `MOD_TUI_CONFIG` para carregar um caminho de configuração TUI personalizado.
