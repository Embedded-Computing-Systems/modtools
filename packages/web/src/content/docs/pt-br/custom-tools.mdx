...
description: Crie ferramentas que o LLM pode chamar no MOD.
---

Ferramentas personalizadas são funções que você cria e que o LLM pode chamar durante as conversas. Elas funcionam junto com as [ferramentas integradas](/docs/tools) do MOD, como `read`, `write` e `bash`.
...
- Ou globalmente, colocando-as em `~/.config/MOD/tools/`.
