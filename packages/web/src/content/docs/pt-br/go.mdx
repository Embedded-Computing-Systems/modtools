...
O Model-of-Design Tools Go é uma assinatura de baixo custo — **US$ 5 no seu primeiro mês**, depois **US$ 10/mês** — que oferece acesso confiável a modelos abertos de programação populares.

:::note
O Model-of-Design Tools Go está atualmente em beta.
:::

O Go funciona como qualquer outro provedor no Model-of-Design Tools. Você assina o Model-of-Design Tools Go e
obtém a sua chave de API. Ele é **totalmente opcional** e você não precisa usá-lo para
usar o Model-of-Design Tools.
...
O Model-of-Design Tools Go lhe dá acesso a esses modelos por **US$ 5 no seu primeiro mês**, depois **US$ 10/mês**.

---

## Como funciona

O Model-of-Design Tools Go funciona como qualquer outro provedor no Model-of-Design Tools.

1. Você entra no **<a href={console}>Model-of-Design Tools Zen</a>**, assina o Go e
   copia a sua chave de API.
2. Você executa o comando `/connect` na TUI, seleciona `Model-of-Design Tools Go` e cola
   a sua chave de API.
3. Execute `/models` na TUI para ver a lista de modelos disponíveis através do Go.

:::note
Apenas um membro por workspace pode assinar o Model-of-Design Tools Go.
:::
...
O Model-of-Design Tools Go inclui os seguintes limites:
...
O [ID do modelo](/docs/config/#models) na sua configuração do Model-of-Design Tools
usa o formato `modtools-go/<model-id>`. Por exemplo, para o Kimi K2.5, você usaria
`modtools-go/kimi-k2.5` na sua configuração.
...
Criamos o Model-of-Design Tools Go para:
...
4. Não ter **nenhuma restrição de fornecedor (lock-in)**, permitindo que você use qualquer outro provedor com o Model-of-Design Tools também.
