...
1. Execute o comando `/connect` no TUI, selecione `OpenCode Zen` e acesse [modtools.ai/zen](https://modtools.ai/zen).
...
1. Execute o comando `/connect` no TUI, selecione `OpenCode Go` e acesse [modtools.ai/zen](https://modtools.ai/zen).
