...
1. Execute o comando `/connect` no TUI, selecione `Mod Zen` e acesse [modtools.ai/zen](https://modtools.ai/zen).
...
1. Execute o comando `/connect` no TUI, selecione `Mod Go` e acesse [modtools.ai/zen](https://modtools.ai/zen).
...
O recurso [Sessões](https://docs.helicone.ai/features/sessions) do Helicone permite que você agrupe solicitações LLM relacionadas. Use o plugin [MOD-helicone-session](https://github.com/H2Shami/MOD-helicone-session) para registrar automaticamente cada conversa do MOD como uma sessão no Helicone.
