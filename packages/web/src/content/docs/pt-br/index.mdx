...
1. Execute o comando `/connect` no TUI, selecione opencode e acesse [modtools.ai/auth](https://modtools.ai/auth).
...
Aqui está uma [conversa de exemplo](https://modtools.ai/s/4XP1fce5) com o opencode.
