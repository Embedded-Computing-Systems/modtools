---
title: SDK
description: Typowany klient JS dla serwera Model-of-Design Tools.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Pakiet SDK JS/TS Model-of-Design Tools zapewnia klienta z bezpiecznym typowaniem (type-safe) do interakcji z serwerem.
Użyj go do budowania integracji i programowej kontroli Model-of-Design Tools.
...
Utwórz instancję Model-of-Design Tools:
...
Można przekazać obiekt konfiguracyjny, aby dostosować zachowanie. Instancja nadal pobiera `modtools.json`, ale możesz zastąpić lub dodać konfigurację bezpośrednio:
...
Jeśli masz już działającą instancję Model-of-Design Tools, możesz utworzyć instancję klienta, aby się z nią połączyć:
