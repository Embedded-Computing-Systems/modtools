...
1. Uruchom polecenie `/connect` w TUI, wybierz `Mod Zen` i przejdź do [modtools.ai/auth](https://modtools.ai/zen).
...
1. Uruchom polecenie `/connect` w TUI, wybierz `Mod Go` i przejdź do [modtools.ai/auth](https://modtools.ai/zen).
...
Funkcja [Sesje](https://docs.helicone.ai/features/sessions) firmy Helicone umożliwia grupowanie powiązanych żądań LLM. Użyj wtyczki [MOD-helicone-session](https://github.com/H2Shami/MOD-helicone-session), aby automatycznie rejestrować każdą konwersację MOD jako sesję w Helicone.
