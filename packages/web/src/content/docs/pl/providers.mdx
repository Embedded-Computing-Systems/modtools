...
1. Uruchom polecenie `/connect` w TUI, wybierz `OpenCode Zen` i przejdź do [modtools.ai/auth](https://modtools.ai/zen).
...
1. Uruchom polecenie `/connect` w TUI, wybierz `OpenCode Go` i przejdź do [modtools.ai/auth](https://modtools.ai/zen).
