...
Model-of-Design Tools Go to niskokosztowa subskrypcja — **5 $ za pierwszy miesiąc**, a następnie **10 $/miesiąc** — która zapewnia niezawodny dostęp do popularnych otwartych modeli do kodowania.

:::note
Model-of-Design Tools Go jest obecnie w fazie beta.
:::

Go działa jak każdy inny dostawca w Model-of-Design Tools. Subskrybujesz Model-of-Design Tools Go i
otrzymujesz swój klucz API. Jest to **całkowicie opcjonalne** i nie musisz z tego korzystać, aby
używać Model-of-Design Tools.
...
Model-of-Design Tools Go daje Ci dostęp do tych modeli za **5 $ za pierwszy miesiąc**, a następnie **10 $/miesiąc**.

---

## Jak to działa

Model-of-Design Tools Go działa jak każdy inny dostawca w Model-of-Design Tools.

1. Logujesz się do **<a href={console}>Model-of-Design Tools Zen</a>**, subskrybujesz Go i
   kopiujesz swój klucz API.
2. Uruchamiasz komendę `/connect` w TUI, wybierasz `Model-of-Design Tools Go` i wklejasz
   swój klucz API.
3. Uruchom `/models` w TUI, aby zobaczyć listę modeli dostępnych w ramach Go.

:::note
Tylko jeden członek na obszar roboczy (workspace) może zasubskrybować Model-of-Design Tools Go.
:::
...
Model-of-Design Tools Go zawiera następujące limity:
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji Model-of-Design Tools
używa formatu `modtools-go/<model-id>`. Na przykład dla Kimi K2.5 należy użyć
`modtools-go/kimi-k2.5` w swojej konfiguracji.
...
Stworzyliśmy Model-of-Design Tools Go, aby:
...
4. Zapewnić **brak ograniczeń (no lock-in)**, pozwalając na korzystanie z dowolnego innego dostawcy wraz z Model-of-Design Tools.
