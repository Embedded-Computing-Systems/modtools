---
title: Formatery
description: Model-of-Design Tools używa formaterów specyficznych dla języka.
---

Model-of-Design Tools automatycznie formatuje pliki po ich zapisaniu lub edycji przy użyciu formaterów specyficznych dla języka. Zapewnia to, że wygenerowany kod jest zgodny ze stylem kodu Twojego projektu.

---

## Wbudowane

Model-of-Design Tools zawiera kilka wbudowanych formaterów dla popularnych języków i frameworków. Poniższa tabela zawiera listę formaterów, obsługiwanych plików oraz wymagań konfiguracyjnych.
...
Jeśli więc Twój projekt zawiera `prettier` w `package.json`, Model-of-Design Tools automatycznie go użyje.

---

## Jak to działa

Kiedy Model-of-Design Tools zapisuje lub edytuje plik:
...
Możesz dostosować formatery za pomocą sekcji `formatter` w konfiguracji Model-of-Design Tools.
