...
Utwórz `.modtools/commands/test.md`:
...
Możesz zdefiniować polecenia w `modtools.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji modtools:
...
- Globalnie: `~/.config/modtools/commands/`
- Na projekt: `.modtools/commands/`
...
modtools zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
