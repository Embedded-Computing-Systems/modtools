...
1. Uruchom polecenie `/connect` w TUI, wybierz opencode i przejdź do [modtools.ai/auth](https://modtools.ai/auth).
...
Oto [przykładowa rozmowa](https://modtools.ai/s/4XP1fce5) z opencode.
