---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala modtools.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

modtools zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie modtools uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI modtools, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do modtools. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij modtools. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `modtools.json`, który konfiguruje zachowanie serwera/runtime.
...
Użyj `MOD_TUI_CONFIG`, aby załadować niestandardową ścieżkę konfiguracji TUI.
