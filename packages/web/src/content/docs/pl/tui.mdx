---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala MOD.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

MOD zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie MOD uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI MOD, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do MOD. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Jest to oddzielny plik od `MOD.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo Mod czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `MOD.default`.
