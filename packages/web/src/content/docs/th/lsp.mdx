...
description: Model-of-Design Tools ทำงานร่วมกับเซิร์ฟเวอร์ LSP ของคุณ
---

Model-of-Design Tools ทำงานร่วมกับ Language Server Protocol (LSP) เพื่อช่วยให้ LLM โต้ตอบกับโค้ดเบสของคุณ ใช้การวินิจฉัยเพื่อให้ข้อเสนอแนะไปยัง LLM

---

## บิวท์อิน

Model-of-Design Tools มาพร้อมกับเซิร์ฟเวอร์ LSP ในตัวหลายตัวสำหรับภาษายอดนิยม:
...
:::note
คุณสามารถปิดใช้งานการดาวน์โหลดเซิร์ฟเวอร์ LSP อัตโนมัติได้โดยตั้งค่าตัวแปรสภาพแวดล้อม `MOD_DISABLE_LSP_DOWNLOAD` เป็น `true`
:::
