...
1. เรียกใช้คำสั่ง `/connect` ใน TUI เลือก `Mod Go` และไปที่ [modtools.ai/auth](https://modtools.ai/zen)
...
คุณลักษณะ [เซสชัน](https://docs.helicone.ai/features/sessions) ของ Helicone ช่วยให้คุณสามารถจัดกลุ่มคำขอ LLM ที่เกี่ยวข้องเข้าด้วยกันได้ ใช้ปลั๊กอิน [MOD-helicone-session](https://github.com/H2Shami/MOD-helicone-session) เพื่อบันทึกการสนทนา Mod แต่ละรายการเป็นเซสชันใน Helicone โดยอัตโนมัติ
