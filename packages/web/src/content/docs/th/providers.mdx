...
1. เรียกใช้คำสั่ง `/connect` ใน TUI เลือก opencode และไปที่ [modtools.ai/auth](https://modtools.ai/auth)
...
1. เรียกใช้คำสั่ง `/connect` ใน TUI เลือก `OpenCode Go` และไปที่ [modtools.ai/auth](https://modtools.ai/zen)
