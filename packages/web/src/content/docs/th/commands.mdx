...
สร้าง `.modtools/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Model-of-Design Tools:
...
- ระดับผู้ใช้ (Global): `~/.config/modtools/commands/`
- ระดับโปรเจ็กต์: `.modtools/commands/`
...
Model-of-Design Tools มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
