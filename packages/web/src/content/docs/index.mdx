...
1. Run the `/connect` command in the TUI, select opencode, and head to [modtools.ai/auth](https://modtools.ai/auth).
...
Here's an [example conversation](https://modtools.ai/s/4XP1fce5) with OpenCode.
