...
1. Ejecute el comando `/connect` en la TUI, seleccione opencode y diríjase a [modtools.ai/auth](https://modtools.ai/auth).
...
Aquí tiene una [conversación de ejemplo](https://modtools.ai/s/4XP1fce5) con OpenCode.
