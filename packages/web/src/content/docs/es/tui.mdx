---
title: TUI
description: Usando la interfaz de usuario del terminal Model-of-Design Tools.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Model-of-Design Tools proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar Model-of-Design Tools se inicia TUI para el directorio actual.
...
Cuando utilice Model-of-Design Tools TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a Model-of-Design Tools. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de Model-of-Design Tools. _Alias_: `/quit`, `/q`
...
Esto es independiente de `modtools.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
Utilice `MOD_TUI_CONFIG` para cargar una ruta de configuración de TUI personalizada.
