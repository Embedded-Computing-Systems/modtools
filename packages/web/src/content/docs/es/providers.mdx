...
1. Ejecute el comando `/connect` en TUI, seleccione opencode y diríjase a [modtools.ai/auth](https://modtools.ai/auth).
...
1. Ejecute el comando `/connect` en TUI, seleccione `OpenCode Go` y diríjase a [modtools.ai/auth](https://modtools.ai/zen).
