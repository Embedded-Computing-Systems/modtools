...
1. Ejecute el comando `/connect` en TUI, seleccione `MOD Go` y diríjase a [modtools.ai/auth](https://opencode.ai/zen).
...
Más documentación en la página de inicio de [MOD-gitlab-auth](https://www.npmjs.com/package/MOD-gitlab-auth).
...
La función [Sesiones](https://docs.helicone.ai/features/sessions) de Helicone le permite agrupar solicitudes LLM relacionadas. Utilice el complemento [MOD-helicone-session](https://github.com/Embedded-Computing-Systems/modtools-helicone-session) para registrar automáticamente cada conversación MOD como una sesión en Helicone.
