...
Los proveedores más populares están precargados de forma predeterminada. Si agregó las credenciales de un proveedor mediante el comando `/connect`, estarán disponibles cuando inicie Model-of-Design Tools.
...
Aqui tienes varios modelos que funcionan bien con Model-of-Design Tools, sin orden particular. (Esta no es una lista exhaustiva ni necesariamente actualizada):
...
configuracion de Model-of-Design Tools.
...
Aquí el ID completo es `provider_id/model_id`. Por ejemplo, si usa [Model-of-Design Tools Zen](/docs/zen), usaría `modtools/gpt-5.1-codex` para GPT 5.1 Codex.
...
Muchos modelos admiten múltiples variantes con diferentes configuraciones. Model-of-Design Tools se envía con variantes predeterminadas integradas para proveedores populares.

### Variantes integradas

Model-of-Design Tools se envía con variantes predeterminadas para muchos proveedores:
...
Cuando se inicia Model-of-Design Tools, busca modelos en el siguiente orden de prioridad:
...
2. La lista de modelos en la configuración Model-of-Design Tools.
