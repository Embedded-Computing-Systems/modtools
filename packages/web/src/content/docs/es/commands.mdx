...
Puede agregar comandos personalizados a través de la configuración Mod o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Mod [config](/docs/config):
...
MOD incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
