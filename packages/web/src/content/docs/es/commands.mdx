...
Crear `.modtools/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración Model-of-Design Tools o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Model-of-Design Tools [config](/docs/config):
...
- Por proyecto: `.modtools/commands/`
...
modtools incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
