---
title: Compartir
description: Comparte tus conversaciones Model-of-Design Tools.
---

La función para compartir de Model-of-Design Tools te permite crear enlaces públicos a tus conversaciones de Model-of-Design Tools, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, Model-of-Design Tools:
...
Model-of-Design Tools admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, Model-of-Design Tools usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
...
Para aplicar esto en todo su equipo para un proyecto determinado, agréguelo al `modtools.json` en su proyecto y regístrelo en Git.
...
[Obtenga más información](/docs/enterprise) sobre el uso de modtools en su organización.
