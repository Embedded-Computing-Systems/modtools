...
Hay dos tipos de agentes en Model-of-Design Tools; agentes primarios y subagentes.
...
Model-of-Design Tools viene con dos agentes principales integrados, **Build** y **Plan**. Bien
...
Model-of-Design Tools viene con dos subagentes integrados, **General** y **Explore**. Veremos esto a continuación.

---

## Integrados

Model-of-Design Tools viene con dos agentes primarios integrados y dos subagentes integrados.
...
Configure agentes en su archivo de configuración `modtools.json`:
...
Si no se especifica ninguna temperatura, Model-of-Design Tools utiliza valores predeterminados específicos del modelo; normalmente 0 para la mayoría de los modelos, 0,55 para los modelos Qwen.
...
Esta ruta es relativa a donde se encuentra el archivo de configuración. Entonces esto funciona tanto para la configuración global Model-of-Design Tools como para la configuración específica del proyecto.
...
El ID del modelo en su configuración Model-of-Design Tools usa el formato `provider/model-id`. Por ejemplo, si usa [Model-of-Design Tools Zen](/docs/zen), usaría `modtools/gpt-5.1-codex` para GPT 5.1 Codex.
...
:::tip
Ejecute `modtools models` para ver una lista de los modelos disponibles.
:::
...
:::tip
¿Tiene un agente que le gustaría compartir? [Enviar un PR](https://github.com/Embedded-Computing-Systems/modtools).
:::
