...
- `.mod/plugins/` - Complementos a nivel de proyecto
...
4. Directorio de complementos del proyecto (`.mod/plugins/`)
...
```ts title=".mod/plugins/my-plugin.ts"
...
```js title=".mod/plugins/example.js"
...
```js title=".mod/plugins/notification.js"
...
```javascript title=".mod/plugins/env-protection.js"
...
```javascript title=".mod/plugins/inject-env.js"
...
```ts title=".mod/plugins/custom-tools.ts"
...
```ts title=".mod/plugins/compaction.ts"
import type { Plugin } from "@modtools-ai/plugin"
...
```ts title=".mod/plugins/custom-compaction.ts"
import type { Plugin } from "@modtools-ai/plugin"
