...
Con Mod puede seleccionar uno de varios temas integrados, usar un tema que se adapte al tema de su terminal o definir su propio tema personalizado.

De forma predeterminada, Mod usa nuestro propio tema `MOD`.
...
Mod viene con varios temas integrados.
...
- Quiere que Mod coincida con la apariencia de su terminal
...
Mod admite un sistema de temas flexible basado en JSON que permite a los usuarios crear y personalizar temas fácilmente.
...
2. **Directorio de configuración de usuario**: definido en `~/.config/MOD/themes/*.json` o `$XDG_CONFIG_HOME/MOD/themes/*.json`
