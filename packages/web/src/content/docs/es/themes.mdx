...
Con Model-of-Design Tools puede seleccionar uno de varios temas integrados, usar un tema que se adapte al tema de su terminal o definir su propio tema personalizado.

De forma predeterminada, Model-of-Design Tools usa nuestro propio tema `modtools`.
...
Model-of-Design Tools viene con varios temas integrados.
...
- Quiere que Model-of-Design Tools coincida con la apariencia de su terminal
...
Model-of-Design Tools admite un sistema de temas flexible basado en JSON que permite a los usuarios crear y personalizar temas fácilmente.
...
2. **Directorio de configuración de usuario**: definido en `~/.config/modtools/themes/*.json` o `$XDG_CONFIG_HOME/modtools/themes/*.json`
3. **Directorio raíz del proyecto**: definido en `<project-root>/.modtools/themes/*.json`
4. **Directorio de trabajo actual** - Definido en `./.modtools/themes/*.json`
