...
Las habilidades del agente permiten a Model-of-Design Tools descubrir instrucciones reutilizables de su repositorio o directorio de inicio.
...
Model-of-Design Tools busca estas ubicaciones:

- Configuración del proyecto: `.modtools/skills/<name>/SKILL.md`
- Configuración global: `~/.config/modtools/skills/<name>/SKILL.md`
...
Para las rutas locales del proyecto, Model-of-Design Tools sube desde su directorio de trabajo actual hasta llegar al árbol de trabajo de git.
Carga cualquier `skills/*/SKILL.md` coincidente en `.modtools/` y cualquier `.claude/skills/*/SKILL.md` o `.agents/skills/*/SKILL.md` coincidente a lo largo del camino.

Las definiciones globales también se cargan desde `~/.config/modtools/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` y `~/.agents/skills/*/SKILL.md`.
...
Crea `.modtools/skills/git-release/SKILL.md` así:
...
Model-of-Design Tools enumera las habilidades disponibles en la descripción de la herramienta `skill`.
...
Controle a qué agentes de habilidades pueden acceder utilizando permisos basados ​​en patrones en `modtools.json`:
...
**Para agentes integrados** (en `modtools.json`):
