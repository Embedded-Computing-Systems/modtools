...
Model-of-Design Tools admite variables de entorno de proxy estándar y certificados personalizados para entornos de red empresarial.

---

## Proxy

Model-of-Design Tools respeta las variables de entorno de proxy estándar.
...
Si su empresa utiliza CA personalizadas para conexiones HTTPS, configure Model-of-Design Tools para confiar en ellas.
