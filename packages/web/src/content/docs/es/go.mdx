...
Model-of-Design Tools Go es una suscripción de bajo costo — **$5 por tu primer mes**, luego **$10/mes** — que te brinda acceso confiable a modelos abiertos de programación populares.

:::note
Model-of-Design Tools Go está actualmente en beta.
:::

Go funciona como cualquier otro proveedor en Model-of-Design Tools. Te suscribes a Model-of-Design Tools Go y
obtienes tu API key. Es **completamente opcional** y no necesitas usarlo para
usar Model-of-Design Tools.
...
Model-of-Design Tools Go te da acceso a estos modelos por **$5 por tu primer mes**, luego **$10/mes**.

---

## Cómo funciona

Model-of-Design Tools Go funciona como cualquier otro proveedor en Model-of-Design Tools.

1. Inicias sesión en **<a href={console}>Model-of-Design Tools Zen</a>**, te suscribes a Go y
   copias tu API key.
2. Ejecutas el comando `/connect` en la TUI, seleccionas `Model-of-Design Tools Go` y pegas
   tu API key.
3. Ejecutas `/models` en la TUI para ver la lista de modelos disponibles a través de Go.

:::note
Solo un miembro por espacio de trabajo puede suscribirse a Model-of-Design Tools Go.
:::
...
Model-of-Design Tools Go incluye los siguientes límites:
...
El [ID del modelo](/docs/config/#models) en tu configuración de Model-of-Design Tools
usa el formato `modtools-go/<model-id>`. Por ejemplo, para Kimi K2.5, usarías
`modtools-go/kimi-k2.5` en tu configuración.
...
Creamos Model-of-Design Tools Go para:
...
4. Evitar la **dependencia (lock-in)** al permitirte usar también cualquier otro proveedor con Model-of-Design Tools.
