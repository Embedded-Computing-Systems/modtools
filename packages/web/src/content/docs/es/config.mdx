...
También puede definir agentes utilizando archivos de Markdown en `~/.config/MOD/agents/` o `.mod/agents/`. [Más información aquí](/docs/agents).
...
También puede definir comandos utilizando archivos de Markdown en `~/.config/MOD/commands/` o `.mod/commands/`. [Más información aquí](/docs/commands).
...
Coloque los archivos de complemento en `.mod/plugins/` o `~/.config/MOD/plugins/`. También puedes cargar complementos desde npm a través de la opción `plugin`.
