...
Agent skills omogucavaju Mod da pronade uputstva koja se mogu ponovo koristiti iz repozitorija ili home direktorija.
...
Mod pretrazuje ove lokacije:

- Konfiguracija projekta: `.modtools/skills/<name>/SKILL.md`
- Globalna konfiguracija: `~/.config/MOD/skills/<name>/SKILL.md`
...
Za projektne lokalne putanje, Mod ide prema gore od trenutnog radnog direktorija dok ne dode do git worktree-ja.
...
Globalne definicije se takoder ucitavaju iz `~/.config/MOD/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` i `~/.agents/skills/*/SKILL.md`.
...
Mod navodi dostupne skills u opisu `skill` alata.
...
Kontrolisite kojim skills agenti mogu pristupiti pomocu dozvola baziranih na obrascima u `MOD.json`:
