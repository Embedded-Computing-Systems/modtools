...
Kreiraj `.modtools/commands/test.md`:
...
Možete dodati prilagođene komande kroz Model-of-Design Tools konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Model-of-Design Tools [config](/docs/config):
...
- Globalno: `~/.config/modtools/commands/`
- Po projektu: `.modtools/commands/`
...
Model-of-Design Tools uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
