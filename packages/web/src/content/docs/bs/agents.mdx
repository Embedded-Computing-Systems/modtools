...
Postoje dvije vrste agenata u Model-of-Design Tools: primarni agenti i podagenti.
...
Model-of-Design Tools dolazi sa dva ugrađena primarna agenta, **Build** i **Plan**. Pogledat ćemo ih u nastavku.
...
Model-of-Design Tools dolazi sa dva ugrađena subagenta, **General** i **Explore**. Ovo ćemo pogledati u nastavku.

---

## Ugrađeni

Model-of-Design Tools dolazi sa dva ugrađena primarna agenta i dva ugrađena subagenta.
...
Konfigurirajte agente u svom konfiguracijskom fajlu `modtools.json`:
...
- Globalno: `~/.config/modtools/agents/`
...
Ako temperatura nije navedena, Model-of-Design Tools koristi standardne postavke specifične za model; obično 0 za većinu modela, 0.55 za Qwen modele.
...
Ova putanja je relativna u odnosu na mjesto gdje se nalazi konfiguracijski fajl. Dakle, ovo radi i za globalnu Model-of-Design Tools konfiguraciju i za konfiguraciju specifične za projekat.
...
ID modela u vašoj Model-of-Design Tools konfiguraciji koristi format `provider/model-id`. Na primjer, ako koristite [Model-of-Design Tools Zen](/docs/zen), koristili biste `modtools/gpt-5.1-codex` za GPT 5.1 Codex.
...
:::tip
Pokrenite `modtools models` da vidite listu dostupnih modela.
:::
