...
Također možete definirati agente koristeći markdown datoteke u `~/.config/MOD/agents/` ili `.mod/agents/`. [Saznajte više ovdje](/docs/agents).
...
Također možete definirati naredbe koristeći markdown fajlove u `~/.config/MOD/commands/` ili `.mod/commands/`. [Saznajte više ovdje](/docs/commands).
...
Postavite datoteke dodataka u `.mod/plugins/` ili `~/.config/MOD/plugins/`. Također možete učitati dodatke iz npm-a preko opcije `plugin`.
