---
title: TUI
description: Korištenje korisničkog interfejsa MOD terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

MOD pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje MOD pokreće TUI za trenutni direktorij.
...
Kada koristite MOD TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u MOD. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz MOD. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `MOD.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo MOD čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `MOD.default`.
