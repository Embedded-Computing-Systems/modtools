---
title: TUI
description: Korištenje korisničkog interfejsa Model-of-Design Tools terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Model-of-Design Tools pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Model-of-Design Tools pokreće TUI za trenutni direktorij.
...
Kada koristite Model-of-Design Tools TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Model-of-Design Tools. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Model-of-Design Tools. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `modtools.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
Koristite `MOD_TUI_CONFIG` da učitate prilagođenu putanju TUI konfiguracije.
