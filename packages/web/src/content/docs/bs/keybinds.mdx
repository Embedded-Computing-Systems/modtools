...
Model-of-Design Tools ima listu veza tipki koje možete prilagoditi putem `tui.json`.
...
Model-of-Design Tools koristi `leader` (vodeću) tipku za većinu povezivanja tipki. Ovo izbjegava sukobe u vašem terminalu.
...
Unos prompta aplikacije Model-of-Design Tools za desktop podržava uobičajene prečice u stilu Readline/Emacs za uređivanje teksta. One su ugrađene i trenutno se ne mogu konfigurirati putem `modtools.json`.
