...
Model-of-Design Tools Go je povoljna pretplata — **$5 za vaš prvi mjesec**, a zatim **$10/mjesečno** — koja vam pruža pouzdan pristup popularnim otvorenim modelima za programiranje.

:::note
Model-of-Design Tools Go je trenutno u beta fazi.
:::

Go radi kao bilo koji drugi provajder u Model-of-Design Tools-u. Pretplatite se na Model-of-Design Tools Go i
dobijete svoj API ključ. On je **potpuno opcionalan** i ne morate ga koristiti da
biste koristili Model-of-Design Tools.
...
:::tip
Testirali smo odabranu grupu modela i provajdera koji dobro rade sa Model-of-Design Tools-om.
:::
...
Model-of-Design Tools Go vam daje pristup ovim modelima za **$5 za vaš prvi mjesec**, a zatim **$10/mjesečno**.

---

## Kako funkcioniše

Model-of-Design Tools Go radi kao bilo koji drugi provajder u Model-of-Design Tools-u.

1. Prijavite se na **<a href={console}>Model-of-Design Tools Zen</a>**, pretplatite se na Go i
   kopirajte svoj API ključ.
2. Pokrenite komandu `/connect` u TUI-ju, odaberite `Model-of-Design Tools Go` i zalijepite
   svoj API ključ.
3. Pokrenite `/models` u TUI-ju da vidite listu modela dostupnih kroz Go.

:::note
Samo jedan član po radnom prostoru (workspace) može se pretplatiti na Model-of-Design Tools Go.
:::
...
Model-of-Design Tools Go uključuje sljedeća ograničenja:
...
[Model id](/docs/config/#models) u vašoj Model-of-Design Tools konfiguraciji
koristi format `modtools-go/<model-id>`. Na primjer, za Kimi K2.5, koristili biste
`modtools-go/kimi-k2.5` u svojoj konfiguraciji.
...
Napravili smo Model-of-Design Tools Go da bismo:
...
4. Osigurali da **nema zaključavanja (no lock-in)**, omogućavajući vam da uz Model-of-Design Tools koristite i bilo kojeg drugog provajdera.
