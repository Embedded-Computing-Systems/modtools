---
title: Dijeljenje
description: Dijelite Model-of-Design Tools razgovore javnim linkovima.
---

Model-of-Design Tools opcija dijeljenja vam omogucava da kreirate javne linkove za razgovore. Tako lakse saradujete s timom ili trazite pomoc od drugih.
...
Kada podijelite razgovor, Model-of-Design Tools:
...
Model-of-Design Tools podrzava tri nacina dijeljenja koji odreduju kako se razgovori dijele:

---

### Ručno (zadano)

Po defaultu, Model-of-Design Tools koristi rucni nacin dijeljenja. Sesije se ne dijele automatski, ali ih mozete rucno podijeliti komandom `/share`:
...
Da ovo vazi za cijeli tim u odredenom projektu, dodajte postavku u projektni `modtools.json` i commitujte u Git.
...
[Saznajte vise](/docs/enterprise) o koristenju modtools u organizaciji.
