---
title: Formateri
description: Model-of-Design Tools koristi formatere specifične za jezik.
---

Model-of-Design Tools automatski formatira datoteke nakon što su napisane ili uređene pomoću formatera specifičnih za jezik. Ovo osigurava da kod koji se generira prati stilove koda vašeg projekta.

---

## Ugrađeni

Model-of-Design Tools dolazi sa nekoliko ugrađenih formatera za popularne jezike i okvire. Ispod je lista formatera, podržanih ekstenzija datoteka i naredbi ili opcija konfiguracije koje su mu potrebne.
...
Dakle, ako vaš projekat ima `prettier` u vašem `package.json`, Model-of-Design Tools će ga automatski koristiti.

---

## Kako radi

Kada Model-of-Design Tools piše ili uređuje datoteku, on:
...
Možete prilagoditi formatere kroz `formatter` odjeljak u vašoj Model-of-Design Tools konfiguraciji.
