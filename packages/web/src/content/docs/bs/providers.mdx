...
1. Pokrenite naredbu `/connect` u TUI-u, odaberite `Mod Go` i idite na [modtools.ai/auth](https://modtools.ai/zen).
...
Heliconeova funkcija [Sessions](https://docs.helicone.ai/features/sessions) vam omogućava da grupišete povezane LLM zahtjeve zajedno. Koristite dodatak [MOD-helicone-session](https://github.com/H2Shami/MOD-helicone-session) da automatski prijavite svaki Mod razgovor kao sesiju u Helicone-u.
