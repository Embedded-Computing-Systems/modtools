...
1. Pokrenite naredbu `/connect` u TUI-u, odaberite opencode i idite na [modtools.ai/auth](https://modtools.ai/auth).
...
1. Pokrenite naredbu `/connect` u TUI-u, odaberite `OpenCode Go` i idite na [modtools.ai/auth](https://modtools.ai/zen).
