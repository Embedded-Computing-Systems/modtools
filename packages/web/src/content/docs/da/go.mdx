...
Model-of-Design Tools Go er et lavprisabonnement — **$5 for din første måned**, derefter **$10/måned** — der giver dig pålidelig adgang til populære åbne kodningsmodeller.

:::note
Model-of-Design Tools Go er i øjeblikket i beta.
:::

Go fungerer som enhver anden udbyder i Model-of-Design Tools. Du abonnerer på Model-of-Design Tools Go og
får din API-nøgle. Det er **helt valgfrit**, og du behøver ikke at bruge det for at
bruge Model-of-Design Tools.
...
:::tip
Vi testede en udvalgt gruppe af modeller og udbydere, der fungerer godt med Model-of-Design Tools.
:::
...
Model-of-Design Tools Go giver dig adgang til disse modeller for **$5 for din første måned**, derefter **$10/måned**.

---

## Sådan fungerer det

Model-of-Design Tools Go fungerer som enhver anden udbyder i Model-of-Design Tools.

1. Du logger ind på **<a href={console}>Model-of-Design Tools Zen</a>**, abonnerer på Go, og
   kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI'en, vælger `Model-of-Design Tools Go`, og indsætter
   din API-nøgle.
3. Kør `/models` i TUI'en for at se listen over tilgængelige modeller gennem Go.

:::note
Kun ét medlem per arbejdsområde kan abonnere på Model-of-Design Tools Go.
:::
...
Model-of-Design Tools Go inkluderer følgende grænser:
...
Dit [model id](/docs/config/#models) i din Model-of-Design Tools config
bruger formatet `modtools-go/<model-id>`. For eksempel for Kimi K2.5, vil du
bruge `modtools-go/kimi-k2.5` i din config.
...
Vi skabte Model-of-Design Tools Go for at:
...
4. Undgå **lock-in** ved også at lade dig bruge enhver anden udbyder med Model-of-Design Tools.
