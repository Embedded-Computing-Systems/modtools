...
Du vil måske bemærke [lavprismodeller](/docs/config/#models), såsom Haiku, Nano eller Flash, i din brugshistorik. MOD bruger disse modeller til at generere sessionstitler.
...
- Hy3 Free er tilgængelig på MOD i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
...
- Nemotron 3.5 Lightning Free er tilgængelig på MOD i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
...
- Ox Alpha Free er en stealth-model, som er gratis på MOD i en begrænset periode. Udbyderen følger en nul-opbevaringspolitik og bruger ikke dine data til at træne modeller.
- Muse Spark 1.2 Contributor Free er tilgængelig på MOD i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
