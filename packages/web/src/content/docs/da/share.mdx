---
title: Deling
description: Del dine Model-of-Design Tools-samtaler.
---

Model-of-Design Toolss delingsfunksjon lar deg lage offentlige lenker til dine Model-of-Design Tools-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Når du deler en samtale, Model-of-Design Tools:
...
Model-of-Design Tools støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuel (standard)

Som standard bruger Model-of-Design Tools manuell delingsmodus. Sessioner deles ikke automatisk, men du kan dele dem manuelt ved at bruge kommandoen `/share`:
...
For at håndheve dette på tvers av teamet ditt for et gitt prosjekt, tilføj det til `modtools.json` i prosjektet ditt og tjek inn i Git.
...
[Finn ut mer](/docs/enterprise) om brug av modtools i organisasjonen din.
