---
title: TUI
description: Brug af Model-of-Design Tools-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Model-of-Design Tools giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre Model-of-Design Tools starter TUI for den nuværende mappe.
...
Når du bruger Model-of-Design Tools TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til Model-of-Design Tools. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut Model-of-Design Tools. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `modtools.json`, som konfigurerer server-/kørselstidsadfærd.
...
Brug `MOD_TUI_CONFIG` til at indlæse en brugerdefineret TUI-konfigurationssti.
