---
title: TUI
description: Brug af MOD-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

MOD giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre MOD starter TUI for den nuværende mappe.
...
Når du bruger MOD TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til MOD. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Dette er adskilt fra `MOD.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe MOD venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `MOD.default`.
