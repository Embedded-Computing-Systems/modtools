...
Her er alle de innebygde verktøyene som er tilgængelige i Model-of-Design Tools.
...
:::note
Dette verktøyet er bare tilgængelig når `MOD_EXPERIMENTAL_LSP_TOOL=true` (eller `MOD_EXPERIMENTAL=true`).
:::
...
:::note
Dette verktøyet er bare tilgængelig når du bruger Model-of-Design Tools-leverandøren eller når miljøvariabelen `MOD_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).
