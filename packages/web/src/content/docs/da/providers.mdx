...
1. Kør kommandoen `/connect` i TUI, vælg `Mod Go`, og gå til [modtools.ai/auth](https://modtools.ai/zen).
...
Helicones [Sessions](https://docs.helicone.ai/features/sessions) funktion lader dig gruppe relaterede LLM anmodninger sammen. Brug [MOD-helicone-session](https://github.com/H2Shami/MOD-helicone-session) plugin for automatisk at logge hver Mod-samtale som en session i Helicone.
