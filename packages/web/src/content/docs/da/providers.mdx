...
1. Kør kommandoen `/connect` i TUI, vælg opencode og gå til [modtools.ai/auth](https://modtools.ai/auth).
...
1. Kør kommandoen `/connect` i TUI, vælg `OpenCode Go`, og gå til [modtools.ai/auth](https://modtools.ai/zen).
