...
- Prosjektkonfigurasjon: `.mod/skills/<name>/SKILL.md`
...
Den laster alle matchende `skills/*/SKILL.md` i `.mod/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.
...
Lag `.mod/skills/git-release/SKILL.md` slik:
