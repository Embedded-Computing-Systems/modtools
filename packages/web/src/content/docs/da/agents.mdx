...
Der er to typer agenter i Model-of-Design Tools; primære agenter og subagenter.
...
Model-of-Design Tools leveres med indbyggede primære agenter, **Build** og **Plan**. Vi vil
...
Model-of-Design Tools leveres med to indbyggede underagenter, **Generelt** og **Udforsk**. Vi vil se på dette nedenfor.

---

## Indbyggede

Model-of-Design Tools leveres med to indbyggede primære agenter og to indbyggede subagenter.
...
Konfigurer agent i din `modtools.json`-konfigurationsfil:
...
Hvis ingen temperatur er angivet, bruger Model-of-Design Tools modelspecifikke standardindstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne sti er i forhold til, hvor konfigurationsfilen er placeret. Så dette virker både for den globale Model-of-Design Tools-konfiguration og den projektspecifikke konfiguration.
...
Model-id'et i din Model-of-Design Tools-konfiguration brugerformatet `provider/model-id`. For eksempel, hvis du bruger [Model-of-Design Tools Zen](/docs/zen), vil du bruge `modtools/gpt-5.1-codex` til GPT 5.1 Codex.
...
:::tip
Kør `modtools models` for at se en liste over de tilgængelige modeller.
:::
