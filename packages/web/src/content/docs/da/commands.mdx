...
Opret `.modtools/commands/test.md`:
...
Du kan tilføje brugerdefinerede kommandoer gennem Model-of-Design Tools-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din Model-of-Design Tools [config](/docs/config):
...
modtools indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
