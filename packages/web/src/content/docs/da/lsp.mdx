---
title: LSP-servere
description: MOD integreres med dine LSP-servere.
---

MOD kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

MOD leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `MODTOOLS_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og MOD åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din MOD-konfiguration.
