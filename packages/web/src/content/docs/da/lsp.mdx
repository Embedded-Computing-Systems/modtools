---
title: LSP-servere
description: Model-of-Design Tools integreres med dine LSP-servere.
---

Model-of-Design Tools integreres med Language Server Protocol (LSP) for at hjælpe LLM med at interagere med din kodebase. Den bruger diagnostik til at give feedback til LLM.

---

## Indbyggede

Model-of-Design Tools leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `MOD_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når modtools åbner en fil, vil den:
...
Du kan tilpasse LSP-servere gennem sektionen `lsp` i din modtools-konfiguration.
