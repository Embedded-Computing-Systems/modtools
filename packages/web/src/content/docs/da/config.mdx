...
Du kan også definere agenter ved at bruge markdown-filer i `~/.config/MOD/agents/` eller `.mod/agents/`. [Learn more here](/docs/agents).
...
Du kan også definere kommandoer ved hjælp af markdown-filer i `~/.config/MOD/commands/` eller `.mod/commands/`. [Learn more here](/docs/commands).
...
Placer plugin-filer i `.mod/plugins/` eller `~/.config/MOD/plugins/`. Du kan også indlæse plugins fra npm gennem indstillingen `plugin`.
