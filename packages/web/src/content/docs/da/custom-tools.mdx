...
description: Opret værktøjer, som LLM kan kalde MOD ind.
---

Brugerdefinerede værktøjer er funktioner, du opretter, som LLM kan kalde under samtaler. De arbejder sammen med MODs [built-in tools](/docs/tools) som `read`, `write` og `bash`.
...
- Eller globalt ved at placere dem i `~/.config/MOD/tools/`.
