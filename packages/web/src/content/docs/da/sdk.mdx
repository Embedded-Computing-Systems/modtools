...
Brug den til at bygge integrasjoner og kontrollere modtools programmatisk.
...
Opret en forekomst av modtools:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `modtools.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av modtools, kan du oprete en klientforekomst for at koble til den:
