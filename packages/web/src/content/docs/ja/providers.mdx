...
1. TUI で `/connect` コマンドを実行し、`OpenCode Zen` を選択して、[modtools.ai/zen](https://modtools.ai/zen) にアクセスします。
...
1. TUI で `/connect` コマンドを実行し、`OpenCode Go` を選択して、[modtools.ai/zen](https://modtools.ai/zen) にアクセスします。
