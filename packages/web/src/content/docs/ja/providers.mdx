...
1. TUI で `/connect` コマンドを実行し、`Mod Zen` を選択して、[modtools.ai/zen](https://modtools.ai/zen) にアクセスします。
...
1. TUI で `/connect` コマンドを実行し、`Mod Go` を選択して、[modtools.ai/zen](https://modtools.ai/zen) にアクセスします。
...
Helicone の [Sessions](https://docs.helicone.ai/features/sessions) 機能を使用すると、関連する LLM リクエストをグループ化できます。 [MOD-helicone-session](https://github.com/H2Shami/MOD-helicone-session) プラグインを使用して、各 Mod 会話を Helicone のセッションとして自動的に記録します。
