...
- プロジェクト設定: `.mod/skills/<name>/SKILL.md`
...
途中で、一致する `skills/*/SKILL.md` を `.mod/` に読み込み、一致する `.claude/skills/*/SKILL.md` または `.agents/skills/*/SKILL.md` を読み込みます。
...
次のように `.mod/skills/git-release/SKILL.md` を作成します。
