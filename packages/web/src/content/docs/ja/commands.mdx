...
`.modtools/commands/test.md` を作成します。
...
カスタムコマンドは、Model-of-Design Tools 設定を通じて、または `commands/` ディレクトリに Markdown ファイルを作成することによって追加できます。

---

### JSON

Model-of-Design Tools [設定](/docs/config)で `command` オプションを使用します:
...
- グローバル: `~/.config/modtools/commands/`
- プロジェクトごと: `.modtools/commands/`
...
Model-of-Design Tools には、`/init`、`/undo`、`/redo`、`/share`、`/help` などのいくつかの組み込みコマンドが含まれています。 [詳細はこちら](/docs/tui#commands)。
