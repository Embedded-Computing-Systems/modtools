...
Helicone 的 [Sessions](https://docs.helicone.ai/features/sessions) 功能允许你将相关的 LLM 请求归为一组。使用 [MOD-helicone-session](https://github.com/H2Shami/MOD-helicone-session) 插件可以自动将每个 Mod 对话记录为 Helicone 中的一个会话。
