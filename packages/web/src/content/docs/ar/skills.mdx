...
تتيح مهارات الوكيل لـ Mod اكتشاف تعليمات قابلة لإعادة الاستخدام من مستودعك أو من دليل المنزل.
...
يبحث Mod في هذه المواقع:

- إعدادات المشروع: `.modtools/skills/<name>/SKILL.md`
- إعدادات عامة: `~/.config/MOD/skills/<name>/SKILL.md`
...
بالنسبة لمسارات المشروع المحلية، يتدرج Mod صعوداً من دليل العمل الحالي حتى يصل إلى `git worktree`.
...
كما تُحمَّل التعريفات العامة أيضاً من `~/.config/MOD/skills/*/SKILL.md` و `~/.claude/skills/*/SKILL.md` و `~/.agents/skills/*/SKILL.md`.
...
يعرض Mod المهارات المتاحة في وصف أداة `skill`.
...
تحكم في المهارات التي يمكن للوكلاء الوصول إليها باستخدام صلاحيات مبنية على أنماط داخل `MOD.json`:
