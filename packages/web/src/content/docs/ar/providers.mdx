...
1. شغّل الأمر `/connect` في TUI، واختر opencode، ثم انتقل إلى [modtools.ai/auth](https://modtools.ai/auth).
...
1. شغّل الأمر `/connect` في TUI، واختر `OpenCode Go`، ثم انتقل إلى [modtools.ai/auth](https://modtools.ai/zen).
