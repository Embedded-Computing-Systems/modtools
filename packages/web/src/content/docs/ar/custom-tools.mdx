...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في modtools.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في modtools مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.modtools/tools/` داخل مشروعك.
- أو عالميا بوضعها في `~/.config/modtools/tools/`.
