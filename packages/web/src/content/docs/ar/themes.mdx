...
مع Model-of-Design Tools يمكنك الاختيار من بين عدة سمات مدمجة، أو استخدام سمة تتكيّف مع سمة terminal لديك، أو تعريف سمة مخصصة خاصة بك.

افتراضيًا، يستخدم Model-of-Design Tools سمتنا `modtools`.
...
يأتي Model-of-Design Tools مع عدة سمات مدمجة.
...
- يريدون أن يطابق Model-of-Design Tools مظهر terminal لديهم
...
يدعم Model-of-Design Tools نظام سمات مرنًا قائمًا على JSON يتيح للمستخدمين إنشاء السمات وتخصيصها بسهولة.
...
2. **مجلد ضبط المستخدم** - معرّف في `~/.config/modtools/themes/*.json` أو `$XDG_CONFIG_HOME/modtools/themes/*.json`
3. **مجلد جذر المشروع** - معرّف في `<project-root>/.modtools/themes/*.json`
4. **مجلد العمل الحالي** - معرّف في `./.modtools/themes/*.json`
