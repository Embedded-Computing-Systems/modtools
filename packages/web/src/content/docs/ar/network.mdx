...
يدعم Model-of-Design Tools متغيرات بيئة الوكيل (proxy) القياسية والشهادات المخصصة لبيئات الشبكات المؤسسية.

---

## الوكيل

يتبع Model-of-Design Tools متغيرات بيئة الوكيل القياسية.
...
إذا كانت مؤسستك تستخدم سلطات تصديق (CA) مخصصة لاتصالات HTTPS، فقم بإعداد Model-of-Design Tools ليثق بها.
