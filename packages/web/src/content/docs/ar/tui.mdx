---
title: TUI
description: استخدام واجهة المستخدم TUI في Model-of-Design Tools.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر Model-of-Design Tools واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل Model-of-Design Tools إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة Model-of-Design Tools في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى Model-of-Design Tools. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من Model-of-Design Tools. _الأسماء المستعارة_: `/quit`, `/q`
...
يمكنك تخصيص سلوك واجهة TUI عبر ملف إعدادات Model-of-Design Tools.
...
استخدم `MOD_TUI_CONFIG` لتحميل مسار إعدادات TUI مخصص.
