...
أنشئ الملف `.modtools/commands/test.md`:
...
يمكنك إضافة أوامر مخصصة عبر إعدادات Model-of-Design Tools أو بإنشاء ملفات Markdown داخل الدليل `commands/`.

---

### JSON

استخدم خيار `command` في [config](/docs/config) الخاص بـ Model-of-Design Tools:
...
- على مستوى النظام: `~/.config/modtools/commands/`
- لكل مشروع: `.modtools/commands/`
...
يتضمن modtools عدة أوامر مضمنة مثل `/init` و`/undo` و`/redo` و`/share` و`/help`؛ [اعرف المزيد](/docs/tui#commands).
