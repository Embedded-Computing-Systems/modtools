...
يوجد نوعان من الوكلاء في Model-of-Design Tools: وكلاء أساسيون ووكلاء فرعيون.
...
يأتي Model-of-Design Tools مع وكيلين أساسيين مدمجين: **Build** و **Plan**. سنلقي نظرة عليهما أدناه.
...
يأتي Model-of-Design Tools مع وكيلين فرعيين مدمجين: **General** و **Explore**. سنلقي نظرة على ذلك أدناه.

---

## المدمجة

يأتي Model-of-Design Tools مع وكيلين أساسيين مدمجين ووكيلين فرعيين مدمجين.
...
هيّئ الوكلاء في ملف إعدادات `modtools.json`:
...
إذا لم يتم تحديد temperature، يستخدم Model-of-Design Tools القيم الافتراضية الخاصة بالنموذج؛ عادة 0 لمعظم النماذج و 0.55 لنماذج Qwen.
...
هذا المسار نسبي لمكان وجود ملف الإعدادات. لذلك يعمل هذا لكل من إعدادات Model-of-Design Tools العامة وإعدادات المشروع.
...
يستخدم معرّف النموذج في إعدادات Model-of-Design Tools الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [Model-of-Design Tools Zen](/docs/zen)، فستستخدم `modtools/gpt-5.1-codex` لـ GPT 5.1 Codex.
...
:::tip
شغّل `modtools models` لعرض قائمة بالنماذج المتاحة.
:::
