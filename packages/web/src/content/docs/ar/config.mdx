...
يمكنك أيضًا تعريف الوكلاء باستخدام ملفات markdown في `~/.config/MOD/agents/` أو `.mod/agents/`. [تعرف على المزيد هنا](/docs/agents).
...
يمكنك أيضًا تعريف الأوامر باستخدام ملفات markdown في `~/.config/MOD/commands/` أو `.mod/commands/`. [تعرف على المزيد هنا](/docs/commands).
...
ضع ملفات الإضافات في `.mod/plugins/` أو `~/.config/MOD/plugins/`. يمكنك أيضًا تحميل إضافات من npm عبر الخيار `plugin`.
