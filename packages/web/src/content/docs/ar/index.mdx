...
1. شغّل الأمر `/connect` في واجهة TUI، واختر opencode، ثم انتقل إلى [modtools.ai/auth](https://modtools.ai/auth).
...
إليك [مثالا لمحادثة](https://modtools.ai/s/4XP1fce5) مع OpenCode.
