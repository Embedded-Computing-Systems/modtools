...
import { IconModtools } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "modtools/session/message-v2"
import type { Message } from "modtools/session/message"
import type { Session } from "modtools/session/index"
              ...
              <ul data-component="header-stats">
                <li title={props.messages.modtools_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.modtools_name}>
                    <IconModtools width={16} height={16} />
                  </div>
