...
import { IconMod } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "mod/session/message-v2"
import type { Message } from "mod/session/message"
import type { Session } from "mod/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.mod_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.mod_name}>
                    <IconMod width={16} height={16} />
                  </div>
