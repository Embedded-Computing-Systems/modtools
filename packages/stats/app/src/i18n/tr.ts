export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | MOD Data",
  "app.description":
    "MOD Go kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde MOD Data logosu",
  ...
  "header.githubAria": "GitHub'da MOD'a yıldız ver",
  "header.github": "GitHub",
  "header.tryOpenCode": "MOD'u dene",
  ...
  "footer.homeAria": "MOD ana sayfası",
  ...
  "home.topModelsDescription": "MOD Go genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz MOD Go kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | MOD Data",
  "lab.description":
    "MOD Go'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son MOD kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "MOD'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son MOD kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük MOD token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | MOD Data",
  "model.description":
    "{{model}} için MOD Go kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda MOD Go kullanımı görünür.",
  "model.unranked": "Geçen haftaki MOD Go kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki MOD Go kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde MOD Go kullanımı yok.",
  ...
  "model.overviewDescription": "Son MOD Go tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz MOD Go kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük MOD Go token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz MOD Go kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama MOD Go oturum yapısı.",
  ...
  "model.geoDescription": "Ülkeye göre kullanılan MOD Go model tokenları.",
  "model.noGeoTitle": "Coğrafi veri yok",
  "model.noGeoDescription": "Bu modelle eşleşen MOD Go coğrafi satırı yok.",
  "model.worldMap": "Ülkeye göre model token kullanımının dünya haritası",
  "model.peersDescription": "Son MOD Go token hacmine göre yakındaki modeller.",
