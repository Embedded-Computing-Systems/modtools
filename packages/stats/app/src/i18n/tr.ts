export const dict = {
  ...
  "app.description":
    "MOD kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  ...
  "home.topModelsDescription": "MOD genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz MOD kullanıcıları.",
  ...
  "lab.description":
    "MOD'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  ...
  "model.description":
    "{{model}} için MOD kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda MOD kullanımı görünür.",
  "model.unranked": "Geçen haftaki MOD kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki MOD kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde MOD kullanımı yok.",
  ...
  "model.overviewDescription": "Son MOD tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz MOD kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük MOD token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz MOD kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama MOD oturum yapısı.",
  ...
  "model.geoDescription": "Ülkeye göre kullanılan MOD model tokenları.",
  "model.noGeoTitle": "Coğrafi veri yok",
  "model.noGeoDescription": "Bu modelle eşleşen MOD coğrafi satırı yok.",
  "model.worldMap": "Ülkeye göre model token kullanımının dünya haritası",
  "model.peersDescription": "Son MOD token hacmine göre yakındaki modeller.",
