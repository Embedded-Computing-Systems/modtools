export const dict = {
  ...
  "app.description":
    "Przeglądaj użycie MOD w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  ...
  "home.topModelsDescription": "Użycie modeli w MOD.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy MOD według modelu.",
  ...
  "lab.description":
    "Porównaj modele {{lab}} używane w MOD, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  ...
  "model.description":
    "Zobacz dane użycia {{model}} w MOD, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie MOD pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu MOD z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu MOD z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia MOD w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny MOD, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia MOD.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów MOD w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy MOD w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji MOD.",
  ...
  "model.geoDescription": "Tokeny modelu MOD użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne MOD nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów MOD.",
