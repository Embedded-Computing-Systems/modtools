export const dict = {
  "app.title": "Rankingi użycia modeli AI | MOD Data",
  "app.description":
    "Przeglądaj użycie MOD Go w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny MOD Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę MOD na GitHub",
  "header.github": "GitHub",
  "header.tryOpenCode": "Wypróbuj MOD",
  ...
  "footer.homeAria": "Strona główna MOD",
  ...
  "home.topModelsDescription": "Użycie modeli w MOD Go.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy MOD Go według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | MOD Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w MOD Go, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia MOD.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w MOD",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia MOD",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów MOD z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | MOD Data",
  "model.description":
    "Zobacz dane użycia {{model}} w MOD Go, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie MOD Go pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu MOD Go z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu MOD Go z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia MOD Go w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny MOD Go, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia MOD Go.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów MOD Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy MOD Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji MOD Go.",
  ...
  "model.geoDescription": "Tokeny modelu MOD Go użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne MOD Go nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów MOD Go.",
