export const dict = {
  "app.title": "Classifiche di utilizzo dei modelli IA | MOD Data",
  "app.description":
    "Esplora l'utilizzo di MOD Go nei modelli IA, inclusi volume di token, classifiche, quota di mercato, prezzi dei token, costo per sessione, rapporto cache e ripartizioni geografiche.",
  "app.unfurlAlt": "Logotipo MOD Data su uno sfondo scuro con motivo",
  ...
  "header.githubAria": "Aggiungi una stella a MOD su GitHub",
  "header.github": "GitHub",
  "header.tryOpenCode": "Prova MOD",
  ...
  "home.topModelsDescription": "Utilizzo dei modelli in MOD Go.",
  ...
  "home.uniqueUsersDescription": "Utenti unici giornalieri di MOD Go per modello.",
  ...
  "lab.title": "Utilizzo e classifiche dei modelli IA {{lab}} | MOD Data",
  "lab.description":
    "Confronta i modelli {{lab}} usati in MOD Go, inclusi utilizzo dei token, classifiche dei modelli, finestre di contesto, date di rilascio, costi e dati specifici del modello.",
  "lab.loadingTitle": "Laboratorio modelli",
  "lab.loadingDescription": "Lettura della disponibilità dei modelli e dell'utilizzo recente di MOD.",
  "lab.notFound": "Nessun modello corrispondeva a questo laboratorio.",
  "lab.heroPrefix": "Esplora {{count}} modelli {{lab}} usati in MOD",
  ...
  "lab.shareOfUsage": "{{share}} dell'utilizzo recente di MOD",
  "lab.usageTitle": "Utilizzo token {{lab}}",
  "lab.usageDescription": "Volume giornaliero di token MOD negli ultimi due mesi.",
  ...
  "lab.usage": "Utilizzo",
  "lab.share": "Quota",
  "model.title": "Utilizzo, costo e posizione di {{model}} | MOD Data",
  "model.description":
    "Visualizza i dati di utilizzo di {{model}} in MOD Go, inclusi volume di token, rango settimanale, mix di token, costi, rapporto cache, sessioni, ripartizioni geografiche e modelli simili.",
  ...
  "model.catalogFallback":
    "Fatti del modello dall'indice condiviso dei modelli. L'utilizzo di MOD Go appare quando questo modello ha attività.",
  "model.unranked": "Non classificato nell'utilizzo MOD Go della scorsa settimana",
  "model.ranked": "Posizione #{{rank}} nell'utilizzo MOD Go della scorsa settimana",
  ...
  "model.noCurrentUsage": "Nessun utilizzo di MOD Go nella finestra dati attuale.",
  ...
  "model.inputs": "Input",
  "model.overviewDescription": "Token recenti di MOD Go, utenti unici e posizione di mercato.",
  "model.noSummaryTitle": "Nessun riepilogo di utilizzo",
  "model.noSummaryDescription": "Questo modello non ha ancora righe di utilizzo di MOD Go.",
  "model.tokens": "Token",
  ...
  "model.usageDescription": "Volume giornaliero di token MOD Go nella recente finestra di due mesi.",
  ...
  "model.usersDescription": "Utenti unici giornalieri di MOD Go nella recente finestra di due mesi.",
  ...
  "model.efficiencyDescription": "Costi, comportamento della cache e forma media della sessione MOD Go.",
  ...
  "model.geoDescription": "Token del modello MOD Go usati per paese.",
  "model.noGeoTitle": "Nessun dato geografico",
  "model.noGeoDescription": "Nessuna riga geografica MOD Go corrispondeva a questo modello.",
  "model.worldMap": "Mappa mondiale dell'utilizzo dei token del modello per paese",
  "model.peersDescription": "Modelli vicini per volume recente di token MOD Go.",
