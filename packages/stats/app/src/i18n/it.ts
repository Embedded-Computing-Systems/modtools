export const dict = {
  ...
  "app.description":
    "Esplora l'utilizzo di MOD nei modelli IA, inclusi volume di token, classifiche, quota di mercato, prezzi dei token, costo per sessione, rapporto cache e ripartizioni geografiche.",
  ...
  "home.topModelsDescription": "Utilizzo dei modelli in MOD.",
  ...
  "home.uniqueUsersDescription": "Utenti unici giornalieri di MOD per modello.",
  ...
  "lab.description":
    "Confronta i modelli {{lab}} usati in MOD, inclusi utilizzo dei token, classifiche dei modelli, finestre di contesto, date di rilascio, costi e dati specifici del modello.",
  ...
  "model.description":
    "Visualizza i dati di utilizzo di {{model}} in MOD, inclusi volume di token, rango settimanale, mix di token, costi, rapporto cache, sessioni, ripartizioni geografiche e modelli simili.",
  ...
  "model.catalogFallback":
    "Fatti del modello dall'indice condiviso dei modelli. L'utilizzo di MOD appare quando questo modello ha attività.",
  "model.unranked": "Non classificato nell'utilizzo MOD della scorsa settimana",
  "model.ranked": "Posizione #{{rank}} nell'utilizzo MOD della scorsa settimana",
  ...
  "model.noCurrentUsage": "Nessun utilizzo di MOD nella finestra dati attuale.",
  ...
  "model.inputs": "Input",
  "model.overviewDescription": "Token recenti di MOD, utenti unici e posizione di mercato.",
  "model.noSummaryTitle": "Nessun riepilogo di utilizzo",
  "model.noSummaryDescription": "Questo modello non ha ancora righe di utilizzo di MOD.",
  "model.tokens": "Token",
  ...
  "model.usageDescription": "Volume giornaliero di token MOD nella recente finestra di due mesi.",
  ...
  "model.usersDescription": "Utenti unici giornalieri di MOD nella recente finestra di due mesi.",
  ...
  "model.efficiencyDescription": "Costi, comportamento della cache e forma media della sessione MOD.",
  ...
  "model.geoDescription": "Token del modello MOD usati per paese.",
  "model.noGeoTitle": "Nessun dato geografico",
  "model.noGeoDescription": "Nessuna riga geografica MOD corrispondeva a questo modello.",
  "model.worldMap": "Mappa mondiale dell'utilizzo dei token del modello per paese",
  "model.peersDescription": "Modelli vicini per volume recente di token MOD.",
