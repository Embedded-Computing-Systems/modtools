export const dict = {
  ...
  "app.description":
    "Explora el uso de MOD en modelos de IA, incluido el volumen de tokens, clasificaciones, cuota de mercado, precios de tokens, coste por sesión, ratio de caché y desgloses geográficos.",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos en MOD.",
  ...
  "home.uniqueUsersDescription": "Usuarios únicos diarios de MOD por modelo.",
  ...
  "lab.description":
    "Compara modelos de {{lab}} usados en MOD, incluido uso de tokens, clasificaciones de modelos, ventanas de contexto, fechas de lanzamiento, costes y datos específicos del modelo.",
  ...
  "model.description":
    "Consulta datos de uso de {{model}} en MOD, incluido volumen de tokens, posición semanal, mezcla de tokens, costes, ratio de caché, sesiones, desgloses geográficos y modelos similares.",
  ...
  "model.catalogFallback":
    "Datos del modelo desde el índice compartido de modelos. El uso de MOD aparecerá cuando este modelo tenga actividad.",
  "model.unranked": "Sin clasificación en el uso de MOD de la semana pasada",
  "model.ranked": "Clasificado #{{rank}} en el uso de MOD de la semana pasada",
  ...
  "model.noCurrentUsage": "Sin uso de MOD en la ventana de datos actual.",
  ...
  "model.overviewDescription": "Tokens recientes de MOD, usuarios únicos y posición de mercado.",
  "model.noSummaryTitle": "Sin resumen de uso",
  "model.noSummaryDescription": "Este modelo aún no tiene filas de uso de MOD.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volumen diario de tokens de MOD durante la ventana reciente de dos meses.",
  ...
  "model.usersDescription": "Usuarios únicos diarios de MOD durante la ventana reciente de dos meses.",
  ...
  "model.efficiencyDescription": "Coste, comportamiento de caché y forma media de sesión de MOD.",
  ...
  "model.geoDescription": "Tokens del modelo de MOD usados por país.",
  "model.noGeoTitle": "Sin datos geográficos",
  "model.noGeoDescription": "Ninguna fila geográfica de MOD coincidió con este modelo.",
  "model.worldMap": "Mapa mundial del uso de tokens del modelo por país",
  "model.peersDescription": "Modelos cercanos por volumen reciente de tokens de MOD.",
