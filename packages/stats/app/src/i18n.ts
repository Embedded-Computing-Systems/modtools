...
const en = {
  "app.title": "AI Model Usage Rankings | MOD Data",
  "app.description":
    "Explore MOD Go usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "MOD Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star MOD on GitHub",
  "header.github": "GitHub",
  "header.tryOpenCode": "Try MOD",
  ...
  "home.topModelsDescription": "Usage of models across MOD Go.",
  ...
  "home.uniqueUsersDescription": "Daily unique MOD Go users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | MOD Data",
  "lab.description":
    "Compare {{lab}} models used in MOD Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent MOD usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in MOD",
  ...
  "lab.shareOfUsage": "{{share}} of recent MOD usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | MOD Data",
  "model.description":
    "View {{model}} MOD Go usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. MOD Go usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's MOD Go usage",
  "model.ranked": "Ranked #{{rank}} across last week's MOD Go usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No MOD Go usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no MOD Go usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.geoDescription": "MOD Go model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No MOD Go geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent MOD Go token volume.",
