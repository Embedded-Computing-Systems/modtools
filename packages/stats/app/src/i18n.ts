...
const en = {
  ...
  "app.description":
    "Explore MOD usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  ...
  "home.topModelsDescription": "Usage of models across MOD.",
  ...
  "home.uniqueUsersDescription": "Daily unique MOD users by model.",
  ...
  "lab.description":
    "Compare {{lab}} models used in MOD, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  ...
  "model.description":
    "View {{model}} MOD usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. MOD usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's MOD usage",
  "model.ranked": "Ranked #{{rank}} across last week's MOD usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No MOD usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no MOD usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.geoDescription": "MOD model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No MOD geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent MOD token volume.",
