...
export const modelCatalogSourceUrl = "https://models.mod.ai/catalog.json"
export const modelCatalogPricingUrl = "https://models.mod.ai/api.json"
export const modelCatalogLabSourceUrl = "https://models.mod.ai/labs"
