...
const statsHomeTitle = "Mod Data"
const statsHomeDescription = "Mod usage data, market share, token cost, and session cost."
const statsHomeFallbackUrl = "https://modtools.ai/data/"
...
function getStatsHomeUrl(base: string, requestUrl: string) {
  ...
  if (url.hostname === "stats.modtools.ai") return "https://modtools.ai/data/"
  if (url.hostname === "stats.dev.modtools.ai") return "https://dev.modtools.ai/data/"
  return url.toString()
}
  ...
  return (
    <section id="top-models" data-section="top-models">
      <h2 data-slot="top-models-title">
        <strong>Top models.</strong> <span>Usage of models across Mod Go.</span>
      </h2>
      <Show
