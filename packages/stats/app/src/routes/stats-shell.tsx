...
export const githubLink = {
  ...
  apiHref: "https://api.github.com/repos/anomalyco/mod",
  fallbackStars: "195K",
}
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://modtools.ai/legal/terms-of-service", label: i18n.t("footer.terms") },
    { href: "https://modtools.ai/legal/privacy-policy", label: i18n.t("footer.privacy") },
  ]
  const connect = [
    { href: "mailto:hello@modtools.ai", label: i18n.t("footer.contact") },
    { href: "https://modtools.ai/discord", label: i18n.t("footer.community") },
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://modtools.ai" aria-label={i18n.t("footer.homeAria")}>
          <OpenCodeMark />
        </a>
