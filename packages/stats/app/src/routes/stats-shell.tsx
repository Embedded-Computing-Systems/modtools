import MODWordmarkDark from "../asset/logo-ornate-dark.svg"
...
export const githubLink = {
  ...
  apiHref: "https://api.github.com/repos/Embedded-Computing-Systems/modtools",
  label: "GitHub",
  fallbackStars: "150K",
  ariaLabel: "Star Mod on GitHub",
}
export const themePreferences = ["dark", "light", "system"] as const
export const themeStorageKey = "MOD:stats-theme"
    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://modtools.ai/">
            <strong>Try Mod</strong>
          </a>
          <button
...
function ModMark() {
  return (
    <svg data-slot="MOD-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://modtools.ai/legal/terms-of-service", label: "Terms of service" },
    { href: "https://modtools.ai/legal/privacy-policy", label: "Privacy policy" },
  ]
  const connect = [
    { href: "mailto:hello@modtools.ai", label: "Contact us" },
    { href: "https://modtools.ai/discord", label: "Community" },
    { href: "https://x.com/MOD", label: "X" },
    githubLink,
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://modtools.ai" aria-label="Mod home">
          <ModMark />
        </a>
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={MODWordmarkDark} alt="Mod" />
        ...
        <div data-slot="modal-body">
          <div data-slot="modal-intro">
            <h2 id="subscribe-title">Mod Newsletter</h2>
            <p>
