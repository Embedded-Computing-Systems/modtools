...
- Effect plugins import `@modtools-ai/plugin/v2/effect`, not `@modtools-ai/core`.
- Public domain values use generated `@modtools-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@modtools-ai/plugin/v2/effect`.
