# MOD V2 Promise Plugin API

The Promise plugin API is the async/await equivalent of `@modtools-ai/plugin/v2/effect`. It grants plugins the same two in-process capabilities:
...
```ts
import { define } from "@modtools-ai/plugin/v2/promise"
