...
import { createEmbeddedRoutes } from "@modtools-ai/server/routes"
...
export const create = Effect.fn("OpenCode.create")(function* () {
  ...
  const client = yield* OpenCode.make({ baseUrl: "http://mod.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@modtools-ai/sdk-next/OpenCode") {}
