...
import { Account } from "@modtools-ai/console-core/account.js"
...
import { User } from "@modtools-ai/console-core/user.js"
import { and, Database, eq, isNull, or } from "@modtools-ai/console-core/drizzle/index.js"
...
import { AuthTable } from "@modtools-ai/console-core/schema/auth.sql.js"
...
const MY_THEME: Theme = {
  ...THEME_OPENAUTH,
  logo: "https://modtools.ai/favicon-v3.svg",
}
  ...
  async fetch(request: Request, env: Env, ctx: ExecutionContext) {
    const result = await issuer({
      ...
      async success(ctx, response) {
        ...
        if (Resource.App.stage !== "production" && !email.endsWith("@embedded-computing.systems")) {
