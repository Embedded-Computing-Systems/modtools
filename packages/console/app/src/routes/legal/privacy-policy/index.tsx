...
export default function PrivacyPolicy() {
  ...
  return (
    <main data-page="legal">
      <Title>Mod | Privacy Policy</Title>
      <LocaleLinks path="/legal/privacy-policy" />
      <Meta name="description" content="Mod privacy policy" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="privacy-policy">
              ...
              <p>
                At Mod, we take your privacy seriously. Please read this Privacy Policy to learn how we treat your
                personal data.{" "}
                <strong>
              ...
              <p>
                Remember that your use of Mod is at all times subject to our Terms of Use,{" "}
              ...
              <p>
                ...
                time. We will alert you of material changes by placing a notice on the Mod website, by sending you
              ...
              <ul>
                <li>
                  ...
                  sending you information about Mod.
                </li>
              ...
              <p>
                ...
                you, Mod or another party; enforcing any agreements with you; responding to claims that any posting
