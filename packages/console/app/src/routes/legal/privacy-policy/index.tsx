...
export default function PrivacyPolicy() {
  ...
  return (
    <main data-page="legal">
      <Title>Model-of-Design Tools | Privacy Policy</Title>
      <LocaleLinks path="/legal/privacy-policy" />
      <Meta name="description" content="Model-of-Design Tools privacy policy" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="privacy-policy">
              ...
              <p>
                At Model-of-Design Tools, we take your privacy seriously. Please read this Privacy Policy to learn how we treat your
                personal data.{" "}
                <strong>
              ...
              <p>
                Remember that your use of Model-of-Design Tools is at all times subject to our Terms of Use,{" "}
                <a href={language.route("/legal/terms-of-service")}>https://modtools.ai/legal/terms-of-service</a>,
              ...
              <p>
                ...
                time. We will alert you of material changes by placing a notice on the Model-of-Design Tools website, by sending you
              ...
              <ul>
                <li>
                  ...
                  sending you information about Model-of-Design Tools.
                </li>
              ...
              <p>
                ...
                you, Model-of-Design Tools or another party; enforcing any agreements with you; responding to claims that any posting
