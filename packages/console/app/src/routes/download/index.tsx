...
import desktopAppIcon from "../../asset/lander/modtools-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://modtools.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>modtools.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g modtools-ai")}>
                <code>
                  npm i -g <strong>modtools-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g modtools-ai")}>
                <code>
                  bun add -g <strong>modtools-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install Embedded-Computing-Systems/tap/modtools")}>
                <code>
                  brew install <strong>Embedded-Computing-Systems/tap/modtools</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S modtools")}>
                <code>
                  paru -S <strong>modtools</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask modtools-desktop")}>
                <code>
                  brew install --cask <strong>modtools-desktop</strong>
                </code>
                <CopyStatus />
              </button>
