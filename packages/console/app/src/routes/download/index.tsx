...
import desktopAppIcon from "../../asset/lander/MOD-desktop-icon.png"
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              ...
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g MOD-ai")}>
                <code>
                  npm i -g <strong>MOD-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g MOD-ai")}>
                <code>
                  bun add -g <strong>MOD-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/MOD")}>
                <code>
                  brew install <strong>anomalyco/tap/MOD</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S MOD")}>
                <code>
                  paru -S <strong>MOD</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask MOD-desktop")}>
                <code>
                  brew install --cask <strong>MOD-desktop</strong>
                </code>
                <CopyStatus />
              </button>
