...
import compareVideo from "../../asset/lander/modtools-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/modtools-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="modtools:auth" content={loggedin() ? "true" : "false"} />
          ...
          <section data-component="testimonials">
            ...
            <a href="https://x.com/thdxr/status/1973531687629017227">
              <div data-slot="testimonial">
                ...
                <div data-slot="quote">
                  <span>@Model-of-Design Tools</span>
