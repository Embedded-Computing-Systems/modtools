...
declare const MODTOOLS_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof MODTOOLS_CLI_NAME === "string" ? MODTOOLS_CLI_NAME : "mod", {
  description: "MOD 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
