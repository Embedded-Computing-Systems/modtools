...
```
REGISTRY=ghcr.io/Embedded-Computing-Systems TAG=24.04 bun ./packages/containers/script/build.ts
REGISTRY=ghcr.io/Embedded-Computing-Systems TAG=24.04 bun ./packages/containers/script/build.ts --push
```
...
jobs:
  build-cli:
    ...
    container:
      image: ghcr.io/Embedded-Computing-Systems/build/bun-node:24.04
```
