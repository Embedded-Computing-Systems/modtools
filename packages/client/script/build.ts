...
import { compile, emitEffectImported, emitPromise, write } from "@modtools-ai/httpapi-codegen"
        ...
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              ...
              import: 'import type { OpenCodeEventEncoded } from "@modtools-ai/protocol/groups/event"',
            },
          },
        }),
