...
import modtoolsThemeJson from "./themes/modtools.json"
...
export const mod2Theme = mod2ThemeJson as DesktopTheme
...
export const modtoolsTheme = modtoolsThemeJson as DesktopTheme
