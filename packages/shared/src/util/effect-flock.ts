...
import { Effect, Function, Layer, Option, Schedule, Schema, ServiceMap } from "effect"
...
export namespace EffectFlock {
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("EffectFlock") {}
