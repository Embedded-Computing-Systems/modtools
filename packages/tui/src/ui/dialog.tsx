...
import { useBindings, useModModeStack } from "../keymap"
...
function init() {
  ...
  const renderer = useRenderer()
  const modeStack = useModModeStack()
  ...
  return (
    <ctx.Provider value={value}>
      ...
      <box
        ...
        onMouseUp={!Flag.MODTOOLS_EXPERIMENTAL_DISABLE_COPY_ON_SELECT ? copySelection : undefined}
      >
