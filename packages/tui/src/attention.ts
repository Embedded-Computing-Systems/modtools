...
import defaultSoundPath from "@modtools-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@modtools-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@modtools-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@modtools-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@modtools-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@modtools-ai/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "MOD"
const DEFAULT_PACK_ID = "MOD.default"
