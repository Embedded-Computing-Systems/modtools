...
import { registerModSpinner } from "../register-spinner"
...
import type { AssistantMessage, FilePart, UserMessage } from "@modtools-ai/sdk/v2"
...
import { MODTOOLS_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useModKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.MODTOOLS_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
