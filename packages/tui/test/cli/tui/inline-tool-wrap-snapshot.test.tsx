...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "MOD.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/modtools/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/modtools (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/modtools/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/modtools/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const MODTOOLS_DB|MODTOOLS_DB|MODTOOLS_DEV|Global\\.Path\\.data|data =" in packages/modtools/src (115 matches)',
  },
] as const
