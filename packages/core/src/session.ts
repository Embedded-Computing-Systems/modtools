...
import { ListAnchor } from "@modtools-ai/schema/session"
...
import { SessionDurable } from "@modtools-ai/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@mod/v2/Session") {}
