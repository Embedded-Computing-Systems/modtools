...
import type { Data, Definition, Payload } from "@modtools-ai/schema/event"
...
import { Durable } from "@modtools-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@modtools-ai/schema/event").ID
export type { Data, Definition, Payload } from "@modtools-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@mod/Event") {}
