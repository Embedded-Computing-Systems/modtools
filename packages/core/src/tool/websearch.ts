...
import { ToolFailure } from "@modtools-ai/llm"
...
export class ConfigService extends Context.Service<ConfigService, Config>()("@mod/v2/WebSearchConfig") {}

/** Isolates the retained product environment contract from the generic tool implementation. */
export const defaultConfigLayer = Layer.sync(ConfigService, () =>
  ConfigService.of({
    provider:
      process.env.MODTOOLS_WEBSEARCH_PROVIDER === "exa" || process.env.MODTOOLS_WEBSEARCH_PROVIDER === "parallel"
        ? process.env.MODTOOLS_WEBSEARCH_PROVIDER
        : undefined,
    enableExa: truthy("MODTOOLS_EXPERIMENTAL") || truthy("MODTOOLS_ENABLE_EXA") || truthy("MODTOOLS_EXPERIMENTAL_EXA"),
    enableParallel: truthy("MODTOOLS_ENABLE_PARALLEL") || truthy("MODTOOLS_EXPERIMENTAL_PARALLEL"),
