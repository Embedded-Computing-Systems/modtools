...
export class Service extends Context.Service<Service, Interface>()("@mod/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.MODTOOLS_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
