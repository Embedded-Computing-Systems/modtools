...
import { FileSystemWatcher } from "@modtools-ai/schema/filesystem-watcher"
...
declare const MODTOOLS_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof MODTOOLS_LIBC === "undefined" ? undefined : MODTOOLS_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@mod/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.MODTOOLS_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.MODTOOLS_EXPERIMENTAL_FILEWATCHER)) {
