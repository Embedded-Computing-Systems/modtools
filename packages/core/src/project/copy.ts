...
import { Event } from "@modtools-ai/schema/project-directories"
import { ProjectCopy } from "@modtools-ai/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@mod/ProjectCopy") {}
