...
import type { EffectDrizzleSqlite } from "@modtools-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@MOD/ProjectDirectories") {}
