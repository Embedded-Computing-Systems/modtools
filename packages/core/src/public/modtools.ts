...
/** Intentional public native API for Effect applications embedding Mod. */
export class Service extends Context.Service<Service, Interface>()("@MOD/public/Mod") {}
...
>()("@MOD/public/Mod/SessionModelValidation") {}
...
const SessionModelValidationLayer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    return SessionModelValidation.of({
      validate: Effect.fn("Mod.sessions.validateModel")(function* (input) {
  ...
  Effect.gen(function* () {
    ...
    return Service.of({
      ...
      sessions: {
        ...
        get: sessions.get,
        list: sessions.list,
        switchModel: Effect.fn("Mod.sessions.switchModel")(function* (input) {
...
// TODO: Add Mod.create(...) as the Promise facade over the same native API semantics.
