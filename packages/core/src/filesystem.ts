...
import { Entry, FileSystem, FindInput, Match } from "@modtools-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@modtools-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@mod/v2/FileSystem") {}
