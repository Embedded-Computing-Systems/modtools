import { convertToOpenAICompatibleChatMessages as convertToCopilotMessages } from "@modtools-ai/core/github-copilot/chat/convert-to-openai-compatible-chat-messages"
