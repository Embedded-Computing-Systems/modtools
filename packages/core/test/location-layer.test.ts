...
import { define } from "@modtools-ai/plugin/v2/effect"
...
import { LocationServiceMap } from "@modtools-ai/core/location-services"
      ...
      Effect.flatMap(([blocked, allowed]) =>
        Effect.gen(function* () {
          ...
          yield* Effect.promise(() =>
            fs.writeFile(
              path.join(blocked.path, "MOD.json"),
              JSON.stringify({
