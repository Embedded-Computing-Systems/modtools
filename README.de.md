...
OpenCode ist auch als Desktop-Anwendung verfügbar. Lade sie direkt von der [Releases-Seite](https://github.com/anomalyco/opencode/releases) oder [modtools.ai/download](https://modtools.ai/download) herunter.
...
Mehr Infos zur Konfiguration von OpenCode findest du in unseren [**Docs**](https://modtools.ai/docs).
