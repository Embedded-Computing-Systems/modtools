...
Generates UPCOMING_CHANGELOG.md by running the modtools changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for modtools run (default: low)
      --quiet            Suppress modtools command output unless it fails
