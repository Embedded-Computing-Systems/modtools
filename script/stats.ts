...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/Embedded-Computing-Systems/modtools/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for Embedded-Computing-Systems/modtools...\n")
...
console.log("Fetching npm all-time downloads for modtools-ai...\n")
const npmDownloads = await fetchNpmDownloads("modtools-ai")
