...
nix run nixpkgs#MOD           # или github:Embedded-Computing-Systems/modtools для самой свежей ветки dev
```
...
MOD также доступен как десктопное приложение. Скачайте его со [страницы релизов](https://github.com/Embedded-Computing-Systems/modtools/releases) или с [modtools.ai/download](https://modtools.ai/download).
...
1. `$MODTOOLS_INSTALL_DIR` - Пользовательский каталог установки
...
Больше информации о том, как настроить MOD: [**наши docs**](https://modtools.ai/docs).
