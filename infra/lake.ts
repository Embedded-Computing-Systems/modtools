...
const tableBucketName = `MOD-${$app.stage}-lake`
...
const firehose = new aws.kinesis.FirehoseDeliveryStream(
  "LakeFirehose",
  {
    name: `MOD-${$app.stage}-lake-ingest`,
    destination: "iceberg",
