...
- `MOD` (preserve casing in prose; keep `MOD` only when it is part of commands, package names, paths, or code)
- `MOD Zen`
- `MOD CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `MOD` in prose when referring to the product name; use `MOD`
