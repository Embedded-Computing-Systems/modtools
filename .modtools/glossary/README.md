...
Use this folder for locale-specific translation guidance that supplements `.modtools/agent/translator.md`.
...
- PR #12345: https://github.com/Embedded-Computing-Systems/modtools/pull/12345

## Do Not Translate (Locale Additions)

- `Model-of-Design Tools` (preserve casing)
