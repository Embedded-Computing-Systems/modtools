...
- PR #15835: https://github.com/Embedded-Computing-Systems/modtools/pull/15835

## Do Not Translate (Locale Additions)

- `Model-of-Design Tools` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `modtools` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Model-of-Design Tools` in prose, `modtools` only for exact technical identifiers
...
- Avoid changing `modtools` to `Model-of-Design Tools` inside commands, URLs, package names, or code literals
