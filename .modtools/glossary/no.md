...
- PR #10018: https://github.com/Embedded-Computing-Systems/modtools/pull/10018
- PR #12935: https://github.com/Embedded-Computing-Systems/modtools/pull/12935

## Do Not Translate (Locale Additions)

- `Model-of-Design Tools` (preserve casing in prose; keep `modtools` only in commands, package names, paths, or code)
