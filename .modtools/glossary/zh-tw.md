...
- PR #13942: https://github.com/Embedded-Computing-Systems/modtools/pull/13942

## Do Not Translate (Locale Additions)

- `Model-of-Design Tools` (preserve casing in prose; keep `modtools` only when it is part of commands, package names, paths, or code)
- `Model-of-Design Tools Zen`
- `Model-of-Design Tools CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `modtools` in prose when referring to the product name; use `Model-of-Design Tools`
