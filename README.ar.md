...
nix run nixpkgs#MOD           # او github:Embedded-Computing-Systems/modtools لاحدث فرع dev
```
...
يتوفر MOD ايضا كتطبيق سطح مكتب. قم بالتنزيل مباشرة من [صفحة الاصدارات](https://github.com/Embedded-Computing-Systems/modtools/releases) او من [modtools.ai/download](https://modtools.ai/download).
...
1. `$MODTOOLS_INSTALL_DIR` - مجلد تثبيت مخصص
...
لمزيد من المعلومات حول كيفية ضبط MOD، [**راجع التوثيق**](https://modtools.ai/docs).
