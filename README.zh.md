...
OpenCode 也提供桌面版应用。可直接从 [发布页 (releases page)](https://github.com/anomalyco/opencode/releases) 或 [modtools.ai/download](https://modtools.ai/download) 下载。
...
- 100% 开源。
- 不绑定特定提供商。推荐使用 [OpenCode Zen](https://modtools.ai/zen) 的模型，但也可搭配 Claude、OpenAI、Google 甚至本地模型。模型迭代会缩小差异、降低成本，因此保持 provider-agnostic 很重要。
- 内置 LSP 支持。
