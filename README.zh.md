...
mise use -g MOD               # 任意系统
nix run nixpkgs#MOD           # 或用 github:Embedded-Computing-Systems/modtools 获取最新 dev 分支
```
...
Mod 也提供桌面版应用。可直接从 [发布页 (releases page)](https://github.com/Embedded-Computing-Systems/modtools/releases) 或 [modtools.ai/download](https://modtools.ai/download) 下载。
...
1. `$MODTOOLS_INSTALL_DIR` - 自定义安装目录
