...
nix run nixpkgs#MOD           # o github:Embedded-Computing-Systems/modtools para la rama dev más reciente
```
...
Mod también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/Embedded-Computing-Systems/modtools/releases) o desde [modtools.ai/download](https://modtools.ai/download).
...
1. `$MODTOOLS_INSTALL_DIR` - Directorio de instalación personalizado
...
Mod incluye dos agentes integrados que puedes alternar con la tecla `Tab`.
...
Más información sobre [agentes](https://modtools.ai/docs/agents).

### Documentación

Para más información sobre cómo configurar Mod, [**ve a nuestra documentación**](https://modtools.ai/docs).

### Contribuir

Si te interesa contribuir a Mod, lee nuestras [docs de contribución](./CONTRIBUTING.md) antes de enviar un pull request.

### Proyectos basados en Mod

Si estás trabajando en un proyecto basado en Mod y usas "MOD" como parte del nombre, por ejemplo, "MOD-dashboard" u "MOD-mobile", agrega una nota en tu README para aclarar que no está hecho por el equipo de Mod y que no está afiliado con nosotros de ninguna manera.
