...
rustPlatform.buildRustPackage (finalAttrs: {
  ...
  postFixup = lib.optionalString stdenv.hostPlatform.isLinux ''
    mv $out/bin/Model-of-Design Tools $out/bin/modtools-desktop
    sed -i 's|^Exec=Model-of-Design Tools$|Exec=modtools-desktop|' $out/share/applications/Model-of-Design Tools.desktop
  '';

  meta = {
    description = "Model-of-Design Tools Desktop App";
