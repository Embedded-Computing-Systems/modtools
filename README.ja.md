...
nix run nixpkgs#MOD           # または github:Embedded-Computing-Systems/modtools で最新 dev ブランチ
```
...
MOD はデスクトップアプリとしても利用できます。[releases page](https://github.com/Embedded-Computing-Systems/modtools/releases) から直接ダウンロードするか、[modtools.ai/download](https://modtools.ai/download) を利用してください。
...
1. `$MODTOOLS_INSTALL_DIR` - カスタムのインストールディレクトリ
...
MOD の設定については [**ドキュメント**](https://modtools.ai/docs) を参照してください。
