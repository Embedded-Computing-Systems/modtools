...
nix run nixpkgs#MOD           # 또는 github:Embedded-Computing-Systems/modtools 로 최신 dev 브랜치
```
...
MOD 는 데스크톱 앱으로도 제공됩니다. [releases page](https://github.com/Embedded-Computing-Systems/modtools/releases) 에서 직접 다운로드하거나 [modtools.ai/download](https://modtools.ai/download) 를 이용하세요.
...
1. `$MODTOOLS_INSTALL_DIR` - 사용자 지정 설치 디렉터리
...
MOD 설정에 대한 자세한 내용은 [**문서**](https://modtools.ai/docs) 를 참고하세요.
