...
nix run nixpkgs#MOD           # or github:Embedded-Computing-Systems/modtools for latest dev branch
```
...
MOD ডেস্কটপ অ্যাপ্লিকেশন হিসেবেও উপলব্ধ। সরাসরি [রিলিজ পেজ](https://github.com/Embedded-Computing-Systems/modtools/releases) অথবা [modtools.ai/download](https://modtools.ai/download) থেকে ডাউনলোড করুন।
...
1. `$MODTOOLS_INSTALL_DIR` - কাস্টম ইনস্টলেশন ডিরেক্টরি
...
কিভাবে MOD কনফিগার করবেন সে সম্পর্কে আরও তথ্যের জন্য, [**আমাদের ডকস দেখুন**](https://modtools.ai/docs)।
